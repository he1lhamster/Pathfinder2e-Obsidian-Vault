...
name: Blizzard
rarity: Common
requirement: A blizzard can occur only during winter.
...
---
# Blizzard<span class="item-type">Hazard 6</span>
...
---
**Prepare** DC 21 [[DATABASE/skill/Survival|Survival]] (trained) to notice escalations in the weather or 25 DC [[DATABASE/skill/Nature|Nature]] (expert) to correctly interpret the behavior of local wildlife.
