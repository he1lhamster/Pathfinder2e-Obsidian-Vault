...
---
# Ordained Purpose<span class="item-type">Focus 4</span>
...
**Failure** The creature takes full damage and must [[DATABASE/action/Drop Prone|Drop Prone]] as its first action on its next turn.
**Critical Failure** The creature takes double damage, must Drop Prone as its first action on its next turn, and can't [[DATABASE/action/Stand|Stand]] during its next turn.
