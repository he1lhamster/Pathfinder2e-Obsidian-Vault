...
---
# Force Cage<span class="item-type">Spell 7</span>
...
You create an immobile, invisible prison of sheer force. The cage is a 20-foot cube made of bands of force, each a half inch thick and a half inch apart, that extend to the [[DATABASE/plane/Ethereal Plane|Ethereal Plane]]. Each creature in the area where you create the cage must attempt a Reflex save. If such a creature fails, it becomes trapped inside the cage. If it succeeds, it's pushed outside the cage into a space of its choice. If a creature in the area is too big to fit inside the prison, the spell automatically fails.
 ...
 _Force cage_ is immune to counteracting effects of its level or lower, but it is automatically destroyed by a [[DATABASE/spell/Disintegrate|disintegrate]] spell of any level, or by contact with a _[[DATABASE/equipment/Rod of Cancellation|rod of cancellation]]_ or [[DATABASE/equipment/Sphere of Annihilation|sphere of annihilation]].