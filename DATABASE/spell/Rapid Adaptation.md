...
---
# Rapid Adaptation<span class="item-type">Spell 2</span>
...
* **Mountain** The target isn't [[Flat-Footed]] when [[Climb]], and when it rolls a success on an Acrobatics check to Balance on rubble, it gets a critical success instead.
