...
---
# Scintillating Safeguard<span class="item-type">Spell 6</span>

<span class="item-trait">Abjuration</span>
**Source** [[Advanced Player's Guide]] 
**Traditions** divine, occult, primal
**Cast** <span class="action-icon">5</span> somatic; **Trigger** An effect would deal physical or energy damage to you or a creature in range.
