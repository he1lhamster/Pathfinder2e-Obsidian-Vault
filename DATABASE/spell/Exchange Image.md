...
---
# Exchange Image<span class="item-type">Spell 1</span>
...
**Cast** <span class="action-icon">2</span> somatic, verbal; **Requirements** You have the humanoid trait.
...
**Success** You take on the target’s appearance, and they take yours. This has the same effects as a 1st-level [[DATABASE/spell/Illusory Disguise|illusory disguise]] spell, except that the target can’t [[DATABASE/action/Dismiss|Dismiss]] the disguise. The duration is 1 minute or until Dismissed.
