...
---
# Phantasmal Treasure<span class="item-type">Spell 2</span>

<span class="item-trait">Emotion</span><span class="item-trait">Illusion</span><span class="item-trait">Mental</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
...
**Success** The target becomes [[DATABASE/condition/Fascinated|fascinated]] with the treasure, and the duration is until the end of its turn. The target can also try to disbelieve the illusion if it touches the treasure, [[DATABASE/action/Seek|Seeks]] to examine it, or speaks to it if the illusion appears to be a person or the like. If the target disbelieves the illusion, the spell ends.
