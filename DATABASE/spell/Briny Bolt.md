...
---
# Briny Bolt<span class="item-type">Spell 1</span>
...
**Critical Success** The creature takes 4d6 bludgeoning damage and is [[DATABASE/condition/Blinded|blinded]] for 1 round and [[DATABASE/condition/Dazzled|dazzled]] for 1 minute as saltwater sprays into its eyes. The creature can spend an Interact action to rub its eyes and end the blinded condition, but not the dazzled condition.
