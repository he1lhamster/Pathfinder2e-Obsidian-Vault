...
---
# Forceful Hand<span class="item-type">Spell 5</span>
...
---
A Medium floating, disembodied hand made of magical force appears in an unoccupied space adjacent to you, following you across the battlefield to shield you against your foes' attacks. Each time you Sustain the Spell, the hand moves to an unoccupied space of your choice adjacent to you. When you Sustain the Spell, you can have the hand [[DATABASE/action/Fly|Fly]] to an unoccupied space of your choice adjacent to an ally to protect that ally instead. The hand's movement does not trigger reactions based on creature movement.
 Successful attacks against the hand damage it, and damaging effects that can target a creature can target the hand. The hand has an AC of 25, 50 Hit Points, and can't recover HP by any means. A hit by a [[DATABASE/spell/Disintegrate|disintegrate]] spell or similar effect destroys the hand.
...
* **Concentrate** The hand provides greater cover (+4 circumstance bonus to AC, Reflex, and [[DATABASE/skill/Stealth|Stealth]] checks) against all attacks that pass through the hand's square.
...
* **Swat** The hand Flies to an enemy of your choice within range and attempts to [[DATABASE/action/Shove|Push]] that enemy, using your spell attack roll instead of an [[DATABASE/skill/Athletics|Athletics]] check to determine the results of the Push.
...
* **Grasp** The hand Flies to an enemy of your choice within range and attempts to [[DATABASE/action/Grapple|Grapple]] that enemy, using your spell attack roll instead of an [[DATABASE/skill/Athletics|Athletics]] check to determine the results of the Grapple.
...
* **Crush** If the hand doesn't have a target grabbed, it Flies to an enemy of your choice within range and attempts to Strike that enemy with deadly crushing force. The hand's Strikes are melee spell attacks that deal 6d8 force damage. The hand's Strikes don't take or contribute to your multiple attack penalty. On a successful Strike, the target is [[DATABASE/condition/Grabbed|grabbed]] by the hand until the end of your next turn, unless the hand moves or the target successfully [[DATABASE/action/Escape|Escapes]] against your spell DC. However, if the hand has a target grabbed when it uses Crush, it instead [[DATABASE/monsterability/Constrict|Constricts]] the target, dealing 6d8 force damage with a basic Fortitude save.