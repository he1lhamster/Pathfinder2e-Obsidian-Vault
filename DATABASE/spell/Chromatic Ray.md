...
4. **Green** (poison) The ray deals 25 poison damage to the target, and the target must succeed at a Fortitude save or be [[Enfeebled]] for 1 minute (enfeebled 2 on a critical failure).
...
1. **Blue** The ray has the effect of the [[Flesh to Stone]] spell. On a critical hit, the target is [[Clumsy]] as long as it's [[Slowed]] by the _flesh to stone_ effect.
