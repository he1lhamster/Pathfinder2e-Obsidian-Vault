...
---
You wrap the targeted creatures in thin, sickly green shrouds that sap information from attackers. The shroud settles about each target's shoulders, granting a +1 status bonus to AC and a +2 status bonus to [[DATABASE/skill/Stealth|Stealth]] checks, both only while the target is in dim light or darkness.
...
**Failure** The attacker takes full damage and is [[DATABASE/condition/Sickened|sickened 1]]. In addition, the cloaked creature gleans a piece of information from the attacker's mind. The details and extent of this information are at the GM's discretion.
