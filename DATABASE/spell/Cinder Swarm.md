...
range: 60 feet
rarity: Common
saving_throw: Fortitude orbasicReflex (see text)
...
---
# Cinder Swarm<span class="item-type">Spell 4</span>
...
**Defense** Fortitude or basic Reflex (see text); **Duration** sustained up to 1 minute
...
* **Fireflies** (incapacitation) You create a flurry of fireflies that deal 3d6 fire damage and can dazzle or blind, depending on the target's Fortitude save. **Critical Success** The creature takes no damage.**Success** The creature takes half damage and is [[DATABASE/condition/Dazzled|dazzled]] for 1 round.**Failure** The creature takes full damage and is [[DATABASE/condition/Blinded|blinded]] for 1 round. It's then temporarily immune to being blinded by cinder swarm for 24 hours.**Critical Failure** As failure, but double damage and blinded for 1 minute.
