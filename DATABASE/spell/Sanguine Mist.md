...
---
You unleash a cloud of foul, blood-sucking fog that drains the vitality from the living to bolster your own. Each living creature in the area when you Cast the Spell, aside from you, takes 6d6 negative damage with a basic Fortitude save. Creatures in the area are [[DATABASE/condition/Concealed|concealed]], and all creatures outside the cloud become concealed to creatures within it.
