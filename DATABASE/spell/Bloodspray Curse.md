...
---
# Bloodspray Curse<span class="item-type">Spell 4</span>
...
**Failure** As success, but when it takes the additional damage, it also takes 2d6 [[DATABASE/condition/Persistent Damage|persistent bleed damage]].
