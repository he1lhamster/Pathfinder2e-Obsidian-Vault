...
---
# Infectious Comedy<span class="item-type">Spell 5</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Emotion</span><span class="item-trait">Enchantment</span><span class="item-trait">Incapacitation</span><span class="item-trait">Mental</span>
...
**Critical Failure** The target falls [[DATABASE/condition/Prone|prone]] and can't use actions or reactions for 1 round. It then suffers the failure effect.