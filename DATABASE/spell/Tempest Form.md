...
* **Air** You gain a fly Speed of 20 feet and become [[DATABASE/condition/Invisible|invisible]] while you are in the air. You can create the effects of a [[DATABASE/spell/Gust of Wind|gust of wind]] from your space as a 2-action activity, which has the manipulate trait.
* **Mist** You gain a fly Speed of 20 feet, and it becomes hard to see through you. Any creature on one side of your space who is targeted by a creature on the opposite side is [[DATABASE/condition/Concealed|concealed]] to the targeting creature.
