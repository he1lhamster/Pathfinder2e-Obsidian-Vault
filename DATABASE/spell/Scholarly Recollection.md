...
trigger: You attempt a Perception check to Seek, or you attempt a skill check to Recall
  Knowledge with a skillyou're trained in.
type: Focus

---
# Scholarly Recollection<span class="item-type">Focus 1</span>
...
**Cast** <span class="action-icon">5</span> verbal; **Trigger** You attempt a Perception check to Seek, or you attempt a skill check to Recall Knowledge with a skill you're trained in.
