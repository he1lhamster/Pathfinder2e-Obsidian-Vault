...
* **Green Man** Speed 40 feet, climb Speed 40 feet; **Melee** <span class="action-icon">1</span> vines (reach 30 feet, versatile P), **Damage** 6d8+12 bludgeoning; **Ranged** <span class="action-icon">1</span> thorns (range 100 feet), **Damage** 6d6+6 piercing; **Green Caress** (aura, primal, transmutation) 60 feet. Enemies other than plants must succeed at a Fortitude save against your spell DC or become clumsy 1 for 1 round (clumsy 2 on a critical failure).
* **Kaiju** Speed 50 feet; resistance 5 to physical damage; **Melee** <span class="action-icon">1</span> jaws (reach 30 feet), **Damage** 6d10+10 piercing; **Melee** <span class="action-icon">1</span> claws (agile, reach 30 feet), **Damage** 6d8+8 slashing; **Melee** <span class="action-icon">1</span> foot (agile, reach 15 feet), **Damage** 6d6+10 bludgeoning; **Unstoppable** You are immune to being immobilized and ignore difficult terrain and greater difficult terrain; **Trample** <span class="action-icon">3</span> You move up to double your Speed and move through the spaces of Huge or smaller creatures, trampling each creature whose space you enter. A trampled creature takes foot damage with a basic Reflex save against your spell DC.