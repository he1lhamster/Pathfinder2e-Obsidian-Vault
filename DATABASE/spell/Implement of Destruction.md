...
**Failure** The target weapon deals an additional 2d6 [[DATABASE/condition/Persistent Damage|persistent mental damage]] to the target enemy. If the enemy is critically hit by the weapon, the enemy is [[DATABASE/condition/Doomed|doomed 1]] for as long as it takes this persistent mental damage.
