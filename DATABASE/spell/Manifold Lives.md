...
---
# Manifold Lives<span class="item-type">Focus 6</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Cursebound</span><span class="item-trait">Divination</span><span class="item-trait">Emotion</span><span class="item-trait">Mental</span><span class="item-trait">Oracle</span>
**Source** [[DATABASE/source/Dark Archive|Dark Archive]]
**Mystery** [[DATABASE/oraclemystery/Time|time]]
...
**Success** The creature takes half damage and is [[DATABASE/condition/Stupefied|stupefied 2]] for 1 round.
**Failure** The creature takes full damage and is stupefied 2 for 1 minute. While affected, the creature must attempt another save at the start of its turn; on a failure, it's [[DATABASE/condition/Slowed|slowed 1]] for that turn as it sobs uncontrollably.
