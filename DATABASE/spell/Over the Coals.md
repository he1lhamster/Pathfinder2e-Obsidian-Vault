...
**Success** If the target doesn't comply with your request by the end of its next turn, it takes 3d8 [[Persistent Damage]]. If it later complies, the spell automatically ends.
**Failure** As success, but if the target doesn't comply, it is [[Drained]] and takes 6d8 persistent negative damage.
**Critical Failure** As success, but if the target doesn't comply, it is drained 2, [[Doomed]], and takes 6d8 persistent negative damage. Even if the target completes your commands later, the spell doesn't end until all the conditions end.
