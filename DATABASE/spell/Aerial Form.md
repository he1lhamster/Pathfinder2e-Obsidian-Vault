...
* **Bat** Speed 20 feet, fly Speed 30 feet; precise echolocation 40 feet; **Melee** <span class="action-icon">1</span> fangs, **Damage** 2d8 piercing; **Melee** <span class="action-icon">1</span> wing (agile), **Damage** 2d6 bludgeoning.
* **Bird** Speed 10 feet, fly Speed 50 feet; **Melee** <span class="action-icon">1</span> beak, **Damage** 2d8 piercing; **Melee** <span class="action-icon">1</span> talon (agile), **Damage** 1d10 slashing.
* **Pterosaur** Speed 10 feet, fly Speed 40 feet; imprecise scent 30 feet; **Melee** <span class="action-icon">1</span> beak, **Damage** 3d6 piercing.
* **Wasp** Speed 20 feet, fly Speed 40 feet; **Melee** <span class="action-icon">1</span> stinger, **Damage** 1d8 piercing plus 1d6 persistent poison.
