...
* **Living Creature** Make a spell attack roll. On a hit, the target takes 2d6 slashing damage. On a critical hit, double the damage, and the target also takes 1d4 [[Persistent Damage]]. If this spell's damage kills the target, the corpse is only bones.
* **Undead Creature** Make a spell attack roll. On a hit, the target takes 2d6 slashing damage. On a critical hit, double the damage, and the target also becomes [[Enfeebled]] for 1 minute. If this spell's damage destroys the target, only its bare bones remain behind.
