...
**Success** The target sheds bright light in a 20-foot emanation (and dim light to the next 40 feet) and becomes [[DATABASE/condition/Fascinated|fascinated]] with itself for 1 round. It must spend at least 1 action on its turn on a taunting display of arrogance or overconfidence. Using actions that include such a display—such as using [[DATABASE/action/Perform|Perform]] to show off—count toward this requirement.
