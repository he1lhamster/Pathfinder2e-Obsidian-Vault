...
---
# Dehydrate<span class="item-type">Spell 1</span>
...
---
You stir the inner fire of all things within the area, driving out moisture. All creatures in the area take 1d6 [[DATABASE/condition/Persistent Damage|persistent fire damage]] with a basic Fortitude save; creatures with the water or plant traits get a result one degree of success worse than they rolled. The spell ends for a creature when its persistent damage ends.
...
**Failure** The creature is [[DATABASE/condition/Enfeebled|enfeebled 1]] until the end of its next turn.
