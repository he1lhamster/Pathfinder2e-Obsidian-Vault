...
trigger: You attempt a [[DATABASE/skill/Performance|Performance]] check, but you haven't
  rolled yet
type: Item
...
<span class="item-trait">Auditory</span><span class="item-trait">Consumable</span><span class="item-trait">Evocation</span><span class="item-trait">Magical</span><span class="item-trait">Talisman</span>
**Source** [[Secrets of Magic]] 
**Price** 100 gp
**Usage** affixed to armor; **Bulk** —
**Activate** <span class="action-icon">4</span> envision **Trigger** You attempt a [[Performance]] check, but you haven't rolled yet; **Requirements** You're a master in Performance.
