...
---
# Silver Crescent<span class="item-type">Item 6+</span>

<span class="item-trait">Alchemical</span><span class="item-trait">Consumable</span><span class="item-trait">Light</span><span class="item-trait">Lozenge</span>
 ...
 **Secondary Effect** <span class="action-icon">2</span> **Effect** A ray of light descends on a 5-foot square of your choice within 120 feet. Any creature in that space takes positive damage with a basic Reflex save and is [[Dazzled]] until the end of its next turn on a failed save. This is treated as [[Silver Weapon]] for the purposes of weaknesses, resistances, and the like. The silver crescent becomes inert.

## Silver Crescent (Lesser)<span class="item-type">Item 6</span>

**Source** [[Treasure Vault]] 
**Price** 35 gp
The bonus is +1, the DC is 20, and the ray deals 4d6 damage.

## Silver Crescent (Moderate)<span class="item-type">Item 11</span>

**Source** [[Treasure Vault]] 
**Price** 235 gp
The bonus is +2, the DC is 28, and the ray deals 7d6 damage.

## Silver Crescent (Greater)<span class="item-type">Item 16</span>
