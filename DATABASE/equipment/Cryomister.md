...
---
# Cryomister<span class="item-type">Item 1+</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Cold</span><span class="item-trait">Consumable</span><span class="item-trait">Gadget</span>
**Source** [[DATABASE/source/Guns & Gears|Guns & Gears]]
...
## Cryomister (Moderate)<span class="item-type">Item 5</span>
...
## Cryomister (Greater)<span class="item-type">Item 11</span>
...
## Cryomister (Major)<span class="item-type">Item 17</span>

**Source** [[DATABASE/source/Guns & Gears|Guns & Gears]]
**Price** 2,500 gp
**Bulk** L
The area is a 20-foot burst, the Acrobatics DC is 39, and the cold splash damage is 8. The floating ice can support one Gargantuan creature, two Huge creatures, four Large creatures, or eight Medium or smaller creatures. The ice can't support Gargantuan creatures larger than a 20-by-20-foot space, such as a [[DATABASE/monster/Mu Spore|mu spore]].