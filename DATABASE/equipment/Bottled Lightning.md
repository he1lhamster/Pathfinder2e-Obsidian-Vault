...
---
# Bottled Lightning<span class="item-type">Item 1+</span>

<span class="item-trait">Alchemical</span><span class="item-trait">Bomb</span><span class="item-trait">Consumable</span><span class="item-trait">Electricity</span><span class="item-trait">Splash</span>
...
## Bottled Lightning (Lesser)<span class="item-type">Item 1</span>
...
## Bottled Lightning (Moderate)<span class="item-type">Item 3</span>
...
## Bottled Lightning (Greater)<span class="item-type">Item 11</span>
...
## Bottled Lightning (Major)<span class="item-type">Item 17</span>
