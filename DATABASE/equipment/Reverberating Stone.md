...
trigger: You use the affixed shield to [[DATABASE/feat/Shield Block|Shield Block]]
  a melee attack
type: Item
...
---
# Reverberating Stone<span class="item-type">Item 11+</span>
...
**Activate** <span class="action-icon">4</span> envision **Trigger** You use the affixed shield to [[Shield Block]] a melee attack; **Requirements** You're a master in [[Athletics]], and you have the affixed shield [[Raise a Shield]].
...
## Reverberating Stone (Greater)<span class="item-type">Item 15</span>
