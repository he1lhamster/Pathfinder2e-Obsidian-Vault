 ...
 **Cursed** The _Primordial Flame_ was cursed by Syarstik Painted-Tiger, the guardian spirit of Red Cat Cave. As long as it remains cursed, a creature that holds the _Primordial Flame_ can't willingly give up possession. A creature that has held the _Primordial Flame_ and no longer has it in their possession is wracked with mental anguish, becoming [[Clumsy]], [[Enfeebled]], [[Stupefied]], and [[Fatigued]]; these conditions can't be reduced or removed until the creature regains possession of the _Primordial Flame_ or the curse is removed. The curse can be removed only by avenging Syarstik.
...
**Activate** <span class="action-icon">2</span> command, Interact **Frequency** once per day; **Effect** The _Primordial Flame_ casts a 7th-level [[Sunburst]] spell. If you can cast spells higher than 7th level, the _Primordial Flame_ automatically heightens _sunburst_ to half your level rounded up.
**Activate** <span class="action-icon">2</span> command, Interact ; **Effect** The _Primordial Flame_ casts a 5th-level [[Produce Flame]] spell. If you can cast spells higher than 5th level, the _Primordial Flame_ automatically heightens _produce flame_ to half your level rounded up.
