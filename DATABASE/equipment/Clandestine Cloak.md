...
---
# Clandestine Cloak<span class="item-type">Item 6+</span>
...
**Activate** <span class="action-icon">2</span> envision, Interact **Frequency** once per day; **Effect** You pull the cloak’s hood up and gain the benefits of [[DATABASE/spell/Nondetection|nondetection]] for 1 hour or until you pull the hood back down, whichever comes first.
...
## Clandestine Cloak (Greater)<span class="item-type">Item 10</span>

**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Price** 900 gp
**Bulk** L
The item bonus is +2, and when you activate the cloak, you gain the benefits of 5th-level _nondetection_ for 8 hours.