...
---
# Standard of the Primeval Howl<span class="item-type">Item 10</span>

<span class="item-trait">Enchantment</span><span class="item-trait">Magical</span><span class="item-trait">Mental</span>
...
**Activate** <span class="action-icon">5</span> command **Frequency** once per hour; **Trigger** An ally within 20 feet of you critically hits with a Strike; **Requirements** You have the [[Battle Cry]] skill feat; **Effect** You attempt to [[Demoralize]] the foe the Strike hit.