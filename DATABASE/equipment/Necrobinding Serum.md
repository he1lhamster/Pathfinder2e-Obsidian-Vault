...
---
This potent necromantic serum is distilled from the body of an intelligent corporeal undead who seeks to establish absolute control over their undead minions. The raw materials of a _necrobinding serum_ are composed of a slurry made from the creator's own flesh and blood mixed with pulped fungal toxins. The exact ingredients vary, but the act of brewing a _necrobinding serum_ is typically viewed with distaste at best and, in many societies, is regarded as an evil act. While _necrobinding serum_ isn't a poison, its method of delivery is identical to that of an injury poison—it's applied to a weapon that's then used to Strike an undead target (living creatures suffer no additional effect from exposure to a dose of _necrobinding serum_).
