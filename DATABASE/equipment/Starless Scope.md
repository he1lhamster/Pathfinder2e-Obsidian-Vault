...
**Activate** <span class="action-icon">5</span> Interact **Frequency** once per day; **Trigger** you use the _starless scope_ as a divine focus; **Requirements** you worship Desna; **Effect** You attempt to enhance the effects of a spell as you cast it by attempting a [[Religion]] check against the spell's DC, as determined by Table 10–5
...
**Failure** As success, but the creature also suffers an additional effect. An incorporeal creature loses its incorporeal trait as long as it shines with starlight. Any other creature becomes [[Slowed]] as long as it shines with starlight.
