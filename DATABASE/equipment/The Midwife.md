...
---
# The Midwife<span class="item-type">Item 20</span>
...
**Usage** carried; **Bulk** —
**Suit** Stars (Wis); **Alignment** neutral good

---
_The Midwife_ represents the arrival of new life or new information, particularly via the aid of another. As long as you have _The Midwife_ invested, it grants a +2 item bonus to [[DATABASE/skill/Medicine|Medicine]] checks. This increases to a +3 bonus if you are at least 17th level.
**Activate** <span class="action-icon">5</span> command **Frequency** once per day; **Trigger** A creature you can sense within 60 feet would die or be destroyed; **Effect** You prevent the target from dying or being destroyed and restore to the target 6d8+24 Hit Points. This effect can prevent a death effect or [[DATABASE/spell/Disintegrate|disintegrate]] from slaying a target. The amount of healing granted increases to 7d8+28 if you're at least 15th level, 8d8+32 if you're at least 17th level, and 9d8+36 if you're at least 19th level.