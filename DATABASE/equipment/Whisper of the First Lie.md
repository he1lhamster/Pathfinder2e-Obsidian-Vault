...
**Activate** <span class="action-icon">3</span> Interact, envision, command ; **Effect** You unstopper the vial and release the lie, creating the effect of a [[DATABASE/spell/Fabricated Truth|fabricated truth]] (DC 47). The vial is emptied and can never be activated again.
