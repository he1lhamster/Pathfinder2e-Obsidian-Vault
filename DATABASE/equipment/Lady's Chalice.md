...
<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Conjuration</span><span class="item-trait">Divine</span><span class="item-trait">Good</span>
**Source** [[DATABASE/source/Book of the Dead|Book of the Dead]]
**Price** 60 gp
**Usage** held in 1 hand; **Bulk** L

---
This silver chalice bears the symbol of [[DATABASE/deity/Pharasma|Pharasma]], a swirling cloud that transforms into a flight of whippoorwills that encircle the top. The chalice can be activated in one of two ways, though only once per day total.

### [[DATABASE/action/envision|envision]] <span class="action-icon">1</span>
...
### [[DATABASE/action/Strike|Strike]] <span class="action-icon">1</span>
