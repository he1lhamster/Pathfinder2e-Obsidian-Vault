...
---
# The Peacock<span class="item-type">Item 20</span>
...
**Usage** carried; **Bulk** —
**Suit** Keys (Dex); **Alignment** neutral
...
**Activate** <span class="action-icon">2</span> envision, Interact **Frequency** once per day; **Effect** You freeze your appearance as it exists in this very moment by tapping _The Peacock_ to your lips. You cast [[Stoneskin]] on yourself, but with a duration of 30 minutes instead of 20 minutes. The level of the spell is one-half your level rounded down (minimum 6th level).