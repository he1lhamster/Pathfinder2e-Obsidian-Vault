...
---
# Instant Spy<span class="item-type">Item 2</span>
...
---
An instant spy is a tiny clockwork device that is small enough to be easily hidden. It contains the same audio-recording mechanisms as a [[DATABASE/monster/Clockwork Spy|clockwork spy]], as well as a short-lived gemstone that can store up to 1 hour of sound to play back later.
