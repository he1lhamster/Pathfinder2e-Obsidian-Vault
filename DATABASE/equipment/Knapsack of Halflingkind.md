...
---
# Knapsack of Halflingkind<span class="item-type">Item 9+</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Conjuration</span><span class="item-trait">Extradimensional</span><span class="item-trait">Healing</span><span class="item-trait">Invested</span><span class="item-trait">Magical</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Usage** worn backpack; **Bulk** L

---
This sturdy leather satchel contains three compartments fastened with large clasps. The first compartment is lined in blue satin and contains an extradimensional space equivalent to a [[DATABASE/equipment/Bag of Holding|type II bag of holding]].
...
## Knapsack of Halflingkind (Greater)<span class="item-type">Item 13</span>
