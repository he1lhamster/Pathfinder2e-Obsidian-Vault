...
---
# The Beating<span class="item-type">Item 20</span>
...
**Usage** carried; **Bulk** —
**Suit** Hammers (Str); **Alignment** neutral evil
...
**Activate** <span class="action-icon">4</span> envision **Frequency** once per day; **Effect** You wave the card to conjure up dozens of violent ghostly figures; you cast [[DATABASE/spell/Pernicious Poltergeist|pernicious poltergeist]], and the area of the spell is treated as difficult terrain in addition to its normal effects. The level of the spell is one-half your level, rounded down (minimum 6th level), and the save DC is your class DC.