...
---
# War Blood Mutagen<span class="item-type">Item 1+</span>
 ...
 **Benefit** Choose one melee weapon you're holding in one or both hands. You gain the listed item bonus to your attack rolls with this weapon and to Will saves against fear effects. Any attempt to [[DATABASE/action/Disarm|Disarm]] or otherwise remove the weapon from your hands must exceed the listed DC based on the type of war blood mutagen or the attempt fails.
 **Drawback** You can't voluntarily remove the weapon unless you succeed at an [[DATABASE/skill/Athletics|Athletics]] check at the listed DC, which ends the war blood mutagen's effects; this check takes a single action. If you perform an action with the concentrate trait, you must succeed at a DC 5 flat check or the action is lost.

## War Blood Mutagen (Lesser)<span class="item-type">Item 1</span>
...
## War Blood Mutagen (Moderate)<span class="item-type">Item 3</span>
...
## War Blood Mutagen (Greater)<span class="item-type">Item 11</span>
...
## War Blood Mutagen (Major)<span class="item-type">Item 17</span>
