...
**Saving Throw** DC 14 Fortitude; **Onset** 10 minutes; **Maximum Duration** 8 hours; **Stage 1** +1 item bonus to AC and saves to which you are taking penalties caused by the [[DATABASE/condition/Fatigued|fatigued]] condition (10 minutes); **Stage 2** [[DATABASE/condition/Stupefied|stupefied 1]] (1 hour); **Stage 3** can’t recover from fatigued (1 day, after which the drug ends)