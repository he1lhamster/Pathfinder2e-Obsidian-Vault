...
## Heartening Missive (Bull)<span class="item-type">Item 6</span>
...
## Heartening Missive (Butterfly)<span class="item-type">Item 5</span>

**Source** [[DATABASE/source/Treasure Vault|Treasure Vault]] 
**Price** 25 gp
Folded into a delicate butterfly, this missive grants the recipient a sense of grace and poise. Once during the next 24 hours, when the recipient fails a [[DATABASE/skill/Diplomacy|Diplomacy]] or [[DATABASE/skill/Performance|Performance]] check, they can improve the result from a failure to a success or from a critical failure to a failure. This is a fortune effect.

## Heartening Missive (Rabbit)<span class="item-type">Item 6</span>
...
## Heartening Missive (Turtle)<span class="item-type">Item 6</span>
