...
**Activate** Cast a Spell **Frequency** once per day, plus overcharge; **Effect** You cast [[Soothe]] of the indicated level, and can attempt to counteract one mental effect on the same target. Treat the _soothe_ spell's level as 1 higher for this counteract check.
