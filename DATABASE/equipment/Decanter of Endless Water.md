...
---
# Decanter of Endless Water<span class="item-type">Item 7</span>
...
**Activate** <span class="action-icon">1</span> command, Interact ; **Effect** Speaking “stream,” you cause water to pour out at a rate of 1 gallon per round.
**Activate** <span class="action-icon">1</span> command, Interact ; **Effect** Speaking “fountain,” you cause water to pour out in a 5-foot-long stream at a rate of 5 gallons per round.
**Activate** <span class="action-icon">1</span> command, Interact ; **Effect** Speaking “geyser,” you cause a powerful deluge of water to erupt at a rate of 15 gallons per round. You can direct the stream at a creature, subjecting it to the effects of [[Hydraulic Push]] (spell attack roll +15). You can repeat this once per round as long as the geyser continues, spending an Interact action to direct the geyser each time.