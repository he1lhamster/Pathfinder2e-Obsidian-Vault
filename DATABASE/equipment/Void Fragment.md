...
---
 **Stage 1 (8 Days)** The first time you enter this stage from a given void fragment, you gain the effect of a [[DATABASE/equipment/Potion of Tongues|potion of tongues]] for 3 days. The wisp grants you [[DATABASE/monsterability/Telepathy|telepathy]] with a range of 30 feet. Also, you are under the effects of [[DATABASE/spell/Mind Blank|mind blank]], except that its status bonus is +1 and it counteracts with a bonus equal to your class DC – 9. The wisp grants you resistance to mental damage equal to half your level. You also have access to the following activation.
...
**Stage 2 (24 Days)** You gain imprecise thoughtsense to half your telepathy's range, which increases to 60 feet. However, you have a tough time filtering the mental noise. If any creatures can be detected by your thoughtsense, you take a –1 penalty to Perception checks. When you arrive in a space after using the activation to teleport, you create a 10-foot emanation that works like [[DATABASE/spell/Strange Geometry|strange geometry]] for 1 round. This emanation can affect you.
 If you die at this stage or higher, your body implodes. Your soul reincarnates as an aberration of a level close to yours, which extrudes from the location of your implosion. Common forms include [[DATABASE/monster/Amalgamite|amalgamite]], [[DATABASE/monster/Brain Collector|brain collector]], [[DATABASE/monster/Gibbering Mouther|gibbering mouther]], [[DATABASE/monster/Gosreg|gosreg]], [[DATABASE/monster/Intellect Devourer|intellect devourer]], [[DATABASE/monster/Quelaunt|quelaunt]], or [[DATABASE/monster/Shoggoth|shoggoth]]. This creature isn't you, but fleeting memories of your former existence remain with it. You can't be raised from the dead while this monster endures. Its alignment is chaotic evil. The _void fragment_ reappears somewhere on the same planet.
