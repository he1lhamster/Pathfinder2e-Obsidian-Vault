...
---
# Hosteling Statuette<span class="item-type">Item 4</span>
...
**Activate** <span class="action-icon">2</span> envision, Interact **Requirements** Your companion is in statuette form; **Effect** You call forth your companion from the statuette, causing it to unmerge and appear in an unoccupied space adjacent to you.