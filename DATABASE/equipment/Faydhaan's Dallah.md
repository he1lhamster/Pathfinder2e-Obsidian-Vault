...
---
# Faydhaan's Dallah<span class="item-type">Item 14</span>
...
**Activate****—Faydhaan's Hospitality** <span class="action-icon">2</span> (concentrate); **Frequency** once per day; **Requirements** You used the dallah's activation to brew a batch of coffee today; **Effect** You speak the name of the faydhaan shuyookh inscribed on the dallah. You don't need to be holding the dallah to use this activation. The shuyookh transmutes the coffee within the body of each creature who partook from the batch you brewed, choosing a single common potion of 6th level or lower, which grants them all the benefits of that potion. Typically, the shuyookh chooses a [[DATABASE/equipment/Healing Potion|moderate healing potion]], [[DATABASE/equipment/Potion of Resistance|lesser potion of resistance]], or [[DATABASE/equipment/Potion of Swimming|potion of swimming]].