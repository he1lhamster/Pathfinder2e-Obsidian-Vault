...
---
# Alchemist's Fire<span class="item-type">Item 1+</span>

<span class="item-trait">Alchemical</span><span class="item-trait">Bomb</span><span class="item-trait">Consumable</span><span class="item-trait">Fire</span><span class="item-trait">Splash</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
...
## Alchemist's Fire (Lesser)<span class="item-type">Item 1</span>
...
## Alchemist's Fire (Moderate)<span class="item-type">Item 3</span>
...
## Alchemist's Fire (Greater)<span class="item-type">Item 11</span>
...
## Alchemist's Fire (Major)<span class="item-type">Item 17</span>
