...
---
# Crafter's Eyepiece<span class="item-type">Item 3+</span>
...
## Crafter's Eyepiece (Greater)<span class="item-type">Item 11</span>

**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Price** 1,200 gp
The eyepiece grants a +2 item bonus and can be activated.
**Activate** 1 minute (Interact) **Frequency** once per day; **Effect** You calibrate the eyepiece to have it cast a 5th-level [[DATABASE/spell/Creation|creation]] spell over the course of 1 minute to construct a temporary item.