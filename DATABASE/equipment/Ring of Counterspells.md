...
---
# Ring of Counterspells<span class="item-type">Item 10</span>
...
**Activate** <span class="action-icon">5</span> envision **Trigger** You are targeted by or within the area of the spell stored within the ring; **Effect** You can attempt to counteract the triggering spell, using the level of the spell stored in the ring and a counteract modifier of +19. Once you do, the stored spell’s energy is spent, and the ring is empty.
**Activate** <span class="action-icon">1</span> command ; **Effect** You harmlessly expend the stored spell, having no effect but emptying the ring so that another spell can be cast into it.