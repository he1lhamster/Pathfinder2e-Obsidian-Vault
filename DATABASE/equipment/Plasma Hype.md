...
spell: null
stage: 'Stage 1: +10-foot status bonus to speed, quickened andcan use the additional
  action to Step, Stride, Climb, orSwim (1 round)Stage 2: quickened and can use the
  additional action to Step or Stride (1 round)Stage 3: drained 2 and stupefied 2
  (1 round)'
