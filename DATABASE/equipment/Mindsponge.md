...
**Activate** <span class="action-icon">2</span> envision, Interact ; **Effect** The _mindsponge_ casts [[Modify Memory]], but only to erase a memory—a _mindsponge_ can't enhance memory clarity, alter memories, or add false memories.
