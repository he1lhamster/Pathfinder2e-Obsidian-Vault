...
---
The tip of this _+2 greater striking [[Spear]]_ is large and wickedly barbed, and the haft is inlaid with fine silver lines that run the length of the weapon. Wielded by specially trained [[Xulgath]] cavalry, _anchor spears_ are used to prevent the escape of gogiteths or other monsters capable of climbing or burrowing.
**Activate** <span class="action-icon">1</span> command ; **Effect** The _anchor spear_ extends into a _+2 greater striking [[Longspear]]_ or back to its original form as a _+2 greater striking spear_.
