...
<span class="trait-unique item-trait">Unique</span><span class="item-trait">Invested</span><span class="item-trait">Magical</span><span class="item-trait">Necromancy</span>
...
**Activate** <span class="action-icon">1</span> envision ; **Effect** You switch the mask to its other form.
**Activate** <span class="action-icon">2</span> envision **Frequency** once per day; **Effect** You cast [[DATABASE/spell/Crisis of Faith|crisis of faith]] (DC 34), targeting up to four creatures within 30 feet. If the mask is in its angelic form, you can target only evil and neutral creatures. If the mask is in its demonic form, you can target only good and neutral creatures.
**Activate** 10 minutes (command, envision, Interact) **Requirements** A soul fragment is in the mask; **Effect** You cast [[DATABASE/spell/Talking Corpse|talking corpse]] on the soul fragment, except you communicate telepathically and don't require the fragment's body to speak.