...
**Activate** <span class="action-icon">5</span> envision (positive) **Frequency** once per day; **Trigger** You gain the [[Drained]] condition from an undead creature; **Effect** Reduce the value of the drained condition you gain by 1, and the undead that caused the condition takes 2d6 positive damage.