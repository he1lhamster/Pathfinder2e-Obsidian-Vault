...
---
Developed by [[Urdefhan]] for their [[Skaveling]] mounts but quickly copied by other races' cavalry, this leather saddle is made from [[Cave Worm]] hide and is designed to fit a variety of flying steeds. In addition to a seat for the rider, the _bomber's saddle_ has a bomb compartment situated underneath the mount. The compartment can hold up to six alchemical bombs of light or negligible Bulk.
**Activate** <span class="action-icon">1</span> Interact ; **Effect** You drop a single item from the saddle's compartment, which falls to the ground below. If the item is a [[Bomb]], make a ranged Strike with it.
