...
**Activate** <span class="action-icon">1</span> envision, Interact ; **Effect** You learn which of the ace and face cards are still in the deck. You can then swap the apparent face of an ace or face card in your hand (if you have any) with the face of one still in the deck. A creature who [[Seek]] or touches the card can attempt to disbelieve this illusion (Perception DC 20).