...
---
_Fulcrum lenses_ are unique magical crystals that each contain a sliver of [[DATABASE/deity/Nhimbaloth|Nhimbaloth's]] essence. They belong to a larger set of lenses created to manipulate or even bind the Empty Death; most of the other lenses are long lost and likely destroyed. The Haruvex family came into possession of four of the lenses, and they knew that bringing them together focused Nhimbaloth's attention in unprecedented and dangerous ways. Belcorra brought all four lenses to the Abomination Vaults with her, intending to install them in Gauntlight for her ultimate revenge upon Absalom. She also created a special receptacle called the [[DATABASE/equipment/Fulcrum Lattice|Fulcrum Lattice]] to hold the lenses so that their power could be focused together. She realized the danger of keeping the _fulcrum lenses_ too close together until the right time and spread them out among loyal groups in the Abomination Vaults' lowest levels for safekeeping.
 ...
 **Activate** <span class="action-icon">2</span> Interact; **Frequency** once per day; **Requirement** At least one glimmer remains in the _Ebon Fulcrum Lens_; **Effect** You draw upon a glimmer of Nhimbaloth's essence for power; reduce the number of glimmers remaining in the lens by 1. You're [[DATABASE/condition/Quickened|quickened]] for 1 minute and gain a +1 item bonus to attack rolls, saving throws, and DCs. You can use this extra action to [[DATABASE/action/Stride|Stride]] or [[DATABASE/action/Step|Step]], or for an action in a special ghost ability you have.
 ...
 **Activate** <span class="action-icon">2</span> Interact; **Frequency** once per day; **Effect** You hold up the _Ochre Fulcrum Lens_ in your hand and the item casts [[DATABASE/spell/Crushing Despair|crushing despair]] (DC 31 Will save). 
