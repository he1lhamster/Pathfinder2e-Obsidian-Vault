...
---
# Dreamstone<span class="item-type">Item 9+</span>
...
**Activate** <span class="action-icon">1</span> Interact (metamagic) **Frequency** once per day; **Effect** If the next action you use is to Cast a Spell of 4th level or lower that has the sleep trait or is associated with dreams, the spell slot is not expended.
...
## Cursed Dreamstone<span class="item-type">Item 9</span>
