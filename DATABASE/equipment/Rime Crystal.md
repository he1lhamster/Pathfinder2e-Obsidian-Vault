...
---
# Rime Crystal<span class="item-type">Item 3+</span>

<span class="item-trait">Cold</span><span class="item-trait">Evocation</span><span class="item-trait">Magical</span><span class="item-trait">Spellheart</span>
**Source** [[DATABASE/source/Treasure Vault|Treasure Vault]] 
...
**Activate** Cast a Spell ; **Effect** You cast [[DATABASE/spell/Ray of Frost|ray of frost]].
...
## Rime Crystal (Greater)<span class="item-type">Item 8</span>
...
**Activate** Cast a Spell **Frequency** once per day; **Effect** You cast 3rd-level [[DATABASE/spell/Chilling Spray|chilling spray]].

## Rime Crystal (Major)<span class="item-type">Item 13</span>
...
**Activate** Cast a Spell **Frequency** once per day; **Effect** You cast [[DATABASE/spell/Ice Storm|ice storm]].
**Activate** Cast a Spell **Frequency** once per day; **Effect** You cast [[DATABASE/spell/Cone of Cold|cone of cold]].