...
---
_The Carnival_ represents false dreams. When you have _The Carnival_ invested, your flat check DCs to obtain reliable information from divination effects (such as [[DATABASE/spell/Augury|augury]] or [[DATABASE/spell/Read Fate|read fate]], or the activation of this card) are reduced by 2 (but not to less than 2). Casting a divination effect with a flat check, whether or not the flat check succeeds, gives a series of subtly different visions that don't confuse the meaning but make you [[DATABASE/condition/Stupefied|stupefied 1]] for 1 round. If you're at least 17th level, the flat check is instead reduced by 3.
