...
**Activate** <span class="action-icon">1</span> Interact ; **Effect** This potion functions as a bottle of [[Holy Water]]. Like holy water, you throw it as a Strike. It's a simple thrown weapon with a range increment of 20 feet. Unlike an alchemical bomb, it doesn't add the manipulate trait to the attack made with it.
