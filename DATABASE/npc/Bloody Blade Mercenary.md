...
# Bloody Blade Mercenary<span class="item-type">Creature 1</span>

<span class="trait-alignment item-trait">NE</span><span class="trait-size item-trait">Medium</span><span class="item-trait">Half-Orc</span><span class="item-trait">Human</span><span class="item-trait">Humanoid</span><span class="item-trait">Orc</span>
**Source** [[DATABASE/source/Pathfinder 145. Hellknight Hill|Pathfinder #145: Hellknight Hill]]
[[DATABASE/ancestry/Human|Human]] ([[DATABASE/ancestry/Half-Orc|half-orc]]) ranger 1
**Perception** +6
**Languages** [[DATABASE/language/Common|Common]], [[DATABASE/language/Orcish|Orcish]]
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +6, [[DATABASE/skill/Athletics|Athletics]] +7, [[DATABASE/skill/Intimidation|Intimidation]] +2, [[DATABASE/skill/Nature|Nature]] +4, [[DATABASE/skill/Stealth|Stealth]] +6, [[DATABASE/skill/Survival|Survival]] +4, [[DATABASE/skill/Thievery|Thievery]] +6
**Str** +4, **Dex** +3, **Con** +1, **Int** +0, **Wis** +1, **Cha** -1
**Items** 15 sp, [[DATABASE/weapon/Longsword|longsword]], [[DATABASE/weapon/Shortbow|shortbow (20 arrows)]], [[DATABASE/armor/Studded Leather Armor|studded leather armor]]
...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> longsword +9 [+4/-1] (versatile P), **Damage** 1d8+4 slashing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> shortbow +8 [+3/-2] (deadly 1d10, range increment 60 feet, reload 0), **Damage** 1d6 piercing</span><span class="in-box-ability">**[[DATABASE/action/Hunt Prey|Hunt Prey]]** <span class="action-icon">1</span> You designate a single creature as your prey and focus your attacks against that creature. You must be able to see or hear the prey, or you must be tracking the prey during exploration.
