...
# Kereek<span class="item-type">Creature 5</span>
...
**Items** [[DATABASE/weapon/Dagger|dagger]], robes, _wand of [[DATABASE/spell/Burning Hands|burning hands]]_ (1st)
...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> dagger +11 [+7/+3] (agile, finesse, thrown 10 feet, versatile S), **Damage** 1d4+3 piercing</span>**Arcane Spontaneous Spells** DC 22, attack +14; **3rd** _[[DATABASE/spell/Burning Hands|burning hands]]_, _[[DATABASE/spell/Slow|slow]]_ (2 slots); **2nd** _[[DATABASE/spell/Burning Hands|burning hands]]_, _[[DATABASE/spell/Invisibility|invisibility]]_, _[[DATABASE/spell/Obscuring Mist|obscuring mist]]_ (3 slots); **1st** _[[DATABASE/spell/Burning Hands|burning hands]]_, _[[DATABASE/spell/Magic Missile|magic missile]]_, _[[DATABASE/spell/Pest Form|pest form]]_ (3 slots); **Cantrips** **(3rd)** _[[DATABASE/spell/Daze|daze]]_, _[[DATABASE/spell/Mage Hand|mage hand]]_, _[[DATABASE/spell/Message|message]]_, _[[DATABASE/spell/Produce Flame|produce flame]]_, _[[DATABASE/spell/Shield|shield]]_
<span class="in-box-ability">**Hurried Retreat** <span class="action-icon">1</span> **Requirements** The kobold warrior is adjacent to at least one enemy. **Effect** The kobold warrior Strides up to its Speed plus 5 feet and gains a +2 circumstance bonus to AC against reactions triggered by this movement. It must end this movement in a space that's not adjacent to any enemy.</span>