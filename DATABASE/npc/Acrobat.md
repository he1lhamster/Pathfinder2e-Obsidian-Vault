...
description: 'Acrobats perform feats of agility, balance, and strength. The acrobat
  is a 5th-level challenge for contests of acrobatics and the like.<br/><br/><b><u>Recall
...
- '[[DATABASE/skill/Lore|Circus Lore]] +5'
...
**HP** 28
<span class="in-box-ability">**Cat Fall** The acrobat treats all falls as 50 feet shorter.</span><span class="in-box-ability">**Nimble Dodge <span class="action-icon">5</span> ** **Trigger** The acrobat is targeted with a melee or ranged attack by an attacker they can see; **Effect** The acrobat gains a +2 circumstance bonus to AC against the triggering attack.</span>
