...
- '[[DATABASE/skill/Lore|Pathfinder Society Lore]] +11'
...
# Pathfinder Field Agent<span class="item-type">Creature 4</span>

<span class="trait-alignment item-trait">N</span><span class="trait-size item-trait">Medium</span><span class="item-trait">Elf</span><span class="item-trait">Human</span><span class="item-trait">Humanoid</span>
**Source** [[DATABASE/source/Character Guide|Character Guide]] 
**Perception** +11; [[DATABASE/monsterability/Low-Light Vision|low-light vision]], trap finder
**Languages** [[DATABASE/language/Common|Common]]
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +12, [[DATABASE/skill/Arcana|Arcana]] +8, [[DATABASE/skill/Athletics|Athletics]] +6, [[DATABASE/skill/Deception|Deception]] +6, [[DATABASE/skill/Diplomacy|Diplomacy]] +6, [[DATABASE/skill/Lore|Pathfinder Society Lore]] +11, [[DATABASE/skill/Stealth|Stealth]] +12, [[DATABASE/skill/Survival|Survival]] +8, [[DATABASE/skill/Thievery|Thievery]] +10
**Str** +0, **Dex** +4, **Con** +3, **Int** +2, **Wis** +2, **Cha** +0
**Scout's Warning <span class="action-icon">5</span> ** **Trigger** The field agent is about to roll a Perception check for initiative. **Effect** The field agent audibly or visually warns their allies of imminent danger. This ability gains the auditory trait if the warning is audible, and the visual trait if the warning is visual. Any ally who is able to hear the agent (if the warning is audible) or see the agent (if the warning is visual) gains a +1 circumstance bonus to their initiative roll.
**Items** [[DATABASE/equipment/Healing Potion|minor healing potion]], [[DATABASE/equipment/Comprehension Elixir|comprehension elixir]], [[DATABASE/equipment/Infiltrator's Elixir|infiltrator's elixir]], [[DATABASE/weapon/Rapier|rapier]], [[DATABASE/weapon/Shortbow|shortbow (20 arrows)]], [[DATABASE/armor/Studded Leather Armor|studded leather armor]], [[DATABASE/equipment/Thieves' Tools|thieves' tools]]

---
**AC** 21 (22 against traps); **Fort** +10, **Ref** +13, **Will** +11; +1 circumstance to all saves vs. traps
**HP** 60
<span class="in-box-ability">**Deny Advantage** The field agent isn't [[DATABASE/condition/Flat-Footed|flat-footed]] to flanking, [[DATABASE/condition/Hidden|hidden]], or [[DATABASE/condition/Undetected|undetected]] creatures of 4th level or lower, or to creatures of 4th-level or lower using surprise attack.</span>

---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> rapier +12 [+7/+2] (deadly 1d8, disarm), **Damage** 1d6+6 piercing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> shortbow +12 [+7/+2] (deadly d10, range increment 60 feet, reload 0), **Damage** 1d6+2 piercing</span><span class="in-box-ability">**Mobility** When the field agent takes a Stride action to move half their Speed or less, that movement does not trigger reactions.</span><span class="in-box-ability">**[[DATABASE/monsterability/Sneak Attack|Sneak Attack]]** 2d6</span><span class="in-box-ability">**Surprise Attack** On the first round of combat, any creatures that haven't acted yet are [[DATABASE/condition/Flat-Footed|flat-footed]] to the field agent.</span><span class="in-box-ability">**Trap Finder** The field agent has an intuitive sense that alerts them to the dangers and presence of traps. They gain a +1 circumstance bonus to Perception checks to find traps, to AC against attacks made by traps, and to saves against traps. Even if they aren't [[DATABASE/action/Search|Searching]], they still get a check to find traps. They can disable traps that require a proficiency rank of master in [[DATABASE/skill/Thievery|Thievery]].</span>
