...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> fist +4 [+0/-4] (agile, nonlethal, unarmed), **Damage** 1d4+2 bludgeoning</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> crossbow +4 [-1/-6] (range increment 120 feet, reload 1), **Damage** 1d8 piercing</span>