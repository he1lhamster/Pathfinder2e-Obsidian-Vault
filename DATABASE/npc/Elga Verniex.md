...
- '[[DATABASE/spell/Wanderer''s Guide|Wanderer''sGuide]]'
strength: '+0'
strength_req: '0'
strongest_save:
- Will
...
**HP** 90
<span class="in-box-ability">**Moment of Solitude <span class="action-icon">5</span> ** (fortune) **Trigger** Elga fails or critically fails a saving throw against an effect with the enchantment or linguistics trait; **Effect** Elga rerolls the saving throw and takes the better result.</span>
