...
**HP** 200
<span class="in-box-ability">**Cat's Luck <span class="action-icon">5</span> ** (fortune) **Frequency** once per day; **Trigger** Yonsuu fails or critically fails a Reflex saving throw; **Effect** Yonsuu rerolls the saving throw and takes the better result.</span>
