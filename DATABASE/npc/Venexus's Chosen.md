...
description: 'This creature did not include a description.<br/><br/><b><u>Recall Knowledge
  ...
  )</b>: DC 27<br/><b><u>Recall Knowledge - Humanoid</u> ( [[DATABASE/skill/Society|Society]]
...
---
**AC** 23; **Fort** +14, **Ref** +16, **Will** +14
**HP** 115; **Resistances** cold 5; **Weaknesses** fire 5
<span class="in-box-ability">**Tail Lash** <span class="action-icon">5</span> **Trigger** A creature within reach of the chosen's tail Strike uses an action to Strike or attempt a skill check **Effect** Venexus's chosen attempts to Strike the triggering creature with their tail. If it hits, the creature takes a –2 circumstance penalty to the triggering roll.</span>
