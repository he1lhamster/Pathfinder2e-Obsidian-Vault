...
**HP** 150
<span class="in-box-ability">**Nimble Dodge <span class="action-icon">5</span> ** **Trigger** A creature targets Fayati with an attack and she can see the attacker; **Effect** Fayati dodges out of the way, gaining a +2 circumstance bonus to AC against the triggering attack.</span><span class="in-box-ability">**Opportune Backstab <span class="action-icon">5</span> ** **Trigger** A creature within Fayati's reach is hit by a melee Strike from one of her allies; **Effect** Fayati makes a Strike against the triggering creature.</span>
