...
**HP** 115
<span class="in-box-ability">**Spry Dodge <span class="action-icon">5</span> ** **Trigger** The archer is targeted with a melee or ranged attack by an attacker they can see; **Effect** The archer gains a +2 circumstance bonus to AC against the triggering attack. If the attack misses, the archer can Step.</span>
