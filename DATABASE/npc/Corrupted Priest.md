...
- '[[DATABASE/skill/Lore|GozrehLore]] +8'
...
**HP** 45
<span class="in-box-ability">**Roiling Mind <span class="action-icon">5</span> ** **Trigger** The corrupted priest is targeted by an effect with the mental trait or that requires a Will save; **Effect** The hermit's mind is a storm of chaos due to demonic influences. The creator of the triggering effect takes 3d8 mental damage (DC 20 basic Will save).</span>
