...
**HP** 315
<span class="in-box-ability">**Return Fire <span class="action-icon">5</span> ** **Trigger** The Scarlet Triad boss is the target of a physical ranged attack; **Effect** They gain a +4 circumstance bonus to AC against the triggering attack. If the attack misses and the boss has their shortbow in hand, the boss Strikes the attacker with their shortbow.</span>
