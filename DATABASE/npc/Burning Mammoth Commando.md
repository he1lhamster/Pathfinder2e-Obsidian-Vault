...
**HP** 120
<span class="in-box-ability">**Evasion** When the commando rolls a success on a Reflex save, they get a critical success instead.</span><span class="in-box-ability">**Spurred by Death <span class="action-icon">5</span> ** **Trigger** An ally within 30 feet reduces a creature to 0 HP; **Effect** The commando Interacts to draw a weapon, Steps, Strides, or uses Hunt Prey.</span>
