...
**HP** 32
<span class="in-box-ability">**Bob and Weave <span class="action-icon">5</span> ** **Trigger** Jellico is the target of a Strike by an attacker he can see; **Effect** Jellico gains a +2 circumstance bonus to AC against the triggering Strike.</span>
