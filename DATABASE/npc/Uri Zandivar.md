...
**Perception** +35
**Languages** [[DATABASE/language/Common|Common]], [[DATABASE/language/Draconic|Draconic]], [[DATABASE/language/Dwarven|Dwarven]], [[DATABASE/language/Gnoll|Gnoll]], [[DATABASE/language/Osiriani|Osiriani]]
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +37, [[DATABASE/skill/Arcana|Arcana]] +33, [[DATABASE/skill/Athletics|Athletics]] +37, [[DATABASE/skill/Deception|Deception]] +40, [[DATABASE/skill/Diplomacy|Diplomacy]] +37, [[DATABASE/skill/Intimidation|Intimidation]] +40, [[DATABASE/skill/Society|Society]] +27, [[DATABASE/skill/Stealth|Stealth]] +31, [[DATABASE/skill/Thievery|Thievery]] +33, [[DATABASE/skill/Lore|Underworld Lore]] +31
**Str** +9, **Dex** +7, **Con** +5, **Int** +7, **Wis** +8, **Cha** +9
**Items** _+2 [[DATABASE/equipment/Striking|striking]] [[DATABASE/equipment/Returning|returning]] [[DATABASE/weapon/Dagger|dagger]]_, _+3 [[DATABASE/equipment/Striking|major striking]] [[DATABASE/equipment/Speed|speed]] [[DATABASE/weapon/Scimitar|scimitar]]_, [[DATABASE/shield/Steel Shield|steel shield]] with _+2 [[DATABASE/equipment/Striking|greater striking]] [[DATABASE/weapon/Shield Spikes|shield spikes]]_ (Hardness 5, HP 20, BT 10), _[[DATABASE/equipment/Winged Boots|winged boots]]_, _+2 [[DATABASE/equipment/Resilient|greater resilient]] [[DATABASE/armor/Chain Mail|chain mail]]_, [[DATABASE/equipment/Oblivion Essence|oblivion essence]], [[DATABASE/equipment/Manacles|superior manacles]], wasp trapped in amber, [[DATABASE/equipment/Weeping Midnight|weeping midnight]]

---
**AC** 43 (45 with shield raised); **Fort** +32, **Ref** +29, **Will** +35 (perfect will)
**HP** 350
<span class="in-box-ability">**Perfect Will** If Uri rolls a success on a Will saving throw, he gets a critical success instead; if he rolls a critical failure on a Will save, he gets a failure instead.</span><span class="in-box-ability">**[[DATABASE/monsterability/Attack of Opportunity|Attack of Opportunity]] <span class="action-icon">5</span> ** </span><span class="in-box-ability">**Punish Imperfection <span class="action-icon">5</span> ** **Trigger** A creature within Uri's reach fails an attack roll, saving throw, or skill check; **Effect** Uri makes an unarmed Strike against the triggering creature. If the attack hits, the target must succeed at a DC 41 Fortitude save or become [[DATABASE/condition/Enfeebled|enfeebled]] 3 until the end of its next turn (enfeebled 4 on a critical failure).</span><span class="in-box-ability">**[[DATABASE/monsterability/Shield Block|Shield Block]] <span class="action-icon">5</span> ** </span>

---
**Speed** 30 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> _speed scimitar_ +37 [+32/+27] (forceful, magical, sweep), **Damage** 4d6+17 slashing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> _shield spikes_ +36 [+31/+26] (magical), **Damage** 3d6+17 piercing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> _dagger_ +34 [+30/+26] (agile, thrown 10 feet, versatile S), **Damage** 4d4+12 piercing</span><span class="in-box-ability">**Reactionary** Uri can use 2 reactions in a round, but he can't perform the same reaction more than once per round.</span><span class="in-box-ability">**Slash and Slam** <span class="action-icon">2</span> Uri makes two Strikes: one with his scimitar and one with his shield spikes. If both hit, the overwhelming power of the attack leaves the target [[DATABASE/condition/Stunned|stunned 1]] (stunned 2 if one of the Strikes was a critical hit, or stunned 3 if both Strikes were critical hits). These Strikes count as one attack for Uri's multiple attack penalty, and the penalty doesn't increase until after both attacks.</span><span class="in-box-ability">**Swift Capture** <span class="action-icon">2</span> (attack, manipulate) **Requirements** Uri has [[DATABASE/equipment/Manacles|manacles]] in his possession and is adjacent to a creature; **Effect** Uri sheathes a weapon he's carrying, then attempts to bind the creature's wrists or ankles with the manacles. If Uri succeeds at an attack roll with a +36 modifier against the target's AC, he applies the manacles.</span><span class="in-box-ability">**Swift Slash** <span class="action-icon">1</span> Uri Strides and makes a scimitar Strike at any point during the Stride.</span>