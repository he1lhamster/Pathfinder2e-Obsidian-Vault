...
- '[[DATABASE/spell/Crisis of Faith|Crisisof Faith]]'
...
- '[[DATABASE/spell/Waking Nightmare|Waking Nightmare]]'
strength: '+4'
strength_req: '4'
strongest_save:
- Will
...
**HP** 85
<span class="in-box-ability">**Spiteful Command** <span class="action-icon">5</span> (auditory) **Trigger** Malgorzata is targeted with an attack or single-target spell. **Effect** Malgorzata commands a Gyronna cultist within reach of the triggering creature to attack the creature, allowing it to make a melee Strike after the triggering action resolves its effects.</span>
