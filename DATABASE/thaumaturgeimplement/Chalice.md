...
### [[DATABASE/action/Drink from the Chalice|Drink from the Chalice]] <span class="action-icon">1</span>
...
When you or an ally drain the chalice, the overwhelming vitality it's collected helps you overcome many ailments. Reduce the drinker's [[DATABASE/condition/Clumsy|clumsy]], [[DATABASE/condition/Enfeebled|enfeebled]], [[DATABASE/condition/Frightened|frightened]], [[DATABASE/condition/Stupefied|stupefied]], and [[DATABASE/condition/Stunned|stunned]] values by 1. (This reduces the stunned condition only if it has a condition value, not when it has a duration.) The drinker also reduces its [[DATABASE/condition/Drained|drained]] value by 1, but it can reduce its drained condition by Drinking from the Chalice only once per day. 
