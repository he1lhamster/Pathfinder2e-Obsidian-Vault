...
### [[DATABASE/action/Mirror's Reflection|Mirror's Reflection]] <span class="action-icon">1</span>
...
Reinforcing your mirror lets it play tricks on your enemy's senses as it bends light this way or that. You become [[DATABASE/condition/Concealed|concealed]] to the target of your [[DATABASE/action/Exploit Vulnerability|Exploit Vulnerability]] as your mirror warps its perceptions. As normal for concealment where your overall location is still obvious, you can't use this concealment to [[DATABASE/action/Hide|Hide]] or [[DATABASE/action/Sneak|Sneak]].
