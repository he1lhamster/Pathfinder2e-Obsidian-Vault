...
<span>Item Bonuses for Medicine - Common Items</span>
...
<span>Item Bonuses for Medicine - Uncommon/Rare/Unique Items</span>
...
* **Stop Bleeding** Attempt a Medicine check on a creature that is taking [[Persistent Damage]] bleed damage, giving them a chance to make another flat check to remove the persistent damage. The DC is usually the DC of the effect that caused the bleed.
