...
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
You're dishonorable, dishonest, and committed to breaking the false hopes of kindness. You gain the Destructive Vengeance champion's reaction and the [[DATABASE/spell/Touch of Corruption|touch of corruption]] devotion spell. After the tenets of evil, add these tenets.
...
### [[DATABASE/action/Destructive Vengeance|Destructive Vengeance]] <span class="action-icon">5</span>
...
An enemy damaged by the initial damage from your Destructive Vengeance also takes [[DATABASE/condition/Persistent Damage|persistent evil damage]] equal to your Charisma modifier. This applies only to the damage the reaction itself deals to the triggering creature, not the damage you deal with subsequent Strikes.
