...
**Alternate Domains** [[Cold Domain]], [[Lightning Domain]]
**Cleric Spells** 1st: _[[Gust of Wind]]_, 3rd: _[[Lightning Bolt]]_, 5th: _[[Control Water]]_

## Divine Intercession

Gozreh is pleased when their creatures and waterways are treated with respect but quick to show their displeasure.
**Source** [[Gods & Magic]] 
**Minor Boon**: Gozreh grants their guidance while at sea. You are under the constant effects of [[Know Direction]] and become trained in [[Lore]] (or another Lore skill if you are already trained in Sailing Lore).
