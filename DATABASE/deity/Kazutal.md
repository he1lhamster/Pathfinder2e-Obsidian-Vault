...
**Pantheons** [[DATABASE/deity/Demon Bringers|Demon Bringers]], [[DATABASE/deity/The Offering Plate|The Offering Plate]]
...
**Alternate Domains** [[DATABASE/domain/Cities Domain|cities]]
**Cleric Spells** 1st: _[[DATABASE/spell/Mage Armor|mage armor]]_, 3rd: _[[DATABASE/spell/Animal Form|animal form]]_, 4th: _[[DATABASE/spell/Stoneskin|stoneskin]]_
...
**Moderate Boon**: You always seem to find safe shelter when you most need it. Once per day, you can cast [[DATABASE/spell/Rope Trick|rope trick]] as a divine innate spell.
**Major Boon**: Kazutal smiles upon those who seek to offer aid, no matter how meek or helpless they may be. Any time creatures attempt a check to [[DATABASE/action/Aid|Aid]] you, they can choose to automatically succeed. If a creature chooses to roll for the attempt and rolls a success, it gets a critical success instead, granting a +4 circumstance bonus even if it doesn’t have legendary proficiency in that skill. You gain the same benefits when you attempt to Aid others.
**Minor Curse**: Community opinion turns against you. Humanoids in your community who would normally start as [[DATABASE/condition/Indifferent|indifferent]] toward you start as [[DATABASE/condition/Unfriendly|unfriendly]] instead.
**Moderate Curse**: Your strength betrays you, preventing you from taking more than your fair share. You are [[DATABASE/condition/Enfeebled|enfeebled 2]] and can’t carry anything beyond the gear you are actively wearing or using.
