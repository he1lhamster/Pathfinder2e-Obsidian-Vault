...
Immonhiel is a wanderer with no fixed home, much like the people of the Realm. She travels the [[DATABASE/plane/Material Plane|Material Plane]] and the celestial realms to heal all those in need. When recovery isn't possible, Immonhiel remains with the dying as long as she can, offering them comfort through their final hours and medicine to ease their pain and sorrow. The Balm-Bringer's followers aim to walk this same selfless path. 
...
**Domains** [[DATABASE/domain/Creation Domain|creation]], [[DATABASE/domain/Healing Domain|healing]], [[DATABASE/domain/Nature Domain|nature]], [[DATABASE/domain/Repose Domain|repose]]
**Cleric Spells** 1st: _[[DATABASE/spell/Soothe|soothe]]_, 3rd: _[[DATABASE/spell/Cozy Cabin|cozy cabin]]_, 5th: _[[DATABASE/spell/Plant Form|plant form]]_