...
**Pantheons** [[DATABASE/deity/Demon Bringers|Demon Bringers]], [[DATABASE/deity/Dwarven Pantheon|Dwarven Pantheon]], [[DATABASE/deity/The Godclaw|The Godclaw]], [[DATABASE/deity/The Laborer's Bastion|The Laborer's Bastion]]
...
**Domains** [[DATABASE/domain/Creation Domain|creation]], [[DATABASE/domain/Earth Domain|earth]], [[DATABASE/domain/Family Domain|family]], [[DATABASE/domain/Protection Domain|protection]]
**Alternate Domains** [[DATABASE/domain/Duty Domain|duty]]
**Cleric Spells** 1st: _[[DATABASE/spell/Mindlink|mindlink]]_, 3rd: _[[DATABASE/spell/Earthbind|earthbind]]_, 4th: _[[DATABASE/spell/Creation|creation]]_
...
**Major Boon**: Standing watch or guarding a location counts as resting for you, preventing you from being [[DATABASE/condition/Fatigued|fatigued]] due to lack of rest as long as you stand watch for at least 6 hours a day. You can recover your Focus Points (if you have them) by standing guard in addition to any other options you have available. When on guard, you gain a +4 status bonus to Perception to notice ambushes and other dangers approaching. As long as you are holding a shield, you are always [[DATABASE/action/Defend|Defending]] during exploration without needing to move at half your travel speed, and you can perform another exploration activity as well. While you are using a shield, its Hardness increases by 5.
**Minor Curse**: Shoddy artisanship makes itself known. Whenever an item you’re using takes damage, it is [[DATABASE/condition/Broken|broken]].
...
**Major Curse**: You are forever cast out from your home. Members of your community have their attitudes towards you shift two steps worse, meaning those who used to be [[DATABASE/condition/Helpful|helpful]] are now [[DATABASE/condition/Indifferent|indifferent]], those who were [[DATABASE/condition/Friendly|friendly]] are now [[DATABASE/condition/Unfriendly|unfriendly]], and all others are now [[DATABASE/condition/Hostile|hostile]]. This doesn’t necessarily result in violence, but hostile community members generally seek your permanent exile.