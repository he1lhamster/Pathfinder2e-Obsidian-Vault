...
**Pantheons** [[DATABASE/deity/Elven Pantheon|Elven Pantheon]], [[DATABASE/deity/The Last Breath|The Last Breath]]
...
**Domains** [[DATABASE/domain/Pain Domain|pain]], [[DATABASE/domain/Passion Domain|passion]], [[DATABASE/domain/Secrecy Domain|secrecy]], [[DATABASE/domain/Trickery Domain|trickery]]
**Cleric Spells** 1st: _[[DATABASE/spell/Charm|charm]]_, 3rd: _[[DATABASE/spell/Enthrall|enthrall]]_, 6th: _[[DATABASE/spell/Mislead|mislead]]_
...
**Minor Boon**: Calistria smiles on the riskiest deceptions. Once, when you roll a failure on a check to [[DATABASE/action/Lie|Lie]], you get a critical success instead. Calistria typically grants this boon for an extremely consequential lie.
...
**Minor Curse**: Whenever a new person desires vengeance against you, you suffer a painful sting and are afflicted with [[DATABASE/monster/Giant Wasp|giant wasp venom]] at stage 1.
**Moderate Curse**: People react as though you’re insulting them, even in normal conversation. Whenever you attempt to [[DATABASE/action/Make an Impression|Make an Impression]], the outcome is one degree of success worse than the result of your roll. If you converse with someone over a long enough period of time but don’t attempt to Make an Impression, you still insult them, and you suffer the effect of a critical failure to Make an Impression.
