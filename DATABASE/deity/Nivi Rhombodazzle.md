...
---
# Nivi Rhombodazzle (The Grey Polychrome) [N]
...
**Domains** [[DATABASE/domain/Family Domain|family]], [[DATABASE/domain/Luck Domain|luck]], [[DATABASE/domain/Trickery Domain|trickery]], [[DATABASE/domain/Wealth Domain|wealth]]
**Alternate Domains** [[DATABASE/domain/Confidence Domain|confidence]], [[DATABASE/domain/Earth Domain|earth]]
**Cleric Spells** 1st: _[[DATABASE/spell/Illusory Disguise|illusory disguise]]_, 2nd: _[[DATABASE/spell/Invisibility|invisibility]]_, 4th: _[[DATABASE/spell/Private Sanctum|private sanctum]]_
...
**Major Boon**: Those who have done much to please Nivi find themselves slipping from sight when needed. Any time you attempt a [[DATABASE/skill/Stealth|Stealth]] check to [[DATABASE/action/Hide|Hide]] or [[DATABASE/action/Sneak|Sneak]], you also gain the effects of 2nd-level [[DATABASE/spell/Invisibility|invisibility]] and [[DATABASE/spell/Fleet Step|fleet step]] spells to help you elude your enemies. These effects last until the end of your next turn or until you stop Hiding or Sneaking, whichever comes first (you can continue to Hide or Sneak, turn after turn, to extend these effects).
...
**Moderate Curse**: Those who arouse Nivi’s wrath find themselves bound to the earth with no place to hide. You are wreathed in constant [[DATABASE/spell/Faerie Fire|faerie fire]] and constantly affected by [[DATABASE/spell/Earthbind|earthbind]], and any effect that grants [[DATABASE/condition/Invisible|invisibility]] doesn’t work on you.
