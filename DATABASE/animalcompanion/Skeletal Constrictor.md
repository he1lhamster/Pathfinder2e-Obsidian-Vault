...
**Special** mindless
**Support Benefit** Your snake sways, captivating an enemy. Choose one creature within 20 feet of the constrictor that can see it. Until the start of your next turn, your Strikes that deal damage to the chosen creature make the target [[DATABASE/condition/Flat-Footed|flat-footed]] until the end of your next turn.
**Advanced Maneuver** Bony Constriction

### [[DATABASE/action/Body Constriction|Body Constriction]] <span class="action-icon">1</span>
