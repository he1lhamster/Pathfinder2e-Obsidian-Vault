...
trigger: A creature within your reach uses an [[DATABASE/trait/Auditory|auditory]]
  effect, [[DATABASE/trait/Manipulate|manipulate]] action, or [[DATABASE/trait/Move|move]]
  action; makes a ranged attack; or leaves a square during its move action.
type: Feat
