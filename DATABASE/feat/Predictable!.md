...
---
# Predictable! <span class="action-icon">1</span> <span class="item-type">Feat 4</span>

<span class="item-trait">Rogue</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]]

---
By observing an opponent, you can get a sense of their next move and prepare to counter or resist it. Choose one target and attempt a Perception check to [[DATABASE/action/Sense Motive|Sense Motive]] against the foe's [[DATABASE/skill/Deception|Deception]] DC or a hard DC of the foe's level, whichever is higher.
