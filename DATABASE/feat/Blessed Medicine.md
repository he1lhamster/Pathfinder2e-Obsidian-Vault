...
trigger: You fail a check to [[DATABASE/action/Treat Disease|Treat a Disease]] that
  was inflicted byan [[DATABASE/trait/Undead|undead]] (such as ghoul fever or mummy
  rot).
type: Feat
