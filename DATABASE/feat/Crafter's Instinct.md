...
trigger: You misfire with a firearm or you roll a failure on a Strike with a ranged
  weapon.
type: Feat

---
# Crafter's Instinct <span class="action-icon">5</span> <span class="item-type">Feat 13</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Dwarf</span><span class="item-trait">Fortune</span>
**Source** [[Guns & Gears]]
**Frequency** once per day
