...
trigger: You would be reduced to 0 Hit Points (but not immediately killed) during
  a combat encounter that hasspectators.
type: Feat

---
# Living for the Applause <span class="action-icon">5</span> <span class="item-type">Feat 8</span>
