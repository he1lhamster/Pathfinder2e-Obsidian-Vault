...
---
# Worldsphere Gravity <span class="action-icon">1</span> <span class="item-type">Feat 20</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Metamagic</span><span class="item-trait">Wizard</span>
...
* **Gravitational Morass** The pull of gravity is amplified here, creating greater difficult terrain. [[DATABASE/action/Fly|Flying]] creatures that pass through the area must succeed at a Reflex save against your spell DC or fall to the ground, taking bludgeoning damage equal to half the distance fallen.
* **Flowing Time** Erratic timestreams aid you within this space. A creature that starts its turn in the burst is affected by [[DATABASE/spell/Haste|haste]] on that turn.
