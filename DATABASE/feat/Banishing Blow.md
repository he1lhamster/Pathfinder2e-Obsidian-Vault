...
level: '20'
name: Banishing Blow
prerequisite: '[[DATABASE/feat/Fiendsbane Oath|Fiendsbane Oath]]'
rarity: Uncommon
...
trigger: You use your champion's reaction, triggered by a [[DATABASE/trait/Fiend|fiend]]
  within your reach.
type: Feat

---
# Banishing Blow <span class="action-icon">4</span> <span class="item-type">Feat 20</span>
...
**Prerequisites** [[DATABASE/feat/Fiendsbane Oath|Fiendsbane Oath]]
**Trigger** You use your champion's reaction, triggered by a fiend within your reach.

---
The erratic teleportation magic you experienced in the Kortos Mounts has taught you a few tricks. You attempt an [[DATABASE/skill/Athletics|Athletics]] check to [[DATABASE/action/Shove|Shove]] the fiend that triggered your champion's reaction; on a success, the target can't teleport or summon creatures for 1 minute. On a critical success, the target is also [[DATABASE/condition/Stunned|stunned 1]] and can't teleport or summon creatures for 1 hour, and if you are on your home plane and the target is a fiend of level 18 or lower from another plane, it is also banished to its home plane. Your multiple attack penalty doesn't apply to this attack.
