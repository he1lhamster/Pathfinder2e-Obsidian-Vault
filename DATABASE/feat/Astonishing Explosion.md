...
trigger: You use [[DATABASE/action/Quick Alchemy|Quick Alchemy]] to craft analchemical
  bombthat deals [[DATABASE/trait/Splash|splash]] damage and is at least 2 levels
  lower than youradvanced alchemy level.
type: Feat

---
# Astonishing Explosion <span class="action-icon">4</span> <span class="item-type">Feat 20</span>
...
**Frequency** once per minute
**Trigger** You use [[DATABASE/action/Quick Alchemy|Quick Alchemy]] to craft an alchemical bomb that deals splash damage and is at least 2 levels lower than your advanced alchemy level.

---
Your bomb incorporates an explosive spark of wonder that leaves witnesses dumbfounded. Any target hit by your Strike with the bomb is [[DATABASE/condition/Fascinated|fascinated]] by you for 1 round. On a critical success, the target is also [[DATABASE/condition/Stunned|stunned 1]].
