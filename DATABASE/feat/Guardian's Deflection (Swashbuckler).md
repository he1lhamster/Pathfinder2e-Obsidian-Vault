...
trigger: An ally within your melee reach is hit by an attack, you can see the attacker,
  and a +2 circumstancebonus to AC would turn the critical hit into a hit or the hit
  into a miss.
type: Feat

---
# Guardian's Deflection (Swashbuckler) <span class="action-icon">5</span> <span class="item-type">Feat 4</span>
