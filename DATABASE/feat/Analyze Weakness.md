---
actions: '[one-action]'
feat: Analyze Weakness
id: '1790'
level: '6'
name: Analyze Weakness
prerequisite: '[[DATABASE/class_/Rogue|sneak attack 2d6]]'
rarity: Common
requirement: You must have identified a creature with [[DATABASE/action/Recall Knowledge|Recall
  Knowledge]] .
...
---
# Analyze Weakness <span class="action-icon">1</span> <span class="item-type">Feat 6</span>

<span class="item-trait">Rogue</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Prerequisites** [[DATABASE/class_/Rogue|sneak attack 2d6]]
**Requirements** You must have identified a creature with [[DATABASE/action/Recall Knowledge|Recall Knowledge]].
