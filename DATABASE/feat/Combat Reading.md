...
---
You use a performer's cold reading techniques, aura reading, and other tricks to discover your foe's strengths and weaknesses. The GM rolls a secret [[DATABASE/skill/Occultism|Occultism]] check for you against the [[DATABASE/skill/Deception|Deception]] or [[DATABASE/skill/Stealth|Stealth]] DC (whichever is higher) of an enemy of your choice who is engaged in combat and isn't [[DATABASE/condition/Concealed|concealed]] from you, [[DATABASE/condition/Hidden|hidden]] from you, or [[DATABASE/condition/Undetected|undetected]] by you. The GM might apply a penalty for the distance between you and the enemy. The enemy is then temporarily immune to your Combat Reading for 1 day.
