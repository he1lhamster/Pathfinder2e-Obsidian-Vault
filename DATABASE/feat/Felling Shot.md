...
---
# Felling Shot <span class="action-icon">2</span> <span class="item-type">Feat 12</span>

<span class="item-trait">Rogue</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]]

---
Your ranged attacks can shoot an unprepared foe right out of the air. Make a Strike with a ranged weapon or a thrown weapon against a [[DATABASE/condition/Flat-Footed|flat-footed]] creature. If the Strike is a success and deals damage, the target must attempt a Reflex save against your class DC with the following effects.
