...
---
# Pistolero's Challenge <span class="action-icon">1</span> <span class="item-type">Feat 6</span>

<span class="item-trait">Auditory</span><span class="item-trait">Flourish</span><span class="item-trait">Gunslinger</span><span class="item-trait">Linguistic</span><span class="item-trait">Mental</span>
**Source** [[DATABASE/source/Guns & Gears|Guns & Gears]]
**Prerequisites** [[DATABASE/gunslingerway/Way of the Pistolero|way of the pistolero]]

---
With a stern call, carefully chosen barb, or some other challenging declaration, you demand your foe's attention in a duel. Choose an opponent within 30 feet who you can perceive and can hear you, and make your choice of a [[DATABASE/skill/Deception|Deception]] or [[DATABASE/skill/Intimidation|Intimidation]] check against the target's Will DC. No matter the result of the check, the foe is temporarily immune to your Pistolero's Challenge until noon the next day.
...
**Critical Failure** You become [[DATABASE/condition/Frightened|frightened 1]] and can't use this ability again for 1 minute.

## Pistolero's Challenge Leads To...

[[DATABASE/feat/Come at Me!|Come at Me!]]
