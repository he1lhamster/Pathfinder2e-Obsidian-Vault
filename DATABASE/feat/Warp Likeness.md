...
---
# Warp Likeness <span class="action-icon">1</span> <span class="item-type">Feat 5</span>

<span class="item-trait">Morph</span><span class="item-trait">Occult</span><span class="item-trait">Reflection</span><span class="item-trait">Transmutation</span>
**Source** [[DATABASE/source/Dark Archive|Dark Archive]]
**Frequency** once per minute
**Prerequisites** [[DATABASE/feat/Morph-Risen|Morph-Risen]]
**Trigger** You hit a creature with a melee Strike on your last action.
...
**Success** The target resists the effect but its form twists in the process. It's [[DATABASE/condition/Clumsy|clumsy 1]] until the end of its next turn.
**Failure** The target's body briefly warps to resemble yours. It's clumsy 1 until the end of its next turn and [[DATABASE/condition/Sickened|sickened 1]].
