...
---
# Titan Slinger <span class="item-type">Feat 1</span>

<span class="item-trait">Halfling</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]]

---
You have learned how to use your sling to fell enormous creatures. When you hit on an attack with a [[DATABASE/weapongroup/Sling|sling]] against a Large or larger creature, increase the size of the weapon damage die by one step (details on increasing weapon damage die sizes can be found here).
