...
trigger: An ally within your overwatch field fails in their attempt to [[DATABASE/action/Arrest
  a Fall|Arrest a Fall]] , [[DATABASE/action/Balance|Balance]] , [[DATABASE/action/Grab
  an Edge|Grab a Ledge]] , or [[DATABASE/action/Maneuver in Flight|Maneuver in Flight]]
  .
type: Feat
