...
trigger: You would take damage from a Strike or spell that doesn't have the [[DATABASE/trait/Death|death]]
  trait or otherwise cause instant death (such as [[DATABASE/spell/Disintegrate|disintegrate]]
  ).
type: Feat
