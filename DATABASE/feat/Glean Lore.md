...
---
# Glean Lore <span class="action-icon">1</span> <span class="item-type">Feat 1</span>

<span class="item-trait">Divination</span><span class="item-trait">Divine</span><span class="item-trait">Oracle</span><span class="item-trait">Secret</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]]

---
You tap into the collected lore of the divine, accessing a variety of potentially useful information. Attempt a [[DATABASE/skill/Religion|Religion]] check to understand the information you gain. The GM sets the DC (similar to the DC to [[DATABASE/action/Recall Knowledge|Recall Knowledge]]), potentially adjusting the DC of the check for topics far removed from your mystery.
