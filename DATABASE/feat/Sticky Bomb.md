...
trigger: "You use Quick Alchemy to craft an alchemical bomb, and that bomb\u2019s\
  \ level is at least 2 levels lowerthan your advanced alchemy level."
type: Feat

---
# Sticky Bomb <span class="action-icon">4</span> <span class="item-type">Feat 8</span>
