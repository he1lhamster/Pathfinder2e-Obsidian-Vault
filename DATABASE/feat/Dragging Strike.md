...
---
# Dragging Strike <span class="action-icon">1</span> <span class="item-type">Feat 2</span>
...
**Failure** The target becomes [[DATABASE/condition/Flat-Footed|flat-footed]] until the end of your current turn.
