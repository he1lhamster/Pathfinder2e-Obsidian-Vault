...
---
# Tamper <span class="action-icon">1</span> <span class="item-type">Feat 1</span>

<span class="item-trait">Inventor</span><span class="item-trait">Manipulate</span>
**Source** [[DATABASE/source/Guns & Gears|Guns & Gears]]

---
You tamper with a foe's weapon or armor, using a free hand. Choose either a weapon held by an enemy in your reach or a suit of armor worn by an enemy in your reach. Attempt a [[DATABASE/skill/Crafting|Crafting]] check against the enemy's Reflex DC.
