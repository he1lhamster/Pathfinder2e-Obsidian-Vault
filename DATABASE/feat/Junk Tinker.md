...
---
# Junk Tinker <span class="item-type">Feat 1</span>

<span class="item-trait">Goblin</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]]

---
You can make useful tools out of even twisted or rusted scraps. When using the [[DATABASE/skill/Crafting|Crafting]] skill to [[DATABASE/action/Craft|Craft]], you can make level 0 items, including weapons but not armor, out of junk. This reduces the Price to one-quarter the usual amount but always results in a shoddy item. Shoddy items normally give a penalty, but you don't take this penalty when using shoddy items you made.
