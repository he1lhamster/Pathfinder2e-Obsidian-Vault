...
---
# Torrent in the Blood <span class="action-icon">2</span> <span class="item-type">Feat 6</span>

<span class="item-trait">Healing</span><span class="item-trait">Impulse</span><span class="item-trait">Kineticist</span><span class="item-trait">Manipulate</span><span class="item-trait">Overflow</span><span class="item-trait">Primal</span><span class="item-trait">Vitality</span><span class="item-trait">Water</span>
**Source** [[Rage of Elements]]

---
A healing wave splashes across creatures in a 30-foot cone, its cleansing water driving afflictions from the body. Each creature in the area regains 3d8 Hit Points and can attempt a new save against one poison or disease affliction affecting it; on a failed save, the condition doesn't worsen.
