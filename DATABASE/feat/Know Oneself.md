...
trigger: You roll a critical failure on a saving throw against an [[DATABASE/trait/Emotion|emotion]]
  effect.
type: Feat

---
# Know Oneself <span class="action-icon">5</span> <span class="item-type">Feat 1</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Fortune</span><span class="item-trait">Human</span>
**Source** [[DATABASE/source/Character Guide|Character Guide]] 
**Frequency** once per day
