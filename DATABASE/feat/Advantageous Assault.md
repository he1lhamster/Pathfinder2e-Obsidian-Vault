...
---
# Advantageous Assault <span class="action-icon">1</span> <span class="item-type">Feat 6</span>

<span class="item-trait">Fighter</span><span class="item-trait">Press</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]]

---
When an enemy's movement is compromised, you deliver a more deadly blow. Make a Strike against a creature that is [[DATABASE/condition/Grabbed|grabbed]], [[DATABASE/condition/Prone|prone]], or [[DATABASE/condition/Restrained|restrained]]. You gain a circumstance bonus to damage on this Strike equal to the number of weapon damage dice, or that number + 2 if you're wielding the weapon in two hands. The Strike gains the following failure effect. 
