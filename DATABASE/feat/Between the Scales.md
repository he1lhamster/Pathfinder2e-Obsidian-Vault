...
---
# Between the Scales <span class="item-type">Feat 9</span>

<span class="item-trait">Kobold</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]]

---
Underestimating you is a grave mistake, but it's one others keep making. You've learned to take advantage of slips in your foes' defenses. When you Strike a [[DATABASE/condition/Flat-Footed|flat-footed]] creature using a melee weapon or unarmed attack that has the agile and finesse traits, it gains the backstabber trait.
