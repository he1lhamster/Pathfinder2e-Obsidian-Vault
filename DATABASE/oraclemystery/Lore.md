...
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
Knowledge and information come freely to you. You might use this lore to gain power or perhaps to understand the divine mysteries of the multiverse. You might have a conduit to the fabled Akashic Record, maintain a subtle telepathic connection to the collective subconscious of all living creatures, or follow in the footsteps of deities such as [[DATABASE/deity/Abadar|Abadar]], [[DATABASE/deity/Irori|Irori]], [[DATABASE/deity/Nethys|Nethys]], Irori's scholarly nephew [[DATABASE/deity/Gruhastha|Gruhastha]], the fey triune goddess of fate [[DATABASE/deity/Magdh|Magdh]], or the lawful aeon god-figure known as the [[DATABASE/deity/Monad|Monad]].
...
**Trained Skill** [[DATABASE/skill/Occultism|Occultism]] and one [[DATABASE/skill/Lore|Lore]] skill of your choice.
**Granted Cantrip** _[[DATABASE/spell/Read Aura|read aura]]_
**Revelation Spells** initial: _[[DATABASE/spell/Brain Drain|brain drain]]_; advanced: _[[DATABASE/spell/Access Lore|access lore]]_; greater: _[[DATABASE/spell/Dread Secret|dread secret]]_
**Related Domains** [[DATABASE/domain/Knowledge Domain|knowledge]], [[DATABASE/domain/Truth Domain|truth]]
