...
<span class="in-box-ability">**Oily Scales** A scalathrax constantly sweats a glistening oil that makes it exceptionally slick. It treats the results of [[Acrobatics]] checks to [[Squeeze]] or of any skill check to [[Escape]] as one degree of success greater than the rolled result. A scalathrax loses this benefit for 1 minute after it takes any amount of fire damage.</span>

---
**Speed** 25 feet, climb 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +13 [+8/+3] (finesse), **Damage** 2d8+5 piercing plus scalathrax venom</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> leg quill +13 [+8/+3] (range increment 20 feet), **Damage** 2d4+5 piercing</span><span class="in-box-ability">**Scalathrax Venom** (poison) **Saving Throw** **Fortitude** DC 21; **Maximum Duration** 6 rounds; **Stage 1** [[Clumsy]] (1 round); **Stage 2** clumsy 1 and [[Slowed]] (1 round); **Stage 3** clumsy 1 and slowed 2 (1 round)</span><span class="in-box-ability">**Spray Toxic Oil** <span class="action-icon">2</span> (conjuration, primal) The scalathrax disgorges a gout of toxic oil from its mouth in a 15-foot cone. Creatures in the area must attempt a DC 21 Reflex save. The scalathrax can't use Toxic Oil Spray again for 1d4 rounds. 
