...
<span class="in-box-ability">**Counterattack <span class="action-icon">5</span> **Trigger** Leiko is targeted by an attack from an adjacent creature that misses due to Leiko being concealed** **Requirements** Leiko is aware of the attack; **Effect** Leiko makes a Strike against the attacker.</span><span class="in-box-ability">**Slip <span class="action-icon">5</span> **Trigger** A creature moves adjacent to Leiko** **Effect** Leiko teleports to a clear space adjacent to another creature she can see within 30 feet.</span>
