...
land_speed: '25'
language:
- '[[DATABASE/language/Common|Common]] ; bat empathy'
level: '2'
max_speed: '25'
name: Werebat
perception: '+9'
...
# Werebat<span class="item-type">Creature 2</span>

<span class="trait-alignment item-trait">NE</span><span class="trait-size item-trait">Medium</span><span class="item-trait">Beast</span><span class="item-trait">Human</span><span class="item-trait">Humanoid</span><span class="item-trait">Werecreature</span>
**Source** [[DATABASE/source/Bestiary 3|Bestiary 3]]
**Perception** +9; echolocation (precise) 40 feet, [[DATABASE/monsterability/Low-Light Vision|low-light vision]]
**Languages** [[DATABASE/language/Common|Common]]; bat empathy
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +8, [[DATABASE/skill/Athletics|Athletics]] +6, [[DATABASE/skill/Deception|Deception]] +4, [[DATABASE/skill/Society|Society]] +5, [[DATABASE/skill/Stealth|Stealth]] +8
...
**Items** [[DATABASE/weapon/Dagger|dagger (3)]], [[DATABASE/armor/Studded Leather Armor|studded leather]]

---
**AC** 18; **Fort** +9, **Ref** +10, **Will** +7
**HP** 35; **Weaknesses** [[DATABASE/equipment/Silver Weapon|silver]] 5
<span class="in-box-ability">**Wing Thrash <span class="action-icon">5</span> ** **Trigger** An adjacent enemy damages the werebat; **Effect** The werebat makes one or two wing Strikes, each against a different adjacent creature.</span>

---
**Speed** 25 feet, fly 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> fangs +10 [+5/+0] (finesse), **Damage** 1d8+4 slashing plus curse of the werebat</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> wing +10 [+6/+2] (agile, finesse), **Damage** 1d6+4 bludgeoning</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> dagger +10 [+6/+2] (agile, finesse, versatile S), **Damage** 1d4+4 piercing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> dagger +10 [+6/+2] (agile, thrown 10 feet, versatile S), **Damage** 1d4+4 piercing</span><span class="in-box-ability">**[[DATABASE/monsterability/Change Shape|Change Shape]]** <span class="action-icon">1</span> (concentrate, polymorph, primal, transmutation) [[DATABASE/ancestry/Human|Human]] with fist for 1d4+2 bludgeoning and no fly Speed, or Medium [[DATABASE/monster/Giant Bat|giant bat]] with Speed 15 feet and fly 30 feet.</span><span class="in-box-ability">**Curse of the Werebat** (curse, necromancy, primal) **Saving Throw** DC 15 Fortitude</span><span class="in-box-ability">**Moon Frenzy** (polymorph, primal, transmutation) </span>

###  Werebat Colonies

Werebats sometimes methodically curse an entire community to form a terrifyingly large werebat colony. In elaborate covert initiation ceremonies, newly cursed members are given shocking proof of their new monstrous nature and sworn to loyalty and secrecy under threat of exposure or death. Since they're easily mistaken for [[DATABASE/monsterfamily/Vampire|vampires]], these werebats sometimes warn new werebats to avoid such things as direct sunlight in order to confuse monster hunters or lull foes into a false sense of understanding.