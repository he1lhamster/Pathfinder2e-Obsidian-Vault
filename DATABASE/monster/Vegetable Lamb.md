...
Vegetable lambs are gaining popularity as the first elemental to be summoned by spellcasters in training, as they're docile until provoked and easy to control. Casters must take care, however, to not let them germinate in the [[DATABASE/plane/Material Plane|Universe]]; they're a highly invasive species that can devour an entire forest within a decade.
...
# Vegetable Lamb<span class="item-type">Creature 1</span>
...
**Source** [[DATABASE/source/Rage of Elements|Rage of Elements]]
**Perception** +4
**Skills** [[DATABASE/skill/Athletics|Athletics]] +5, [[DATABASE/skill/Nature|Nature]] +6
**Str** +3, **Dex** +1, **Con** +2, **Int** -4, **Wis** +0, **Cha** +3
...
---
**AC** 14; **Fort** +6, **Ref** +3, **Will** +8
**HP** 28; **Immunities** bleed, [[DATABASE/condition/Paralyzed|paralyzed]], poison, sleep; **Weaknesses** fire 3, slashing 2

---
**Speed** 20 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> headbutt +8 [+3/-2], **Damage** 1d6+2 bludgeoning</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> hoof +6 [+1/-4], **Damage** 1d6 bludgeoning</span><span class="in-box-ability">**Cottonseed Burst** <span class="action-icon">2</span> The vegetable lamb releases a cloud of cottony green pollen in a 10-foot burst centered on itself. All creatures caught in the burst that need to breathe, apart from the lamb, must succeed at a DC 15 Fortitude save or be [[DATABASE/condition/Slowed|slowed 1]] by coughing (slowed 2 on a critical failure).</span>