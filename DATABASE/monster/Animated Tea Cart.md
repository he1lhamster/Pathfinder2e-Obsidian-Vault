...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> slam +15 [+10/+5] (magical), **Damage** 2d8+9 bludgeoning</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> dish +15 [+10/+5] (magical, range increment 30 feet, versatile P and S), **Damage** 2d6+8 bludgeoning</span><span class="in-box-ability">**Scald** <span class="action-icon">1</span> **Frequency** once per round; **Effect** The tea cart ejects piping-hot tea in a 15-foot cone that deals 5d6 fire damage (DC 26 basic Reflex save).</span>