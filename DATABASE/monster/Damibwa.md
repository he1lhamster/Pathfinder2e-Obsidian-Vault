...
**Perception** +12; echolocation 60 feet, [[DATABASE/monsterability/Low-Light Vision|low-light vision]]
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +10, [[DATABASE/skill/Athletics|Athletics]] +12, [[DATABASE/skill/Stealth|Stealth]] +10, [[DATABASE/skill/Survival|Survival]] +10
...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +14 [+9/+4], **Damage** 2d8+4 piercing plus [[DATABASE/monsterability/Grab|Grab]]</span><span class="in-box-ability">**Fetch** <span class="action-icon">1</span> (attack, move) **Requirements** The damibwa has a Small or smaller creature [[DATABASE/condition/Grabbed|grabbed]] in water; **Effect** The damibwa attempts an [[DATABASE/skill/Athletics|Athletics]] check against the creature's Fortitude DC. 
