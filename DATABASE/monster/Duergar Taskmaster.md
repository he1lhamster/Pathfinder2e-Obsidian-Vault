...
# Duergar Taskmaster<span class="item-type">Creature 2</span>
...
**Skills** [[DATABASE/skill/Athletics|Athletics]] +7, [[DATABASE/skill/Deception|Deception]] +7, [[DATABASE/skill/Intimidation|Intimidation]] +7, [[DATABASE/skill/Occultism|Occultism]] +5, [[DATABASE/skill/Religion|Religion]] +6, [[DATABASE/skill/Survival|Survival]] +6
**Str** +2, **Dex** +0, **Con** +2, **Int** +0, **Wis** +2, **Cha** +3
**Items** [[DATABASE/armor/Chain Mail|chain mail]], [[DATABASE/weapon/Maul|maul]], [[DATABASE/equipment/Religious Symbol|religious symbol]]

---
**AC** 18; **Fort** +8, **Ref** +4, **Will** +8; +2 status to all saves vs. magic, iron mind
**HP** 30
<span class="in-box-ability">**Iron Mind** Duergar taskmasters automatically disbelieve all illusions of 1st level or lower.</span><span class="in-box-ability"> **Light Blindness**</span>

---
**Speed** 20 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> maul +8 [+3/-2] (shove), **Damage** 1d12+2 bludgeoning</span>**Divine Prepared Spells** DC 18; **1st** _[[DATABASE/spell/Fear|fear]]_, _[[DATABASE/spell/Harm|harm]]_, _[[DATABASE/spell/Magic Weapon|magic weapon]]_; **Cantrips** **(1st)** _[[DATABASE/spell/Detect Magic|detect magic]]_, _[[DATABASE/spell/Shield|shield]]_
**Occult Innate Spells** DC 18; **2nd** _[[DATABASE/spell/Enlarge|enlarge]]_ (self only), _[[DATABASE/spell/Invisibility|invisibility]]_ (self only)
<span class="in-box-ability">**Take Them Down!** <span class="action-icon">1</span> The duergar taskmaster smashes their maul into the ground and invokes [[DATABASE/deity/Droskar|Droskar's]] name to rally their allies to action. All allied duergars of equal or lower level that are within 20 feet of the duergar taskmaster gain a +1 status bonus to attack rolls and damage rolls until the end of the duergar taskmaster's next turn.</span>