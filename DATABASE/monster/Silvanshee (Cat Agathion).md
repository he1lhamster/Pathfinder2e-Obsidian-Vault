...
Silvanshees are a stealthy and extremely inquisitive contingent of agathions who gather information about the mortal world for other agathions. While they love to explore the [[DATABASE/plane/Material Plane|Material Plane]] and sate their curiosity, they're generally reclusive and skittish. These dual instincts war with each other whenever something exciting piques their interest. Because of their small sizes, they don't pose a combat threat to most creatures; instead, silvanshees act as [[DATABASE/plane/Nirvana|Nirvana's]] eyes and ears in the mortal world, reporting back to superiors or calling for help should they run into danger.
...
# Silvanshee<span class="item-type">Creature 1</span>

<span class="trait-alignment item-trait">NG</span><span class="trait-size item-trait">Tiny</span><span class="item-trait">Agathion</span><span class="item-trait">Celestial</span>
**Source** [[DATABASE/source/Bestiary 3|Bestiary 3]]
...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +7, [[DATABASE/skill/Arcana|Arcana]] +3, [[DATABASE/skill/Medicine|Medicine]] +6, [[DATABASE/skill/Lore|Nirvana Lore]] +3, [[DATABASE/skill/Stealth|Stealth]] +7
...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +9 [+4/-1] (finesse, good, magical), **Damage** 1d6–2 piercing plus 1d4 good</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> claw +9 [+5/+1] (agile, finesse, good, magical), **Damage** 1d4–2 slashing plus 1d4 good</span>**Divine Innate Spells** DC 16; **4th** _[[DATABASE/spell/Gaseous Form|gaseous form]]_ (×3), _[[DATABASE/spell/Read Omens|read omens]]_; **Cantrips** **(1st)** _[[DATABASE/spell/Dancing Lights|dancing lights]]_, _[[DATABASE/spell/Know Direction|know direction]]_, _[[DATABASE/spell/Prestidigitation|prestidigitation]]_, _[[DATABASE/spell/Stabilize|stabilize]]_; **Constant** **(2nd)** _[[DATABASE/spell/Speak with Animals|speak with animals]]_
**Champion Focus Spell** DC 16, 1 Focus Point; **1st** _[[DATABASE/spell/Lay on Hands|lay on hands]]_
<span class="in-box-ability">**Cat's Grace** When a silvanshee uses their [[DATABASE/spell/Gaseous Form|gaseous form]] spell, the mist form remains roughly the size and shape of a cat, and the silvanshee retains their fly speed in this form.</span>
