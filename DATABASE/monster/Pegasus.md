...
**HP** 55
<span class="in-box-ability">**Buck** <span class="action-icon">5</span> DC 19</span>

---
**Speed** 40 feet, fly 80 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> hoof +10 [+5/+0], **Damage** 1d8+5 bludgeoning</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> wing +10 [+6/+2] (agile), **Damage** 1d6+5 bludgeoning</span><span class="in-box-ability">**Assisted Mount** <span class="action-icon">1</span> **Requirement** The pegasus is Flying without a rider. **Effect** The pegasus Flies. At any point during the movement, it can allow a willing adjacent creature to Mount it. That creature must use a reaction to do so.</span><span class="in-box-ability">**Gallop** <span class="action-icon">2</span> The pegasus uses 2 move actions, each of which can be either Stride or Fly. It gains a +20-foot circumstance bonus to its Speeds during a Gallop.</span>

###  Corrupted Pegasi

When a foul influence from the fiendish planes, a necromantic blight, or any other sinister influence spreads through a wilderness, pegasi can become corrupted. These neutral evil pegasi have the same statistics as those presented here, but are much more violent.