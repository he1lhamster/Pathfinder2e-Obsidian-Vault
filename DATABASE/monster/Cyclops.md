...
- '[[DATABASE/skill/Lore|Fortune-Telling Lore]] +13'
...
---
**Speed** 30 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> greataxe +14 [+9/+4] (reach 10 feet, sweep), **Damage** 1d12+9 slashing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> heavy crossbow +8 [+3/-2] (range increment 120 feet, reload 2), **Damage** 1d10+4 piercing</span><span class="in-box-ability">**Swipe** <span class="action-icon">2</span> (flourish) The cyclops makes a melee Strike and compares the attack roll result to the AC of up to two foes, each of whom must be within its melee reach and adjacent to each other. Roll damage only once and apply it to each creature hit. A Swipe counts as two attacks for the cyclops’s multiple attack penalty.</span>