...
# Assassin Vine<span class="item-type">Creature 3</span>
...
**Source** [[DATABASE/source/Bestiary 2|Bestiary 2]] 
**Perception** +10; [[DATABASE/monsterability/Tremorsense|tremorsense 30 feet]], [[DATABASE/monsterability/Low-Light Vision|low-light vision]]
**Skills** [[DATABASE/skill/Athletics|Athletics]] +9, [[DATABASE/skill/Stealth|Stealth]] +9 (+11 in forests or grasslands)
**Str** +4, **Dex** +0, **Con** +3, **Int** -5, **Wis** +3, **Cha** +0
**Camouflage** The assassin vine can [[DATABASE/action/Hide|Hide]] in natural environments even if it doesn't have cover.

---
**AC** 18; **Fort** +10, **Ref** +7, **Will** +8
**HP** 68; **Weaknesses** fire 5, slashing 5
<span class="in-box-ability">**Grasping Foliage <span class="action-icon">5</span> ** (primal, transmutation) **Trigger **The assassin vine detects a creature within 20 feet via [[DATABASE/monsterability/Tremorsense|tremorsense]]; **Effect **The assassin vine causes vegetation within a 20-foot emanation to writhe for 1 round, turning this area into difficult terrain. When a creature starts its turn in this area, it must attempt a DC 20 Reflex save. On a failure, it takes a –10-foot circumstance penalty to its Speeds until it leaves the area, and on a critical failure it is also [[DATABASE/condition/Immobilized|immobilized]] for 1 round. A creature can attempt to [[DATABASE/action/Escape|Escape]] to remove these effects. Assassin vines are immune to Grasping Foliage.</span>

---
**Speed** 5 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> vine +12 [+7/+2] (reach 10 feet), **Damage** 1d8+6 bludgeoning plus [[DATABASE/monsterability/Grab|Grab]]</span><span class="in-box-ability">**[[DATABASE/monsterability/Constrict|Constrict]]** <span class="action-icon">1</span> 1d8+4 bludgeoning, DC 20</span>
