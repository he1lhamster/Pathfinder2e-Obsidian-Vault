...
**Slow** A withered is permanently [[Slowed]] and can't use reactions.
**Items** [[Dagger]], [[Leather Armor]], [[Shortsword]]
...
---
**Speed** 35 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> shortsword +14 [+10/+6] (agile, versatile S), **Damage** 1d6+9 piercing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> dagger +14 [+10/+6] (agile, versatile S), **Damage** 1d4+9 piercing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> fist +14 [+9/+4], **Damage** 1d8+7 bludgeoning</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> dagger +13 [+9/+5] (agile, thrown 10 feet, versatile S), **Damage** 1d4+9 piercing</span><span class="in-box-ability">**[[Sneak Attack]]** The withered zombie deals an additional 2d6 precision damage to [[Flat-Footed]] creatures.</span><span class="in-box-ability">**Sudden Surge** <span class="action-icon">4</span> **Trigger** The withered zombie's turn begins; **Effect** The withered zombie has a sudden burst of speed. They are [[Quickened]] this turn and can use the extra action only to Stride or Strike. If the withered zombie's first action this turn is a melee Strike, the target is [[Flat-Footed]] against the attack. The withered zombie can't use Sudden Surge again for 1d4 rounds.</span>