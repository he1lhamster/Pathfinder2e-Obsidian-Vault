...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> barbed leg +11 [+7/+3] (agile, finesse), **Damage** 1d4+3 piercing plus [[Grab]]</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> proboscis +7 [+2/-3], **Damage** 1d6+3 piercing plus Blood Drain</span><span class="in-box-ability">**Blood Drain** <span class="action-icon">1</span> Strike with its proboscis against a target with blood; **Effect** The bloodseeker sucks blood from that target, dealing 2d4 damage, and the bloodseeker gains temporary Hit Points equal to the damage dealt. The target becomes [[Drained]].

</span><span class="in-box-ability">**[[Grab]]** <span class="action-icon">1</span> </span>