...
<span class="in-box-ability">**Mass Wriggle <span class="action-icon">5</span> ** **Trigger** The rat snake swarm takes damage from a melee Strike; **Effect** Snakes slither up and around the creature's weapon and limbs. The target must succeed at a DC 15 Will save or become [[Frightened]].</span>
