...
# Young Umbral Dragon<span class="item-type">Creature 11</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="trait-alignment item-trait">NE</span><span class="trait-size item-trait">Large</span><span class="item-trait">Dragon</span><span class="item-trait">Shadow</span>
**Source** [[DATABASE/source/Bestiary 2|Bestiary 2]] 
**Perception** +22; [[DATABASE/monsterability/Darkvision|greater darkvision]], [[DATABASE/monsterability/Scent|scent (imprecise) 60 feet]]
**Languages** [[DATABASE/language/Common|Common]], [[DATABASE/language/Draconic|Draconic]], [[DATABASE/language/Shadowtongue|Shadowtongue]]
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +18, [[DATABASE/skill/Athletics|Athletics]] +22, [[DATABASE/skill/Deception|Deception]] +22, [[DATABASE/skill/Intimidation|Intimidation]] +22, [[DATABASE/skill/Nature|Nature]] +20, [[DATABASE/skill/Stealth|Stealth]] +20, [[DATABASE/skill/Survival|Survival]] +22
**Str** +7, **Dex** +3, **Con** +5, **Int** +3, **Wis** +5, **Cha** +3

---
**AC** 31; **Fort** +22, **Ref** +20, **Will** +22
**HP** 195; **Immunities** negative, [[DATABASE/condition/Paralyzed|paralyzed]], sleep
<span class="in-box-ability">**[[DATABASE/monsterability/Frightful Presence|Frightful Presence]]** (aura, emotion, fear, mental) 90 feet, DC 26</span><span class="in-box-ability">**[[DATABASE/monsterability/Attack of Opportunity|Attack of Opportunity]] <span class="action-icon">5</span> ** Jaws only.</span>

---
**Speed** 40 feet, fly 140 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +24 [+19/+14] (negative, reach 10 feet), **Damage** 2d10+13 piercing plus 2d6 negative</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> claw +24 [+20/+16] (agile), **Damage** 2d10+13 slashing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> tail +22 [+17/+12] (reach 15 feet), **Damage** 2d12+13 slashing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> wing +22 [+17/+12] (reach 10 feet), **Damage** 1d10+13 slashing</span>**Primal Innate Spells** DC 30; **4th** _[[DATABASE/spell/Darkness|darkness]]_ (×3); **Cantrips** **(4th)** _[[DATABASE/spell/Detect Magic|detect magic]]_
<span class="in-box-ability">**Breath Weapon** <span class="action-icon">2</span> (necromancy, negative, primal) The dragon breathes a blast of darkness that deals 12d6 negative energy damage in a 30-foot cone (DC 30 basic Reflex save). They can't use Breath Weapon again for 1d4 rounds. Undead creatures take 14d6 force damage instead of the negative damage.</span><span class="in-box-ability">**Draconic Frenzy** <span class="action-icon">2</span> The dragon makes two claw Strikes and one wing Strike in any order.</span><span class="in-box-ability">**Draconic Momentum** The dragon recharges their Breath Weapon whenever they score a critical hit with a Strike.</span><span class="in-box-ability">**Ghost Bane** An umbral dragon's Strikes affect incorporeal creatures with the effects of a [[DATABASE/equipment/Ghost Touch|ghost touch]] property rune, and an umbral dragon's jaws deal an additional 4d6 force damage to undead.</span>