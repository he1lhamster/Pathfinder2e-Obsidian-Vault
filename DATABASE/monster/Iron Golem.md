...
# Iron Golem<span class="item-type">Creature 13</span>
...
<span class="in-box-ability">**Golem Antimagic** harmed by acid (6d10, 2d8 from areas and persistent damage); healed by fire (area 2d8 HP); slowed by electricity</span><span class="in-box-ability"> **Vulnerable to Neutralize Poison** Casting [[DATABASE/spell/Neutralize Poison|neutralize poison]] on the golem deactivates its Breath Weapon for 1 minute.</span><span class="in-box-ability"> **Vulnerable to Rust** Magical rusting effects, like a rust monster’s antennae, affect the iron golem normally.</span>

---
**Speed** 20 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> fist +28 [+23/+18] (magical, reach 10 feet), **Damage** 3d10+12 bludgeoning</span><span class="in-box-ability">**Breath Weapon** <span class="action-icon">2</span> (arcane, necromancy, poison) The iron golem exhales poisonous gas in a 10-foot radius centered on the corner of one of the iron golem’s squares. The gas persists for 1 round. Any creature in the area (or that later enters the area) is exposed to the iron golem’s poison. The golem can’t use its Breath Weapon again for 1d4 rounds.</span><span class="in-box-ability">**Inexorable March** <span class="action-icon">1</span> The iron golem Strides up to its Speed, pushing back each creature whose space it moves into and damaging them if they try to stop its movement. A creature can attempt to bar the way by succeeding at a DC 37 Fortitude save. On a critical success, the resisting creature takes no damage; otherwise, it is damaged as if hit by the golem’s fist.</span><span class="in-box-ability">**Iron Golem Poison** (poison) Any [[DATABASE/condition/Drained|drained]] value from this poison is reduced by 1 every hour. **Saving Throw** DC 33 Fortitude; **Maximum Duration** 4 rounds; **Stage 1** 2d6 poison and [[DATABASE/condition/Drained|drained 1]] (1 round); **Stage 2** 4d6 poison and [[DATABASE/condition/Drained|drained 2]] (1 round); **Stage 3** 8d6 poison and [[DATABASE/condition/Drained|drained 3]] (1 round).</span>
