...
# Street Skelm<span class="item-type">Creature 3</span>
...
**Source** [[DATABASE/source/Bestiary 3|Bestiary 3]]
**Perception** +8; [[DATABASE/monsterability/Scent|scent]] (imprecise) 30 feet
**Languages** [[DATABASE/language/Aklo|Aklo]], [[DATABASE/language/Common|Common]]
**Skills** [[DATABASE/skill/Athletics|Athletics]] +9, [[DATABASE/skill/Deception|Deception]] +9, [[DATABASE/skill/Intimidation|Intimidation]] +11, [[DATABASE/skill/Occultism|Occultism]] +8, [[DATABASE/skill/Stealth|Stealth]] +9
**Str** +4, **Dex** +2, **Con** +3, **Int** +3, **Wis** +1, **Cha** +4
**Items** [[DATABASE/weapon/Staff|staff]]

---
**AC** 18; **Fort** +10, **Ref** +9, **Will** +8; –1 to all saves vs. emotion effects
**HP** 55; **Weaknesses** [[DATABASE/equipment/Cold Iron Weapon|cold iron]] 3
...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> fist +12 [+8/+4] (agile, magical), **Damage** 1d6+6 bludgeoning plus [[DATABASE/monsterability/Grab|Grab]]</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> antler +12 [+7/+2] (magical), **Damage** 1d10+6 piercing plus [[DATABASE/monsterability/Knockdown|Knockdown]]</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> staff +13 [+8/+3] (two-handed d8), **Damage** 1d4+7 bludgeoning</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> rock +9 [+4/-1] (range increment 20 feet), **Damage** 1d6+6 bludgeoning</span><span class="in-box-ability">**[[DATABASE/monsterability/Change Shape|Change Shape]]** <span class="action-icon">1</span> (concentrate, occult, polymorph, transmutation) The street skelm can take on the appearance of any Medium male humanoid. This doesn't change his Speed or his attack and damage bonuses with his Strikes but might change the damage type his Strikes deal.</span><span class="in-box-ability">**Frightening Rant** <span class="action-icon">1</span> (auditory, concentrate, emotion, enchantment, fear, linguistic, mental, occult) The skelm rants angrily, filling nearby creatures with shame, fear, and anger. Each creature within 30 feet must succeed at a DC 20 Will save or become [[DATABASE/condition/Frightened|frightened 1]] (frightened 2 on a critical failure). While frightened by this rant, creatures take a –2 status penalty to Strength-based damage rolls against the skelm, but gain a +2 status bonus to those rolls against other creatures.</span><span class="in-box-ability">**Punishing Strike** <span class="action-icon">1</span> The skelm unleashes his constant rage in a reckless attack that makes him [[DATABASE/condition/Flat-Footed|flat-footed]] until the start of his next turn. He Strikes; if he hits, he increases the number of damage dice by one and adds [[DATABASE/monsterability/Push|Push]] to the effect. This counts as two attacks for his multiple attack penalty.</span>