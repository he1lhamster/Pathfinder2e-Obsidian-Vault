...
---
**Speed** 20 feet
<span class="in-box-ability">**Slice and Dice** <span class="action-icon">1</span> (magical) Each enemy in the animated silverware swarm's space takes 1d6 piercing or slashing damage (DC 17 basic Reflex save)</span><span class="in-box-ability">**Stick a Fork in It** <span class="action-icon">1</span> The animated silverware swarm attempts to pin a single creature. The target must attempt a DC 17 Reflex save. 
