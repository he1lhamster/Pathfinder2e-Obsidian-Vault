...
## Elite | [[DATABASE/monster/Stone Ghost, Spite-Filled Apparation and Failed Student|Normal]] | Weak
...
Male [[DATABASE/ancestry/Human|human]] [[DATABASE/ancestry/Oread|oread]] stone spirit
**Perception** +13
**Languages** [[DATABASE/language/Common|Common]], [[DATABASE/language/Gnoll|Gnoll]], [[DATABASE/language/Terran|Terran]]
**Skills** [[DATABASE/skill/Arcana|Arcana]] +12, [[DATABASE/skill/Athletics|Athletics]] +12, [[DATABASE/skill/Intimidation|Intimidation]] +12, [[DATABASE/skill/Lore|Magaambya Lore]] +12, [[DATABASE/skill/Nature|Nature]] +13, [[DATABASE/skill/Stealth|Stealth]] +11
**Str** +3, **Dex** +0, **Con** +4, **Int** +3, **Wis** +4, **Cha** +1
**Items** _+1 [[DATABASE/weapon/Morningstar|morningstar]]_, [[DATABASE/armor/Leather Armor|leather armor]], [[DATABASE/weapon/Sling|sling (10 bullets)]]

---
**AC** 20; **Fort** +11, **Ref** +9, **Will** +15
**HP** 40; **Resistances** all damage 5 (except force or [[DATABASE/equipment/Ghost Touch|ghost touch]]
<span class="in-box-ability">**Stone Spirit** Stone Ghost can pass through objects made of stone or soil, including walls. When inside an object, Stone Ghost can't perceive, attack, or interact with anything outside the object, and if he starts his turn inside an object, he is [[DATABASE/condition/Slowed|slowed 1]].</span>

---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> _morningstar_ +15 [+10/+5] (magical, versatile P), **Damage** 1d6+7 bludgeoning</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> sling +11 [+6/+1] (propulsive, range increment 50 feet, reload 1), **Damage** 1d6+5 bludgeoning</span>**Primal Prepared Spells** DC 22, attack +14; **3rd** _[[DATABASE/spell/Earthbind|earthbind]]_, _[[DATABASE/spell/Summon Elemental|summon elemental]]_ (earth only); **2nd** _[[DATABASE/spell/Darkvision|darkvision]]_, _[[DATABASE/spell/Glitterdust|glitterdust]]_, _[[DATABASE/spell/Shatter|shatter]]_; **1st** _[[DATABASE/spell/Command|command]]_ (animals only), _[[DATABASE/spell/Grease|grease]]_, _[[DATABASE/spell/Pass Without Trace|pass without trace]]_; **Cantrips** **(3rd)** _[[DATABASE/spell/Acid Splash|acid splash]]_, _[[DATABASE/spell/Dancing Lights|dancing lights]]_, _[[DATABASE/spell/Know Direction|know direction]]_, _[[DATABASE/spell/Shield|shield]]_, _[[DATABASE/spell/Tanglefoot|tanglefoot]]_
<span class="in-box-ability">**Entombing Grasp** <span class="action-icon">2</span> (earth, manipulate) **Requirements** A foe within Stone Ghost's reach is standing on stone or soil; **Effect** Stone Ghost briefly extends his intangibility to a foe and drags or pounds them into the earth. He makes an [[DATABASE/skill/Athletics|Athletics]] check against the target's Fortitude DC. On a success, the foe is planted waist-deep in the ground and is immobilized and flat-footed until it [[DATABASE/action/Escape|Escapes]] (DC 22). On a critical success, the foe is completely buried and must hold its breath until it is free or else start suffocating. A successful Escape returns the foe to its original square on the surface, or the closest unoccupied square.</span>