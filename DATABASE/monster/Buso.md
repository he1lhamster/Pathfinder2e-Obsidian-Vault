...
- '[[DATABASE/skill/Lore|Cooking Lore]] +10'
- '[[DATABASE/skill/Lore|Farming Lore]] +10'
...
**Languages** [[DATABASE/language/Goblin|Goblin]], [[DATABASE/language/Sylvan|Sylvan]]
**Skills** [[DATABASE/skill/Arcana|Arcana]] +8, [[DATABASE/skill/Athletics|Athletics]] +9, [[DATABASE/skill/Lore|Cooking Lore]] +10, [[DATABASE/skill/Lore|Farming Lore]] +10, [[DATABASE/skill/Nature|Nature]] +8
**Str** +4, **Dex** +1, **Con** +2, **Int** +3, **Wis** +1, **Cha** -1
**Items** [[DATABASE/weapon/Javelin|javelin (4)]], [[DATABASE/weapon/Kukri|kukri]], studded leather
...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> kukri +11 [+7/+3] (agile, trip), **Damage** 1d6+6 slashing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> javelin +8 [+3/-2] (thrown 30 feet), **Damage** 1d6+6 piercing</span><span class="in-box-ability">**Resize Plant** <span class="action-icon">2</span> (arcane, plant, polymorph, transmutation) **Frequency** twice per day; **Requirements** The buso touches a Small, Medium, or Large plant; **Effect** The plant grows or shrinks by one size, remaining that size for the next 5 minutes. If used on a plant creature, this effect has the effects of [[DATABASE/spell/Enlarge|enlarge]] or [[DATABASE/spell/Shrink|shrink]] (buso's choice). Unwilling plant creatures can attempt a DC 18 Fortitude saving throw to resist this effect.</span>

###  Buso Datu

Occasionally, a busaw spirit who seeks to live a mortal life will possess a buso baby. Such babies are born with the two eyes typical of most humanoid as well as an ivory horn that channels arcane fire. Seen as gods incarnate, they're revered as datu, who rule buso society. When a buso datu dies, their busaw spirit simply retakes their place haunting the forest.