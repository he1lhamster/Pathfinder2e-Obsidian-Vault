...
# Giant Gecko<span class="item-type">Creature 1</span>
...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +8, [[DATABASE/skill/Athletics|Athletics]] +5 (+9 to Climb), [[DATABASE/skill/Stealth|Stealth]] +6
...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +8 [+3/-2], **Damage** 1d8+2 piercing</span>