...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> fist +17 [+12/+7] (magical), **Damage** 2d8+8 bludgeoning</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> splinter +16 [+11/+6] (magical, range increment 30 feet), **Damage** 2d4+8 piercing</span><span class="in-box-ability">**Splinter Volley** <span class="action-icon">2</span> (arcane, evocation) The wood golem makes up to four splinter Strikes, each against a different target. These attacks count toward the wood golem's multiple attack penalty, but the multiple attack penalty doesn't increase until after the wood golem makes all of its attacks.</span>

###  Wood Golem Components
