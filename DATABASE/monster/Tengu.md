...
# Tengu Sneak<span class="item-type">Creature 2</span>

<span class="trait-alignment item-trait">CN</span><span class="trait-size item-trait">Medium</span><span class="item-trait">Humanoid</span><span class="item-trait">Tengu</span>
**Source** [[DATABASE/source/Bestiary|Bestiary]]
**Perception** +6; low-light vision
**Languages** [[DATABASE/language/Common|Common]], [[DATABASE/language/Tengu|Tengu]]; plus two others
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +8, [[DATABASE/skill/Athletics|Athletics]] +6, [[DATABASE/skill/Deception|Deception]] +7, [[DATABASE/skill/Diplomacy|Diplomacy]] +5, [[DATABASE/skill/Society|Society]] +5, [[DATABASE/skill/Stealth|Stealth]] +8, [[DATABASE/skill/Thievery|Thievery]] +8
**Str** +2, **Dex** +4, **Con** +1, **Int** +1, **Wis** +0, **Cha** +1
**Items** [[DATABASE/weapon/Rapier|rapier]], [[DATABASE/weapon/Shortbow|shortbow]], [[DATABASE/armor/Studded Leather Armor|studded leather armor]]
...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> rapier +10 [+5/+0] (deadly 1d8, disarm, finesse), **Damage** 1d6+2 piercing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> beak +10 [+5/+0] (finesse), **Damage** 1d4+2 piercing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> shortbow +10 [+5/+0] (deadly 1d10, range increment 60 feet, reload 0), **Damage** 1d6 piercing</span><span class="in-box-ability">**Go for the Eyes** <span class="action-icon">5</span> (incapacitation) **Trigger** The tengu critically hits with a beak Strike. **Effect** The tengu attempts to peck out its victim’s eyes. The target must attempt a DC 17 Fortitude save.
**Success** Unaffected.
**Failure** Blinded for 1 round.
**Critical Failure** Blinded until healed to maximum HP.</span><span class="in-box-ability">**[[DATABASE/monsterability/Sneak Attack|Sneak Attack]]** The tengu deals 1d6 extra precision damage to flat-footed creatures.</span><span class="in-box-ability">**Surprise Attacker** On the first round of combat, creatures that haven’t acted yet are flat-footed to the tengu.</span>
