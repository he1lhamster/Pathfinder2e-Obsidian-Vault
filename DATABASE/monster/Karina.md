...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +13, [[DATABASE/skill/Athletics|Athletics]] +12, [[DATABASE/skill/Deception|Deception]] +12, [[DATABASE/skill/Stealth|Stealth]] +15
**Str** +3, **Dex** +5, **Con** +3, **Int** -2, **Wis** +1, **Cha** +6
**Sound Imitation** A karina who succeeds at a [[DATABASE/skill/Deception|Deception]] check to [[DATABASE/action/Lie|Lie]] can mimic any voice they have heard. They have a +4 circumstance bonus to this check.
...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> beak +15 [+10/+5] (magical, reach 10 feet), **Damage** 2d8+7 piercing plus grave blight</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> claws +13 [+9/+5] (agile, magical), **Damage** 2d6+5 slashing plus grave blight</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> talons +15 [+10/+5] (magical), **Damage** 1d10+5 piercing plus [[DATABASE/monsterability/Grab|Grab]]</span><span class="in-box-ability">**Grave Blight** (disease) **Saving Throw** DC 19 Fortitude; **Stage 1** carrier with no ill effect (1 day); **Stage 2** 1d6 poison damage, [[DATABASE/condition/Sickened|sickened 1]] (1 day); **Stage 3** 1d8 poison damage, every hour the victim must succeed at another Fortitude save or be [[DATABASE/condition/Confused|confused]] for 1 minute, sickened 2 (1 day)</span><span class="in-box-ability">**Mocking Cry** <span class="action-icon">1</span> (auditory) The karina mimics a voice and mocks a creature within 30 feet. They attempt a Deception check to Demoralize the creature. Regardless of whether the check succeeds, the target creature is temporarily immune to the karina's Mocking Cry for 1 hour.</span>
