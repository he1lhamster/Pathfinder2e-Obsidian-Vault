...
description: 'The rare few drow who specialize in the repeating hand crossbow command
  respect not only for their skills but for their luck and swagger.<br/><br/><b><u>Recall
...
<span class="in-box-ability">**Shootist's Luck <span class="action-icon">5</span> ** (fortune) **Trigger** The shootist fails a save; **Frequency** once per day; **Effect** The shootist rerolls the save and uses the better result.</span>
