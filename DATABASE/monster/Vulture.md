...
**HP** 50; **Immunities** [[DATABASE/condition/Sickened|sickened]]

---
**Speed** 10 feet, fly 35 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> beak +10 [+5/+0], **Damage** 1d10+5 piercing plus carrion fever</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> talon +10 [+6/+2] (agile), **Damage** 1d8+5 slashing</span><span class="in-box-ability">**Carrion Fever** (disease) The [[DATABASE/condition/Sickened|sickened]] condition from carrion fever can't be reduced while the affliction remains; **Saving Throw** DC 18 Fortitude; **Onset** 1 day; **Stage 1** sickened 1 and [[DATABASE/condition/Fatigued|fatigued]] (1 day); **Stage 2** sickened 1, slowed 1, and fatigued (1 day)</span><span class="in-box-ability">**Projectile Vomit** <span class="action-icon">1</span> **Frequency** once per hour; **Effect** The giant vulture vomits up its last meal on a creature within 10 feet. The creature takes 3d6 acid damage with a DC 20 basic Fortitude save. On a failed save, the target is also [[DATABASE/condition/Sickened|sickened 1]].</span>

###  Divine Scavengers

Despite their reputation for being carriers of disease, vultures are revered in some cultures. In the hot climate of northern Garund, they provide a service by eating and carrying away corpses that spoil quickly in the harsh sun. Entities with vulture-like features appear in writings from ancient Osirion, standing watch over pharaohs in life and death. In less wholesome folklore, they can be seen as harbingers of death and decay, making them favored symbols among followers of [[DATABASE/deity/Lamashtu|Lamashtu]] and [[DATABASE/deity/Urgathoa|Urgathoa]].