...
---
**Speed** 20 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> fist +24 [+19/+14] (magical, reach 10 feet), **Damage** 2d10+13 bludgeoning</span><span class="in-box-ability">**Impose Paralysis** <span class="action-icon">5</span> (incapacitation) **Trigger** The stone golem hits a [[DATABASE/condition/Slowed|slowed]] creature. **Effect** The creature must succeed at a DC 30 Fortitude save or become [[DATABASE/condition/Paralyzed|paralyzed]] for 1 round.</span><span class="in-box-ability">**Inexorable March** <span class="action-icon">1</span> The stone golem Strides up to its Speed, pushing back each creature whose space it moves into and damaging them if they try to stop its movement. A creature can attempt to bar the way by succeeding at a DC 34 Fortitude save. On a critical success, the resisting creature takes no damage; otherwise it is damaged as if hit by the golem’s fist.</span><span class="in-box-ability">**Slowing Pulse** <span class="action-icon">1</span> (arcane, concentrate, transmutation) Each creature in a 10-foot emanation must succeed at a DC 30 Fortitude save or be [[DATABASE/condition/Slowed|slowed 1]] for 1 minute. The golem can’t use Slowing Pulse again for 1d4 rounds.</span>
