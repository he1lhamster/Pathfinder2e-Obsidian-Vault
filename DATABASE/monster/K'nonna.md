...
---
**Speed** 30 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> fist +20 [+16/+12] (agile), **Damage** 2d10+8 bludgeoning</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +20 [+15/+10], **Damage** 2d8+8 piercing plus [[Grab]]</span><span class="in-box-ability">**Pounce** <span class="action-icon">1</span> The k'nonna Strides and makes a Strike at the end of that movement. If the k'nonna began this action [[Hidden]], they remain hidden until after this ability's Strike.</span>
