...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> bayonet +17 [+13/+9] (agile, finesse, reach 10 feet), **Damage** 1d4+9 piercing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> _double-barreled musket_ +18 [+13/+8] (concussive, double barrel, fatal d10, range 60 feet, reload 1), **Damage** 2d6+9 piercing</span><span class="in-box-ability">**Bayonet Charge** <span class="action-icon">2</span> The clockwork rifler Strides twice and Strikes with its bayonet</span>