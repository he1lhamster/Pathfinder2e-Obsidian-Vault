...
- '[[DATABASE/skill/Lore|Sailing Lore]] +37'
...
# Bone Ship<span class="item-type">Creature 18</span>

<span class="trait-rare item-trait">Rare</span><span class="trait-alignment item-trait">CE</span><span class="trait-size item-trait">Gargantuan</span><span class="item-trait">Undead</span>
**Source** [[DATABASE/source/Bestiary 3|Bestiary 3]]
...
---
**AC** 42 [[DATABASE/monsterability/All-Around Vision|all-around vision]]; **Fort** +33, **Ref** +27, **Will** +30
**HP** 415; **Immunities** death effects, disease, [[DATABASE/condition/Paralyzed|paralyzed]], poison, skeleton crew, [[DATABASE/condition/Unconscious|unconscious]]; **Resistances** cold 10, electricity 10, fire 10, piercing 10, slashing 10
<span class="in-box-ability">**Blood Wake** (aura, divine, enchantment, fear, mental) 30 feet. The churning water around the bone ship tinges red with seeping blood. A living creature that enters water in the aura sees visions of itself drowning in the blood and must attempt a DC 37 Will save. After attempting this saving throw, the creature is temporarily immune for 1 hour. On a failure, the creature becomes [[DATABASE/condition/Frightened|frightened 2]] (frightened 4 on a critical failure) and [[DATABASE/condition/Stunned|stunned 1]], and it takes a –4 status penalty to [[DATABASE/skill/Athletics|Athletics]] checks to [[DATABASE/action/Swim|Swim]].</span>

---
**Speed** swim 40 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> hull +35 [+30/+25] (reach 20 feet), **Damage** 3d10+17 bludgeoning plus 2d10 negative</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> skeleton crew +35 [+31/+27] (agile), **Damage** 3d6+17 slashing plus 2d10 negative</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> bone cannon +35 [+30/+25] (brutal, divine, negative, range increment 100 feet), **Damage** 2d12+12 bludgeoning damage plus 2d10 negative</span><span class="in-box-ability">**Cannonade** <span class="action-icon">2</span> The bone ship makes four bone cannon Strikes, each targeting a different creature.</span><span class="in-box-ability">**Chain Shot** <span class="action-icon">1</span> The bone ship makes a special bone cannon Strike, firing a chain made of bones. A creature hit by this Strike is [[DATABASE/condition/Grabbed|grabbed]] by the chain ([[DATABASE/action/Escape|Escape]] DC 41). The bone ship can use Interact actions to reel in a grabbed creature 50 feet per action spent, and when the ship moves, it pulls the grabbed creature along with it.</span><span class="in-box-ability">**Crew's Call** <span class="action-icon">2</span> (divine) The crew let out an anguished cry in unison. This is a [[DATABASE/spell/Wail of the Banshee|wail of the banshee]] spell with 100-foot emanation (DC 39). In addition, any creature within 5 feet of the ship is grabbed by the crew. The ship can't use Crew's Call again for 1d4+1 rounds.</span><span class="in-box-ability">**Keelhaul** <span class="action-icon">3</span> As [[DATABASE/monsterability/Trample|Trample]] (Huge or smaller, hull, DC 43), but the bone ship Swims up to double its swim Speed instead of Striding, and each creature that fails its save is also dragged under the ship. The GM places each creature dragged along in an underwater space adjacent to the bone ship at the end of the ship's movement.</span><span class="in-box-ability">**Pressgang Soul** <span class="action-icon">1</span> (divine) The bone ship casts [[DATABASE/spell/Bind Soul|bind soul]]. The target must have died due to the bone ship's assault or from drowning. The creature's soul becomes part of the ghostly crew. A new soul gem grows on the ship, and the bone ship is [[DATABASE/condition/Quickened|quickened]] for 1 minute. It can use the extra action only to Strike or Swim.</span>
...
* _Captain Aster's Eulogy_
* _Crimson Mirage_
* _Starved Whale_
* _Horseman's Herald_
* _Wail upon the Winds_

###  Piloting a Bone Ship
...
**Piloting Check** [[DATABASE/skill/Lore|Sailing Lore]] (DC 40), [[DATABASE/skill/Religion|Religion]] (DC 38); the ship's propulsion is wind if Sailing Lore is used, or magical if Religion is used 
**Collision** 9d10 bludgeoning plus 5d6 negative (DC 38)

###  Vessels of the Dark Gods

Evil deities sometimes raise bone ships bound to them. These flagships herald destruction done at the creator's will.
 [[DATABASE/deity/Urgathoa|Urgathoa]] occasionally makes bone ships to carry her revered acolytes to distant lands or cultures at sea. One of the Four Horsemen of the Apocalypse, [[DATABASE/deity/Charon|Charon]] the Boatman, counts many bone ships among his followers; some ply the River Styx in [[DATABASE/plane/Abaddon|Abaddon]]; while others ferry his apostles to other planes. Charon's bone ships approach slowly rather than speeding toward their quarry, giving more time for the hearts of those who witness them to lose all hope.
 [[DATABASE/deity/Kelizandri|Kelizandri]], elemental lord of water, holds power over the drowned. He gives them new purpose crewing bone ships, where they can live eternally in the moment of their death under the waves. His ships frequently plumb the depths of great seas, casting ghostly green light down in the blackness.