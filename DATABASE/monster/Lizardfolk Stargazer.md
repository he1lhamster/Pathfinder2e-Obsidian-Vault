...
**Source** [[DATABASE/source/Bestiary|Bestiary]]
**Perception** +8
**Languages** [[DATABASE/language/Draconic|Draconic]], [[DATABASE/language/Iruxi|Iruxi]]
**Skills** [[DATABASE/skill/Diplomacy|Diplomacy]] +4, [[DATABASE/skill/Lore|Iruxi Lore]] +6, [[DATABASE/skill/Nature|Nature]] +8, [[DATABASE/skill/Stealth|Stealth]] +6, [[DATABASE/skill/Survival|Survival]] +8
...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> staff +8 [+3/-2] (two-hand d8), **Damage** 1d6+2 bludgeoning</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +8 [+3/-2], **Damage** 1d6+2 piercing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> tail +8 [+4/+0] (agile, finesse), **Damage** 1d4+2 bludgeoning</span>**Primal Prepared Spells** DC 20, attack +10; **1st** _[[DATABASE/spell/Charm|charm]]_, _[[DATABASE/spell/Heal|heal]]_, _[[DATABASE/spell/Magic Fang|magic fang]]_, _[[DATABASE/spell/Shillelagh|shillelagh]]_, _[[DATABASE/spell/Summon Animal|summon animal]]_; **Cantrips** **(1st)** _[[DATABASE/spell/Guidance|guidance]]_, _[[DATABASE/spell/Know Direction|know direction]]_, _[[DATABASE/spell/Produce Flame|produce flame]]_, _[[DATABASE/spell/Stabilize|stabilize]]_
