...
- and [[DATABASE/trait/Goblin|Goblin]] )
level: '7'
max_speed: '30'
name: Fortune Eater
perception: '+13'
...
---
**Speed** fly 30 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> ghostly longsword +17 [+12/+7] (finesse, magical, versatile P), **Damage** 1d8+8 slashing plus 1d8 negative</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> ghostly light mace +17 [+13/+9] (agile, finesse, magical, shove), **Damage** 1d4+8 bludgeoning plus 1d8 negative</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> ghostly longbow +17 [+12/+7] (deadly d10, magical, range increment 100 feet, volley 30 feet), **Damage** 1d8+4 piercing plus 1d8 negative</span><span class="in-box-ability">**Team Attack** <span class="action-icon">3</span> Dead teammates coalesce to attack with phantasmal versions of the weapons they used in life. The fortune eater makes a ghostly longsword Strike, ghostly dagger Strike, and ghostly longbow Strike in any order. Each must target a different creature. Their multiple attack penalty doesn't increase until after all the attacks.</span>
