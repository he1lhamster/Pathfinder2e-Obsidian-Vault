...
---
**Speed** swim 30 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> sting +7 [+3/-1] (agile, finesse), **Damage** 1d6+1 piercing plus stingray venom</span><span class="in-box-ability">**Stingray Venom** (poison) **Saving Throw** DC 16 Fortitude; **Maximum Duration** 4 rounds; **Stage 1** 1d4 poison damage (1 round); **Stage 2** 1d6 poison damage and [[Clumsy]] (1 round)</span>