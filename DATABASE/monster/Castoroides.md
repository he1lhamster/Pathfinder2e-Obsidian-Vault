...
**HP** 45
<span class="in-box-ability">**Slap** <span class="action-icon">5</span> **Trigger** The castoroides is targeted by a physical ranged Strike from an attacker it can see; **Effect** The castoroides swats at the projectile with its wide tail, gaining a +2 circumstance bonus to its AC against the triggering attack.</span>
