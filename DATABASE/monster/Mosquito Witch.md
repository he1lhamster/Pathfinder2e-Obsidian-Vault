...
**Source** [[DATABASE/source/Monsters of Myth|Monsters of Myth]]
**Perception** +22; [[DATABASE/monsterability/Darkvision|darkvision]], swarmsense (imprecise) 30 feet
**Languages** [[DATABASE/language/Aklo|Aklo]], [[DATABASE/language/Auran|Auran]], [[DATABASE/language/Common|Common]], [[DATABASE/language/Sylvan|Sylvan]]; [[DATABASE/spell/Speak with Animals|speak with animals]]
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +18, [[DATABASE/skill/Diplomacy|Diplomacy]] +18, [[DATABASE/skill/Intimidation|Intimidation]] +20, [[DATABASE/skill/Medicine|Medicine]] +19, [[DATABASE/skill/Nature|Nature]] +21, [[DATABASE/skill/Occultism|Occultism]] +15, [[DATABASE/skill/Stealth|Stealth]] +22, [[DATABASE/skill/Survival|Survival]] +21
...
**Wild Empathy** The Mosquito Witch can use [[DATABASE/skill/Diplomacy|Diplomacy]] to [[DATABASE/action/Make an Impression|Make an Impression]] on and make [[DATABASE/action/Request|Requests]] of arthropods (insects, spiders, and similar invertebrates like bloodseekers). Most arthropods have a starting attitude of [[DATABASE/condition/Indifferent|indifferent]] to the Mosquito Witch.

---
**AC** 30; **Fort** +17, **Ref** +20, **Will** +23
**HP** 180; **Immunities** disease
<span class="in-box-ability">**Haunting Gaze** (aura, emotion, enchantment, fear, mental, visual) 30 feet. When a creature ends its turn in the emanation, it must attempt a DC 29 Will save. If the creature fails, it becomes [[DATABASE/condition/Frightened|frightened 1]]. If it's already frightened, its frightened value instead increases by 1 (maximum frightened 3) and doesn't decrease by 1 at the end of the creature's next turn. If a creature's frightened value is 3 or higher before failing its save, the creature is also [[DATABASE/condition/Fleeing|fleeing]] for 1 round.</span>

---
**Speed** 30 feet, climb 30 feet, fly 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> bite +23 [+19/+15] (agile, finesse), **Damage** 2d12+8 piercing plus 1d8 [[DATABASE/condition/Persistent Damage|persistent bleed damage]]</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> swarm strike +23 [+18/+13] (range increment 30 feet), **Damage** 2d10+6 piercing plus dipteric dread</span>**Primal Innate Spells** DC 29; **5th** _[[DATABASE/spell/Tree Stride|tree stride]]_, _[[DATABASE/spell/Vomit Swarm|vomit swarm]]_ (x2); **4th** _[[DATABASE/spell/Pest Form|pest form]]_ (at will); **3rd** _[[DATABASE/spell/Animal Vision|animal vision]]_; **2nd** _[[DATABASE/spell/Animal Messenger|animal messenger]]_; **Cantrips** **(5th)** _[[DATABASE/spell/Dancing Lights|dancing lights]]_; **Constant** **(2nd)** _[[DATABASE/spell/Speak with Animals|speak with animals]]_
<span class="in-box-ability">**Dipteric Dread** (poison) **Saving Throw** DC 29 Fortitude; **Maximum Duration** 6 rounds; **Stage 1** 2d6 piercing and 2d6 poison (1 round); **Stage 2** 2d6 piercing and 3d6 poison (1 round); **Stage 3** 2d6 piercing and 5d6 poison</span><span class="in-box-ability">**Terror From Within** The Mosquito Witch's powers feed on fear. When taking bleed or piercing damage dealt by the Mosquito Witch's bleed and dipteric dread, a creature takes additional damage equal to twice the creature's [[DATABASE/condition/Frightened|frightened]] value.</span>
 ...
 **Bloodbelly** The Mosquito Witch steals and stores stolen blood to power her divinations. Whenever she deals piercing damage, the Mosquito Witch can gain an equal number of Blood Points, to a maximum of 100 Blood Points. She becomes [[DATABASE/condition/Clumsy|clumsy 1]] so long as she has at least 40 Blood Points stored, or [[DATABASE/condition/Clumsy|clumsy 2]] if she has at least 80 Blood Points stored. **Slurp** <span class="action-icon">5</span> **Trigger** A creature adjacent to the Mosquito Witch takes [[DATABASE/condition/Persistent Damage|persistent bleed damage]]; **Effect** The Mosquito Witch slurps up some of the creature's blood and gains Blood Points equal to the bleed damage dealt.
 **Occult Innate Spells** DC 29; **7th** [[DATABASE/spell/Retrocognition|retrocognition]] (×3); **6th** [[DATABASE/spell/Object Reading|object reading]] (×3), [[DATABASE/spell/Scrying|scrying]] (×3); **5th** [[DATABASE/spell/Locate|locate]] (×3), [[DATABASE/spell/Prying Eye|prying eye]] (×3); **4th** [[DATABASE/spell/Read Omens|read omens]] (×3); **3rd** [[DATABASE/spell/Wanderer's Guide|wanderer's guide]] (×3)
...
Mosquitoes are parasites. Like her namesake, the Mosquito Witch wanders the world before alighting in an unguarded area to drain it of life and happiness. Once sated, she withdraws to digest her stolen vitality.
 ...
 This variant learns the [[DATABASE/ritual/Mosquito Blight|mosquito blight]] ritual, which she uses to create a huge area of deadly disease.
 ...
 **Perception** +22; [[DATABASE/monsterability/Darkvision|darkvision]], swarmsense (imprecise) 100 feet, swarmsight (precise) 20 feet
 ...
 **Obscuring Host** (aura) 20 feet. A thick swarm of mosquitoes surrounds the Mosquito Witch, creating [[DATABASE/condition/Concealed|concealment]] in the aura. A creature that begins its turn in the emanation becomes [[DATABASE/condition/Sickened|sickened 1]] unless it succeeds at a DC 26 Fortitude save. The Mosquito Witch and arthropods can see through this aura and are immune to its sickened effect.
 **Fecund Wounds** Insect larvae clog and wriggle out of open wounds within 100 feet of the Mosquito Witch. A creature that takes bleed damage in the area also becomes [[DATABASE/condition/Clumsy|clumsy 1]] for 1 round. **Primal Innate Spells** DC 29; **3rd** [[DATABASE/spell/Animal Vision|animal vision]] (at will); **2nd** [[DATABASE/spell/Animal Messenger|animal messenger]] (at will); **Cantrips (5th)** [[DATABASE/spell/Dancing Lights|dancing lights]]; **Constant** [[DATABASE/spell/Speak with Animals|speak with animals]]