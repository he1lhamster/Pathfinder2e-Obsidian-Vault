...
**Skills** [[DATABASE/skill/Athletics|Athletics]] +8 (+10 to Climb)
**Str** +4, **Dex** +2, **Con** +4, **Int** -4, **Wis** +2, **Cha** +0

---
**AC** 18; **Fort** +10, **Ref** +8, **Will** +6
**HP** 32
<span class="in-box-ability">**Passive Points** A creature that hits a porcupine with an unarmed Strike or a non-reach melee Strike takes 1d8 piercing damage (basic Reflex save). On a critical failure, the creature also takes 1d4 [[DATABASE/condition/Persistent Damage|persistent piercing damage]] as the quills hook into its flesh.</span>

---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> quills +11 [+6/+1], **Damage** 1d8+4 piercing plus embed quill</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> tail +11 [+6/+1], **Damage** 1d6+4 bludgeoning</span><span class="in-box-ability">**Embed Quill** A creature damaged by the porcupine's quills Strike must succeed at a DC 18 Reflex save or some of the quills remain embedded in its body, dealing 1d4 [[DATABASE/condition/Persistent Damage|persistent piercing damage]].</span><span class="in-box-ability">**Rearward Rush** <span class="action-icon">2</span> **Effect** The porcupine scuttles backward, quills extended. It Strides twice, then makes a quill Strike. The target is [[DATABASE/condition/Flat-Footed|flat-footed]] against this Strike unless it has seen a Rearward Rush before.</span>
