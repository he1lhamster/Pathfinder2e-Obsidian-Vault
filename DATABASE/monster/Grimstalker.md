...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +13, [[DATABASE/skill/Intimidation|Intimidation]] +13, [[DATABASE/skill/Nature|Nature]] +11, [[DATABASE/skill/Stealth|Stealth]] +13, [[DATABASE/skill/Survival|Survival]] +12
**Str** +4, **Dex** +4, **Con** +2, **Int** +2, **Wis** +3, **Cha** +2
**Camouflage** A grimstalker can [[DATABASE/action/Hide|Hide]] in natural environments, even if it doesn't have cover.
...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> claw +15 [+11/+7] (agile), **Damage** 2d6+7 slashing plus grimstalker sap</span>**Primal Innate Spells** DC 22, attack +14; **3rd** _[[DATABASE/spell/Earthbind|earthbind]]_, _[[DATABASE/spell/Wall of Thorns|wall of thorns]]_; **2nd** _[[DATABASE/spell/Entangle|entangle]]_, _[[DATABASE/spell/Pass Without Trace|pass without trace]]_, _[[DATABASE/spell/Tree Shape|tree shape]]_; **Cantrips** **(3rd)** _[[DATABASE/spell/Tanglefoot|tanglefoot]]_
<span class="in-box-ability">**Grimstalker Sap** (poison) **Saving Throw** DC 22 Fortitude; **Maximum Duration** 6 rounds; **Stage 1** 1d6 poison damage (1 round); **Stage 2** 1d6 poison damage and [[DATABASE/condition/Clumsy|clumsy 1]] (1 round), **Stage 3** 2d6 poison damage and clumsy 2 (1 round)</span><span class="in-box-ability">**Woodland Stride** A grimstalker can always find a path, almost as if foliage parts before it. A grimstalker ignores difficult terrain caused by plants, such as bushes, vines, and undergrowth. Even plants manipulated by magic don't impede its progress.</span>

###  Grimstalker Forestry

Grimstalkers often harvest the seeds of carnivorous plants, particularly [[DATABASE/monster/Assassin Vine|assassin vines]], which they sow during their wanderings. Typically they seed their territory's borders with these dangerous plants as a defense tactic, but they also sow gardens and fields, weaponizing these plots of land against hapless gardeners and farmers.