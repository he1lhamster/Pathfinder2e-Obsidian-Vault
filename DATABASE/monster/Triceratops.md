...
**HP** 140
<span class="in-box-ability">**Frill Defense** <span class="action-icon">5</span> **Trigger** The rider is targeted with an attack. **Requirements** A creature must be mounted on the triceratops. **Effect** The triceratops intercepts the attack with its bony frill. The rider gains a +2 circumstance bonus to its AC against the triggering attack.</span>
