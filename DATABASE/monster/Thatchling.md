...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> frond +5 [+1/-3] (agile, finesse), **Damage** 1d6 slashing</span><span class="in-box-ability">**Thatchling's Curse** <span class="action-icon">2</span> (curse, enchantment, mental, occult) The thatchling focuses its attention on a single target within 30 feet that it can see, and then begins muttering and whispering nonsense. The target must attempt a DC 16 Will save.
