...
# Living Boulder<span class="item-type">Creature 2</span>
...
**Source** [[DATABASE/source/Bestiary 2|Bestiary 2]] 
**Perception** +6; [[DATABASE/monsterability/Darkvision|darkvision]], [[DATABASE/monsterability/Tremorsense|tremorsense 30 feet]]
**Skills** [[DATABASE/skill/Athletics|Athletics]] +8, [[DATABASE/skill/Stealth|Stealth]] +5 (+7 in rocky areas)
**Str** +4, **Dex** -1, **Con** +4, **Int** -4, **Wis** +2, **Cha** -1

---
**AC** 17; **Fort** +10, **Ref** +5, **Will** +8
**HP** 36; **Immunities** bleed, [[DATABASE/condition/Paralyzed|paralyzed]], poison, sleep

---
**Speed** 20 feet, burrow 20 feet; earth glide
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +10 [+5/+0], **Damage** 1d8+6 piercing</span><span class="in-box-ability">**Earth Glide** A living boulder can [[DATABASE/action/Burrow|Burrow]] through earthen matter, including rock. When it does so, it moves at its full burrow Speed, leaving no tunnels or signs of its passing.</span><span class="in-box-ability">**Rolling Charge** <span class="action-icon">2</span> The living boulder Strides twice, and can then make a Strike with its jaws. This jaws Strike gains [[DATABASE/monsterability/Knockdown|Knockdown]].</span>