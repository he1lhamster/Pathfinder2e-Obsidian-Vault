...
# Herexen<span class="item-type">Creature 2</span>
...
**Skills** [[DATABASE/skill/Athletics|Athletics]] +6, [[DATABASE/skill/Deception|Deception]] +7, [[DATABASE/skill/Religion|Religion]] +10, [[DATABASE/skill/Stealth|Stealth]] +6
**Str** +2, **Dex** +2, **Con** +1, **Int** +0, **Wis** +4, **Cha** +3
**Items** [[DATABASE/weapon/Dagger|dagger]], defiled [[DATABASE/equipment/Religious Symbol|religious symbol]] of [[DATABASE/deity/Pharasma|Pharasma]]

---
**AC** 17; **Fort** +5, **Ref** +8, **Will** +10
**HP** 30 ([[DATABASE/monsterability/Negative Healing|negative healing]]); **Immunities** death effects, disease, [[DATABASE/condition/Paralyzed|paralyzed]], poison, [[DATABASE/condition/Unconscious|unconscious]]
<span class="in-box-ability">**Final Blasphemy** (divine, necromancy, negative) When the herexen is destroyed, it explodes in a wave of negative energy with the effects of a 3-action [[DATABASE/spell/Harm|harm]] spell (DC 20). The herexen is destroyed, so it doesn't gain any Hit Points from this use of harm, and it doesn't need to have any harm spells remaining to use this ability.</span>

---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> dagger +10 [+6/+2] (agile, versatile S), **Damage** 1d6+4 piercing plus heretic's smite</span>**Divine Prepared Spells** DC 18; **1st** _[[DATABASE/spell/Harm|harm]]_ (×4)
**Cleric Domain Spells** DC 20, 1 Focus Point; **1st** _[[DATABASE/spell/Death's Call|death's call]]_
<span class="in-box-ability">**Heretic's Smite** (divine, necromancy) While wielding the favored weapon of its former deity (such as a [[DATABASE/weapon/Dagger|dagger]] for an ex-[[DATABASE/deity/Pharasma|Pharasmin]] herexen), the herexen's Strikes deal an additional 1d6 evil damage against creatures that can cast divine spells.</span>
