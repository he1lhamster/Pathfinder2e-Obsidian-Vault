...
# Lillend<span class="item-type">Creature 7</span>

<span class="trait-alignment item-trait">CG</span><span class="trait-size item-trait">Large</span><span class="item-trait">Azata</span><span class="item-trait">Celestial</span>
**Source** [[DATABASE/source/Bestiary|Bestiary]]
...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +14, [[DATABASE/skill/Deception|Deception]] +16, [[DATABASE/skill/Diplomacy|Diplomacy]] +18, [[DATABASE/skill/Nature|Nature]] +14, [[DATABASE/skill/Performance|Performance]] +20, [[DATABASE/skill/Religion|Religion]] +14, [[DATABASE/skill/Survival|Survival]] +12
**Str** +4, **Dex** +3, **Con** +5, **Int** +2, **Wis** +3, **Cha** +5
**Items** [[DATABASE/weapon/Longsword|+1 longsword]], [[DATABASE/equipment/Musical Instrument|virtuoso harp]]

---
**AC** 25; **Fort** +14, **Ref** +16, **Will** +16
**HP** 145; **Weaknesses** cold iron 10, evil 10
<span class="in-box-ability">**Free Expression** A lillend’s auditory and sonic effects attempt to counteract any effect that would directly control, manipulate, or prevent them from expressing themself freely, such as silence. She can also spend an action, which has concentrate trait, to speak forcefully and counteract such effects.</span>

---
**Speed** 25 feet, fly 45 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> _longsword_ +18 [+13/+8] (chaotic, magical, versatile P), **Damage** 1d8+10 slashing plus 1d6 chaotic and 1d6 good</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> tail +18 [+14/+10] (agile, magical, reach 10 feet), **Damage** 2d6+10 bludgeoning plus 1d6 chaotic, 1d6 good, and [[DATABASE/monsterability/Grab|Grab]]</span>**Divine Innate Spells** DC 26; **4th** _[[DATABASE/spell/Counter Performance|counter performance]]_, _[[DATABASE/spell/Hallucinatory Terrain|hallucinatory terrain]]_, _[[DATABASE/spell/Heal|heal]]_, _[[DATABASE/spell/Inspire Heroics|inspire heroics]]_, _[[DATABASE/spell/Sound Burst|sound burst]]_, _[[DATABASE/spell/Suggestion|suggestion]]_; **3rd** _[[DATABASE/spell/Sleep|sleep]]_; **2nd** _[[DATABASE/spell/Darkness|darkness]]_, _[[DATABASE/spell/Invisibility|invisibility]]_; **1st** _[[DATABASE/spell/Charm|charm]]_; **Cantrips** **(4th)** _[[DATABASE/spell/Daze|daze]]_, _[[DATABASE/spell/Detect Magic|detect magic]]_, _[[DATABASE/spell/Ghost Sound|ghost sound]]_, _[[DATABASE/spell/Inspire Competence|inspire competence]]_, _[[DATABASE/spell/Inspire Courage|inspire courage]]_, _[[DATABASE/spell/Light|light]]_; **Constant** **(5th)** _[[DATABASE/spell/Tongues|tongues]]_; **(4th)** _[[DATABASE/spell/Speak with Plants|speak with plants]]_; **(2nd)** _[[DATABASE/spell/Speak with Animals|speak with animals]]_