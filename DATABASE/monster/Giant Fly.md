...
**HP** 20
<span class="in-box-ability">**Avoid the Swat <span class="action-icon">5</span> ** **Trigger** The giant fly is targeted with a melee or ranged attack by an attacker it can see; **Effect** The giant fly gains a +2 circumstance bonus against the triggering attack. If the attack misses, the giant insect can Fly up to its fly Speed.</span>
