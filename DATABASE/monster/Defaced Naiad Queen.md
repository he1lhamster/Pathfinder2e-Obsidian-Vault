...
# Defaced Naiad Queen<span class="item-type">Creature 15</span>

<span class="trait-rare item-trait">Rare</span><span class="trait-alignment item-trait">CE</span><span class="trait-size item-trait">Medium</span><span class="item-trait">Amphibious</span><span class="item-trait">Fey</span><span class="item-trait">Nymph</span><span class="item-trait">Water</span>
**Source** [[DATABASE/source/Kingmaker Adventure Path|Kingmaker Adventure Path]]
Variant female [[DATABASE/monster/Naiad Queen|naiad queen]]
**Perception** +28; low-light vision
**Languages** [[DATABASE/language/Aklo|Aklo]], [[DATABASE/language/Elven|Elven]], [[DATABASE/language/Sylvan|Sylvan]]
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +28, [[DATABASE/skill/Athletics|Athletics]] +25 (+29 to Swim), [[DATABASE/skill/Deception|Deception]] +31, [[DATABASE/skill/Diplomacy|Diplomacy]] +29, [[DATABASE/skill/Intimidation|Intimidation]] +31, [[DATABASE/skill/Nature|Nature]] +28, [[DATABASE/skill/Performance|Performance]] +31, [[DATABASE/skill/Stealth|Stealth]] +28, [[DATABASE/skill/Survival|Survival]] +26
...
---
**AC** 38; **Fort** +27, **Ref** +30, **Will** +26
**HP** 230; **Weaknesses** cold iron 15, Resistances fire 15
<span class="in-box-ability">**Nymph's Tragedy** (aura, emotion, enchantment, mental, primal, visual) 30 feet. Creatures that start their turn in this aura must succeed at a DC 33 Will save or become [[DATABASE/condition/Dazzled|dazzled]] as their eyes cloud with blood, darkening their vision. This effect persists as long as the creature continues to begin its turn within the aura, even if it can't see the defaced naiad on subsequent turns.</span>

---
**Speed** 30 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> painful caress +30 [+26/+22] (agile, finesse, magical), **Damage** 3d10+14 mental plus Tortuous Touch</span>**Primal Prepared Spells** DC 36, attack +28; **8th** _[[DATABASE/spell/Finger of Death|finger of death]]_, _[[DATABASE/spell/Heal|heal]]_; **7th** _[[DATABASE/spell/Chain Lightning|chain lightning]]_, _[[DATABASE/spell/Dispel Magic|dispel magic]]_, _[[DATABASE/spell/Fly|fly]]_; **6th** _[[DATABASE/spell/Baleful Polymorph|baleful polymorph]]_, _[[DATABASE/spell/Flesh to Stone|flesh to stone]]_, _[[DATABASE/spell/Lightning Bolt|lightning bolt]]_; **5th** _[[DATABASE/spell/Cone of Cold|cone of cold]]_, _[[DATABASE/spell/Heal|heal]]_ (×2); **4th** _[[DATABASE/spell/Freedom of Movement|freedom of movement]]_, _[[DATABASE/spell/Heal|heal]]_ (×2); **3rd** _[[DATABASE/spell/Blindness|blindness]]_, _[[DATABASE/spell/Fear|fear]]_, _[[DATABASE/spell/Slow|slow]]_; **2nd** _[[DATABASE/spell/Glitterdust|glitterdust]]_, _[[DATABASE/spell/Obscuring Mist|obscuring mist]]_, _[[DATABASE/spell/Web|web]]_; **1st** _[[DATABASE/spell/Fear|fear]]_, _[[DATABASE/spell/Gust of Wind|gust of wind]]_, _[[DATABASE/spell/Spider Sting|spider sting]]_; **Cantrips** **(8th)** _[[DATABASE/spell/Detect Magic|detect magic]]_, _[[DATABASE/spell/Guidance|guidance]]_, _[[DATABASE/spell/Light|light]]_, _[[DATABASE/spell/Ray of Frost|ray of frost]]_, _[[DATABASE/spell/Stabilize|stabilize]]_
**Primal Innate Spells** DC 36, attack +28; **4th** _[[DATABASE/spell/Charm|charm]]_ (at will); **Constant** **(4th)** _[[DATABASE/spell/Speak with Plants|speak with plants]]_
<span class="in-box-ability">**Agonized Wail** <span class="action-icon">1</span> (auditory, emotion, enchantment, fear, mental, primal) The defaced naiad queen unleashes an agonized wail. Each creature within 60 feet must succeed at a DC 33 Will save or become [[DATABASE/condition/Frightened|frightened]] 1 (or, on a critical failure, frightened 2 and [[DATABASE/condition/Fleeing|fleeing]] until the end of its next turn). The creature is then temporarily immune to Agonized Wail for 1 hour.</span><span class="in-box-ability">**Baleful Gaze** <span class="action-icon">1</span> (emotion, enchantment, incapacitation, mental, primal, visual) When a defaced naiad queen fixes her gaze upon a foe within range of her nymph's tragedy aura, the creature must attempt a Will save. On a failure, it is affected as if by nymph's tragedy; if it was already affected by that aura, it also takes 8d6 mental damage (16d6 on a critical failure). A defaced naiad queen can use Baleful Gaze on a given creature only once per turn.</span><span class="in-box-ability">**Tortuous Touch** <span class="action-icon">1</span> A creature struck by the defaced naiad queen's painful caress Strike must attempt a DC 36 Fortitude save. On a failure, painful, jagged wounds open on the creature's body, the pain of which makes it [[DATABASE/condition/Clumsy|clumsy]] 1 (clumsy 2 and fall [[DATABASE/condition/Prone|prone]] on a critical failure). The clumsy condition is permanent until it is removed via an effect like [[DATABASE/spell/Restoration|restoration]].</span>
...
### [[DATABASE/action/Forgive Foe|Forgive Foe]] <span class="action-icon">2</span>
