...
**HP** 280 ([[Negative Healing]]); **Immunities** disease, [[Paralyzed]], poison, polymorph, [[Unconscious]]
<span class="in-box-ability">**Desiccation Aura** (aura, divine, necromancy) 30 feet. A cloud of choking, acrid dust swirls about the hollow serpent, draining moisture from any enemy within. A creature entering the aura or starting its turn in the aura must succeed at a DC 34 Fortitude save or become [[Enfeebled]] and [[Slowed]] for 1d4 rounds (2d4 rounds on a critical failure). A creature that succeeds is temporarily immune for 24 hours.</span><span class="in-box-ability">**Divine Guardian <span class="action-icon">5</span> ** **Trigger** An ally within the hollow serpent's reach is attacked; **Effect** The hollow serpent interposes a coil of its body or tail between the ally and attacker. The triggering attack targets the hollow serpent instead of the original target.</span>

---
**Speed** 50 feet, climb 50 feet; [[Freedom of Movement]]
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +30 [+25/+20] (reach 10 feet), **Damage** 4d10+15 piercing plus [[Improved Grab]]</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> tail +30 [+26/+22] (agile, reach 15 feet), **Damage** 3d10+15 bludgeoning plus [[Improved Grab]]</span>**Divine Innate Spells** DC 35; **7th** _[[Vampiric Exsanguination]]_ (drawing in moisture rather than blood); **Constant** **(7th)** _[[Freedom of Movement]]_
<span class="in-box-ability">**[[Constrict]]** <span class="action-icon">1</span> 1d10+7 bludgeoning plus drained 1, DC 36</span><span class="in-box-ability">**[[Swallow Whole]]** <span class="action-icon">1</span> Medium, 4d6 negative plus drained 1, Rupture 32</span><span class="in-box-ability">**Slithering Strike** <span class="action-icon">1</span> The hollow serpent Strides or [[Climb]] and makes a jaws Strike at the end of that movement. If the hollow serpent began this action [[Hidden]], it remains hidden until after this ability's Strike.</span>

###  Serpent Forms

The original hollow serpents were based on the pythons of the Mwangi jungle. The [[Ghoul]] of Nemret Noktoria have experimented with the skins of magically enlarged horned vipers and spitting cobras, hoping to create venomous variants. So far, they have only made hollow serpents of unusually ominous mien, as their venom fails to survive the transition to undeath.