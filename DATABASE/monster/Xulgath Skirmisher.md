...
# Xulgath Skirmisher<span class="item-type">Creature 6</span>
...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +16, [[DATABASE/skill/Athletics|Athletics]] +14, [[DATABASE/skill/Stealth|Stealth]] +16, [[DATABASE/skill/Survival|Survival]] +15
**Str** +4, **Dex** +4, **Con** +1, **Int** +0, **Wis** +3, **Cha** +0
**Items** [[DATABASE/weapon/Javelin|javelins (6)]], [[DATABASE/weapon/Scimitar|scimitar]], [[DATABASE/armor/Studded Leather Armor|studded leather armor]]
...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> scimitar +16 [+11/+6] (forceful, sweep), **Damage** 1d6+4 slashing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +16 [+11/+6], **Damage** 1d6+4 piercing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> claw +16 [+12/+8] (agile, finesse), **Damage** 1d4+4 slashing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> javelin +16 [+11/+6] (thrown 60 feet), **Damage** 1d6+4 piercing damage</span><span class="in-box-ability">**Light Step** When a skirmisher Strides or Steps, they ignore difficult terrain and treat greater difficult terrain as difficult terrain.</span><span class="in-box-ability">**Powerful Arm** The xulgath skirmisher doubles the range increment of its thrown weapons.</span><span class="in-box-ability">**Skirmishing Movement** <span class="action-icon">2</span> (attack, move) The xulgath skirmisher Strides or Steps, then Strikes. This Strike deals an additional 3d6 precision damage.</span>