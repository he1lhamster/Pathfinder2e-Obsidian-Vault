...
# Gorilla<span class="item-type">Creature 3</span>
...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +9, [[DATABASE/skill/Athletics|Athletics]] +11, [[DATABASE/skill/Stealth|Stealth]] +7
...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> fist +11 [+7/+3] (agile, reach 10 feet), **Damage** 2d6+4 bludgeoning</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +11 [+6/+1] (reach 5 feet), **Damage** 1d8+4 piercing</span><span class="in-box-ability">**Frightening Display** <span class="action-icon">2</span> (auditory, emotion, fear, mental) The gorilla beats its chest in a terrifying display. Creatures within 30 feet must attempt a DC 20 Will save. While a creature is [[DATABASE/condition/Frightened|frightened]] by this ability, it is [[DATABASE/condition/Flat-Footed|flat-footed]] to the gorilla.
...
**Critical Failure** The creature is [[DATABASE/condition/Frightened|frightened 2]].</span>

###  Gigantopithecus

These fierce kin of orangutans are three times heavier than a gorilla. They are level 4, with statistics roughly akin to an elite gorilla.