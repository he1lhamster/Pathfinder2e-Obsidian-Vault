...
# Veranallia<span class="item-type">Creature 20</span>
...
**Source** [[DATABASE/source/Bestiary 2|Bestiary 2]] 
**Perception** +38; [[DATABASE/monsterability/Darkvision|darkvision]], [[DATABASE/monsterability/Tremorsense|tremorsense (imprecise) 120 feet]]
**Languages** [[DATABASE/language/Celestial|Celestial]], [[DATABASE/language/Draconic|Draconic]], [[DATABASE/language/Infernal|Infernal]]; [[DATABASE/spell/Speak with Animals|speak with animals]], [[DATABASE/spell/Speak with Plants|speak with plants]], [[DATABASE/spell/Tongues|tongues]]
**Skills** [[DATABASE/skill/Athletics|Athletics]] +34, [[DATABASE/skill/Deception|Deception]] +36, [[DATABASE/skill/Diplomacy|Diplomacy]] +38, [[DATABASE/skill/Lore|Elysium Lore]] +36, [[DATABASE/skill/Intimidation|Intimidation]] +36, [[DATABASE/skill/Medicine|Medicine]] +36, [[DATABASE/skill/Nature|Nature]] +34, [[DATABASE/skill/Survival|Survival]] +38
**Str** +8, **Dex** +6, **Con** +8, **Int** +6, **Wis** +10, **Cha** +8
**Items** _+3 [[DATABASE/equipment/Striking|greater striking]] [[DATABASE/weapon/Sickle|sickle]]_

---
**AC** 45; **Fort** +36, **Ref** +34, **Will** +38
**HP** 475; **Resistances** fire 20, cold 20; **Weaknesses** cold iron 20, evil 20

---
**Speed** 40 feet, fly 40 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> sickle +39 [+35/+31] (agile, finesse, trip), **Damage** 3d4+16 slashing plus 4d6 cold and 1d6 good</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> vine +39 [+34/+29] (reach 20 feet), **Damage** 4d12+16 bludgeoning plus 1d6 good and [[DATABASE/monsterability/Improved Grab|Improved Grab]]</span>**Divine Innate Spells** DC 42, attack +32; **10th** _[[DATABASE/spell/Cataclysm|cataclysm]]_, _[[DATABASE/spell/Primal Phenomenon|primal phenomenon]]_ (once per year), _[[DATABASE/spell/Revival|revival]]_; **9th** _[[DATABASE/spell/Nature's Enmity|nature's enmity]]_, _[[DATABASE/spell/Regenerate|regenerate]]_ (×3), _[[DATABASE/spell/Storm of Vengeance|storm of vengeance]]_, _[[DATABASE/spell/Tree Stride|tree stride]]_ (at will); **8th** _[[DATABASE/spell/Polar Ray|polar ray]]_ (at will), _[[DATABASE/spell/Sunburst|sunburst]]_ (at will); **6th** _[[DATABASE/spell/Baleful Polymorph|baleful polymorph]]_ (at will), _[[DATABASE/spell/Tangling Creepers|tangling creepers]]_ (at will); **Constant** **(9th)** _[[DATABASE/spell/Endure Elements|endure elements]]_, _[[DATABASE/spell/Speak with Animals|speak with animals]]_, _[[DATABASE/spell/Speak with Plants|speak with plants]]_, _[[DATABASE/spell/Tongues|tongues]]_
**Rituals** DC 42; **6th** _[[DATABASE/ritual/Awaken Animal|awaken animal]]_, _[[DATABASE/ritual/Commune with Nature|commune with nature]]_, _[[DATABASE/ritual/Primal Call|primal call]]_; **4th** _[[DATABASE/ritual/Blight|blight]]_, _[[DATABASE/ritual/Plant Growth|plant growth]]_; **3rd** _[[DATABASE/ritual/Reincarnate|reincarnate]]_; **2nd** _[[DATABASE/ritual/Consecrate|consecrate]]_
<span class="in-box-ability">**Alter Weather** <span class="action-icon">3</span> **Frequency **three times per day; **Effect **The veranallia dramatically alters weather patterns in the surrounding area, producing any of the results of a successful 9th-level [[DATABASE/ritual/Control Weather|control weather]] ritual.</span><span class="in-box-ability">**Rebirth** (divine, necromancy) **Frequency **once per day; **Effect **The veranallia spends a minute to encase a creature that has been dead for no more than a year in a cocoon. After 24 hours, the creature is restored to life, and the cocoon explodes in a shower of colorful blossoms. If the veranallia chooses, Rebirth can change the creature's ancestry or heritage, typically into an aasimar.</span>

###  Primordial Veranallia

In the deepest reaches of [[DATABASE/plane/Elysium|Elysium]], the eldest of veranallias roam. These beings concern themselves with transformations that take place over the course of millennia, as well as changes in the climates of entire worlds. Primordial veranallias have an array of unique powers that can affect the area for many miles around them, from turning deserts into glass to triggering earthquakes.