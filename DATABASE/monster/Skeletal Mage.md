...
Rarely, the bones of a spellcaster can be used to create a skeleton that retains a limited ability to cast spells. These spells are almost always offensive in nature, and the skeletal mage uses them with reckless abandon. Skeletal mages are often misidentified as [[DATABASE/monsterfamily/Lich|liches]], and while not nearly as cunning or deadly, they still pose a significant threat to their foes.
**Recall Knowledge - Undead ([[DATABASE/skill/Religion|Religion]])**: DC 20
**Unspecific Lore**: DC 18
**Specific Lore**: DC 15

# Skeletal Mage<span class="item-type">Creature 5</span>
...
**Skills** [[DATABASE/skill/Arcana|Arcana]] +14, [[DATABASE/skill/Stealth|Stealth]] +13
**Str** +2, **Dex** +4, **Con** +0, **Int** -1, **Wis** +2, **Cha** +0

---
**AC** 21; **Fort** +9, **Ref** +11, **Will** +13
**HP** 60 ([[DATABASE/monsterability/Negative Healing|negative healing]]); **Immunities** death effects, disease, mental, [[DATABASE/condition/Paralyzed|paralyzed]], poison, [[DATABASE/condition/Unconscious|unconscious]]; **Resistances** cold 10, electricity 10, fire 10, piercing 5, slashing 5

---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> claw +11 [+7/+3] (agile, finesse), **Damage** 2d8+2 slashing</span>**Arcane Innate Spells** DC 22, attack +14; **3rd** _[[DATABASE/spell/Lightning Bolt|lightning bolt]]_, _[[DATABASE/spell/Magic Missile|magic missile]]_, _[[DATABASE/spell/Paralyze|paralyze]]_; **2nd** _[[DATABASE/spell/Acid Arrow|acid arrow]]_, _[[DATABASE/spell/Enlarge|enlarge]]_, _[[DATABASE/spell/Telekinetic Maneuver|telekinetic maneuver]]_; **1st** _[[DATABASE/spell/Burning Hands|burning hands]]_ (x2), _[[DATABASE/spell/Grease|grease]]_, _[[DATABASE/spell/Shocking Grasp|shocking grasp]]_; **Cantrips** **(3rd)** _[[DATABASE/spell/Produce Flame|produce flame]]_, _[[DATABASE/spell/Ray of Frost|ray of frost]]_