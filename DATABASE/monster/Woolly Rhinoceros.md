...
**HP** 100
<span class="in-box-ability">**Cold Adaptation** The woolly rhinoceros treats environmental cold effects as if they were one step less extreme.</span><span class="in-box-ability">**[[Ferocity]] <span class="action-icon">5</span> ** </span>

---
**Speed** 35 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> horn +16 [+11/+6] (reach 10 feet), **Damage** 2d12+6 piercing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> foot +16 [+11/+6], **Damage** 2d8+6 bludgeoning</span><span class="in-box-ability">**Rhinoceros Charge** <span class="action-icon">2</span> The woolly rhinoceros Strides twice, then makes a horn Strike. As long as the woolly rhinoceros moved at least 20 feet, the Strike's damage increases to 3d12+6. A Medium or smaller creature struck by this attack must succeed at a DC 24 Reflex save or be automatically [[Shove]] back 5 feet and knocked [[Prone]] by the force of the blow.</span><span class="in-box-ability">**[[Trample]]** <span class="action-icon">3</span> Medium or smaller, foot, DC 21</span>