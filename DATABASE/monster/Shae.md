...
Shae are wispy, tenebrous creatures native to the [[Shadow Plane]]. Their amorphous bodies appear in constant states of flux. They cast no shadows of their own, instead gaining and losing umbral energy to nearby shadows that shrink and grow alongside them.
...
<span class="in-box-ability">**Counterattack <span class="action-icon">5</span> ** **Trigger** The shae is targeted by an attack from an adjacent creature that misses due to the shae being [[Concealed]]; **Requirements** The shae is aware of the attack; **Effect** The shae makes a Strike against the attacker.</span><span class="in-box-ability">**Slip <span class="action-icon">5</span> ** **Trigger** A creature moves adjacent to the shae; **Effect** The shae teleports to a clear space adjacent to another creature they can see within 30 feet.</span>

---
**Speed** 25 feet, fly 35 feet; swift steps, tenebral form
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> dagger +13 [+9/+5] (agile, finesse, versatile S), **Damage** 1d4+5 piercing and 1d6 cold</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> dagger +13 [+9/+5] (agile, thrown 10 feet, versatile S), **Damage** 1d4+5 piercing and 1d6 cold</span>**Occult Innate Spells** DC 21; **7th** _[[Plane Shift]]_ (self only; to [[Shadow Plane]] or [[Material Plane]] only); **4th** _[[Gaseous Form]]_ (at will); **Cantrips** **(2nd)** _[[Chill Touch]]_, _[[Detect Magic]]_
...
Though rare, shae occasionally engage in relationships with mortals, resulting in children born as [[Fetchling]]. Though shae maintain a cool superiority over their mortal children, fetchlings who join a shae's cult are placed in positions of authority over other mortals and receive blatantly preferential treatment.