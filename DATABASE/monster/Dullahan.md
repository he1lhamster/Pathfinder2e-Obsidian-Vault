...
**Skills** [[DATABASE/skill/Athletics|Athletics]] +15, [[DATABASE/skill/Intimidation|Intimidation]] +17, [[DATABASE/skill/Stealth|Stealth]] +13, [[DATABASE/skill/Survival|Survival]] +15
**Str** +6, **Dex** +2, **Con** +2, **Int** +2, **Wis** +3, **Cha** +4
**Items** [[DATABASE/weapon/Hatchet|+1 hatchet]], [[DATABASE/weapon/Longsword|+1 longsword]], [[DATABASE/armor/Full Plate|full plate]]

---
**AC** 28; **Fort** +13, **Ref** +15, **Will** +17
**HP** 95 ([[DATABASE/monsterability/Fast Healing|fast healing]] 5); **Immunities** fear, death effects, disease, poison, paralyzed, unconscious; **Weaknesses** good 5
...
---
**Speed** 20 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> _keen longsword_ +18 [+13/+8] (magical, versatile P), **Damage** 1d8+10 slashing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> _keen returning hatchet_ +17 [+13/+9] (agile, sweep), **Damage** 1d6+10 slashing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> fist +18 [+14/+10] (agile, nonlethal), **Damage** 1d4+10 bludgeoning</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> _keen returning hatchet_ +14 [+10/+6] (agile, thrown 10 feet), **Damage** 2d8+10 slashing</span><span class="in-box-ability">**Head Hunter** Any slashing weapon a dullahan wields becomes [[DATABASE/equipment/Keen|keen]], and any hatchet it wields becomes [[DATABASE/equipment/Returning|returning]]. If the dullahan kills a creature with a critical hit using a slashing weapon, the target is decapitated as though the dullahan had used Reap on the target. These effects remain only while the dullahan holds the weapon.</span><span class="in-box-ability">**Reap** <span class="action-icon">2</span> The dullahan removes the head of a dead creature within reach. Each creature within the area of the dullahan’s frightful presence must attempt a new save, even if they are temporarily immune.</span><span class="in-box-ability">**Summon Steed** <span class="action-icon">2</span> (occult, conjuration) The dullahan summons a [[DATABASE/monster/War Horse|warhorse]] with elite adjustments and the fiend trait. This steed remains until it is slain, the dullahan Dismisses it, or the dullahan summons another steed.</span>
