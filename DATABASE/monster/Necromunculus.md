...
**Languages** [[DATABASE/language/Necril|Necril]]; (can't speak any language), undead master link
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +4, [[DATABASE/skill/Stealth|Stealth]] +6
...
**HP** 20; **Immunities** death effects, disease, [[DATABASE/condition/Paralyzed|paralyzed]], poison, [[DATABASE/condition/Unconscious|unconscious]]

---
**Speed** 15 feet, fly 40 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> claw +7 [+3/-1] (agile, finesse, magical), **Damage** 1d4 slashing plus stupefying touch</span><span class="in-box-ability">**Stupefying Touch** A creature damaged by a necromunculus's claw Strike must succeed at a DC 15 Will saving throw or become [[DATABASE/condition/Stupefied|stupefied 1]] for 1 round.</span>
