...
**Languages** [[Abyssal]]
**Skills** [[Crafting]] +4 (+6 when using bone), [[Stealth]] +7
**Str** +0, **Dex** +4, **Con** +3, **Int** -4, **Wis** +1, **Cha** +0

---
**AC** 15; **Fort** +6, **Ref** +9, **Will** +4
**HP** 30; **Immunities** bleed, death effects, disease, [[Doomed]], [[Drained]], [[Fatigued]], good damage, healing, lawful damage, mental, necromancy, nonlethal attacks, [[Paralyzed]], poisoned, [[Sickened]], [[Unconscious]]
...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> mandibles +9 [+4/-1] (finesse), **Damage** 1d4 piercing plus 1d4 acid</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> bone spike +9 [+4/-1] (finesse), **Damage** 1d12 piercing plus 1d4 [[Persistent Damage]]</span>
