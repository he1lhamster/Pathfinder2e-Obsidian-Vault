...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +20, [[DATABASE/skill/Athletics|Athletics]] +22, [[DATABASE/skill/Stealth|Stealth]] +18
**Str** +7, **Dex** +5, **Con** +7, **Int** -5, **Wis** +0, **Cha** -5

---
**AC** 31; **Fort** +20, **Ref** +20, **Will** +17
**HP** 195; **Immunities** bleed, death effects, disease, [[DATABASE/condition/Doomed|doomed]], [[DATABASE/condition/Drained|drained]], [[DATABASE/condition/Fatigued|fatigued]], healing, magic (see Golem Antimagic below), mental, necromancy, nonlethal attacks, [[DATABASE/condition/Paralyzed|paralyzed]], poison, [[DATABASE/condition/Sickened|sickened]], [[DATABASE/condition/Unconscious|unconscious]]; **Resistances** physical 10 (except [[DATABASE/equipment/Adamantine|adamantine]] or bludgeoning)
<span class="in-box-ability">**Golem Antimagic** harmed by sonic (8d6, 2d6 from areas or persistent magic); healed by fire (2d6 HP); slowed by cold</span><span class="in-box-ability">**Vulnerable to Shatter** A glass golem is affected by the [[DATABASE/spell/Shatter|shatter]] spell as though the golem were an unattended object.</span><span class="in-box-ability">**Spell Reflection <span class="action-icon">5</span> ** (abjuration, arcane) **Trigger** The glass golem is targeted by a spell; **Effect** The glass golem positions its magical, reflective surfaces to turn the spell back on the caster. It tries to counteract the spell by attempting an [[DATABASE/skill/Acrobatics|Acrobatics]] check for its counteract check. If it successfully counteracts the spell, the effect is turned back on the caster.</span>
...
**Failure** The creature takes full damage and is [[DATABASE/condition/Dazzled|dazzled]] for 1 minute. 
**Critical Failure** The creature takes full damage and is [[DATABASE/condition/Blinded|blinded]] permanently.</span>