...
# Grippli Skirmisher<span class="item-type">Creature 4</span>
...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +12, [[DATABASE/skill/Athletics|Athletics]] +10, [[DATABASE/skill/Stealth|Stealth]] +12, [[DATABASE/skill/Survival|Survival]] +11, [[DATABASE/skill/Thievery|Thievery]] +10
...
**Items** [[DATABASE/weapon/Composite Shortbow|composite shortbow (30 arrows)]], [[DATABASE/weapon/Kukri|kukri]], [[DATABASE/armor/Leather Armor|leather armor]], [[DATABASE/equipment/Thieves' Tools|thieves' tools]]

---
**AC** 22; **Fort** +11, **Ref** +14, **Will** +9
**HP** 60
<span class="in-box-ability">**Hopping Dodge <span class="action-icon">5</span> ** **Trigger** A creature misses the skirmisher with a melee Strike; **Effect** The skirmisher quickly takes advantage of the attacker's error and Steps.</span>

---
**Speed** 25 feet, climb 20 feet; jungle stride
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> kukri +14 [+10/+6] (agile, finesse, trip), **Damage** 1d6+4 slashing plus baneback poison</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> composite shortbow +14 [+9/+4] (deadly d10, propulsive, range increment 60 feet, reload 0), **Damage** 1d6+3 piercing plus baneback poison</span><span class="in-box-ability">**Baneback Poison** (poison) **Saving Throw** Fortitude DC 21; **Maximum Duration** 6 rounds; **Stage 1** 1d4 poison damage and [[DATABASE/condition/Stupefied|stupefied 1]] (1 round); **Stage 2** 2d4 poison damage and stupefied 2 (1 round); **Stage 3** 2d4 poison damage, stupefied 3, and [[DATABASE/condition/Flat-Footed|flat-footed]] (1 round)</span><span class="in-box-ability">**Jungle Stride** Gripplis ignore difficult terrain in forests and jungles.</span><span class="in-box-ability">**Wily Attack** The skirmisher deals an extra 1d6 precision damage to [[DATABASE/condition/Flat-Footed|flat-footed]] creatures and creatures afflicted by a poison.</span>