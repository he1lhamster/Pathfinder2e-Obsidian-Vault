...
**Perception** +8
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +9, [[DATABASE/skill/Intimidation|Intimidation]] +7, [[DATABASE/skill/Survival|Survival]] +7
 ...
 **Critical Failure** The creature is [[DATABASE/condition/Confused|confused]] for 1d4 rounds.</span><span class="in-box-ability">**Tail Lash** <span class="action-icon">2</span> The emperor bird makes tail Strikes against two different creatures within reach. The emperor bird’s multiple attack penalty does not increase until it has finished both attacks.</span>
