...
# Hippocampus<span class="item-type">Creature 1</span>
...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> tail +7 [+2/-3] (reach 10 feet), **Damage** 1d6+4 bludgeoning</span><span class="in-box-ability">**Sudden Retreat** <span class="action-icon">2</span> The hippocampus makes a tail Strike, then [[DATABASE/action/Swim|Swims]] with a +10-foot circumstance bonus to its swim Speed. It gains a +2 circumstance bonus to AC against reactions triggered by this movement.</span>