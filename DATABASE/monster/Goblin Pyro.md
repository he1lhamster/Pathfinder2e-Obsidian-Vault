...
- '[[DATABASE/skill/Lore|FireLore]] +7'
...
**HP** 15
<span class="in-box-ability">**Goblin Scuttle** <span class="action-icon">5</span> **Trigger** A goblin ally ends a move action adjacent to the pyro. **Effect** The goblin pyro Steps.</span>
