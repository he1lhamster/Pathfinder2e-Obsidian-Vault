...
# Vrykolakas Spawn<span class="item-type">Creature 6</span>
...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +14, [[DATABASE/skill/Athletics|Athletics]] +15, [[DATABASE/skill/Stealth|Stealth]] +14, [[DATABASE/skill/Survival|Survival]] +11
**Str** +5, **Dex** +4, **Con** +2, **Int** -3, **Wis** +2, **Cha** +2

---
**AC** 24; **Fort** +14, **Ref** +16, **Will** +12
**HP** 99 ([[DATABASE/monsterability/Negative Healing|negative healing]]); **Immunities** death effects, disease, [[DATABASE/condition/Paralyzed|paralyze]], poison, sleep
<span class="in-box-ability">**Vrykolakas Vulnerabilities**Vrykolakas all have the following vulnerabilities.
