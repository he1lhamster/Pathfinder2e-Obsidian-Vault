...
**HP** 135; **Immunities** [[DATABASE/condition/Petrified|petrification]]
...
**Success** The creature's body hardens and stiffens, causing it to become [[DATABASE/condition/Slowed|slowed 1]] for 1 round. 
**Failure** The creature becomes [[DATABASE/condition/Petrified|petrified]] for 1 minute. It can attempt a new save at the end of each of its turns. 
**Critical Failure** The creature becomes petrified permanently.</span><span class="in-box-ability">**Powerful Charge** <span class="action-icon">2</span> The gorgon Strides twice, then makes a horn Strike. If it moved at least 20 feet from its starting position, the Strike's damage is increased to 3d12+12.</span><span class="in-box-ability">**[[DATABASE/monsterability/Trample|Trample]]** <span class="action-icon">3</span> Medium or smaller, hoof, DC 26</span>
