...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> claw +14 [+9/+4], **Damage** 2d8+5 piercing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> thrown scrap +13 [+8/+3], **Damage** 2d8+2 bludgeoning</span><span class="in-box-ability">**Rebuild Armor** <span class="action-icon">1</span> **Requirements** The scrapborn's previous action was a successful claw Strike against a target wearing armor and that armor is not [[Broken]]; **Effect** The scrapborn pulls and rips at the target's armor. The target must attempt a DC 20 Reflex save.
