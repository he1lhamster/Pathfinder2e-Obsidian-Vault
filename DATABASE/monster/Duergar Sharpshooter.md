...
# Duergar Sharpshooter<span class="item-type">Creature 0</span>
...
**Skills** [[DATABASE/skill/Athletics|Athletics]] +3, [[DATABASE/skill/Stealth|Stealth]] +5
**Str** +1, **Dex** +3, **Con** +3, **Int** +0, **Wis** +2, **Cha** -2
**Items** [[DATABASE/armor/Chain Shirt|chain shirt]], [[DATABASE/weapon/Crossbow|crossbow (3 bola bolts and 10 bolts)]], [[DATABASE/weapon/Light Mace|light mace]]
...
---
**Speed** 20 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> light mace +5 [+1/-3] (agile, finesse, shove), **Damage** 1d4+1 bludgeoning</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> crossbow +7 [+2/-3] (range increment 120 feet, reload 1), **Damage** 1d8 piercing or bola bolt</span>**Occult Innate Spells** DC 12; **2nd** _[[DATABASE/spell/Enlarge|enlarge]]_ (self only), _[[DATABASE/spell/Invisibility|invisibility]]_ (self only)
<span class="in-box-ability">**Bola Bolt** This shot deals no damage, but on a hit, the target must succeed at a DC 16 Reflex save or be knocked [[DATABASE/condition/Prone|prone]] and [[DATABASE/condition/Immobilized|immobilized]] until it is freed with a successful DC 15 check to [[DATABASE/action/Escape|Escape]]. This check can be attempted either by the target or a creature adjacent to the target.
</span>