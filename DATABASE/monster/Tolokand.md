...
**Source** [[DATABASE/source/Bestiary 3|Bestiary 3]]
**Perception** +27; [[DATABASE/monsterability/Darkvision|darkvision]], smoke vision
**Languages** no voice; [[DATABASE/spell/Tongues|tongues]]
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +25, [[DATABASE/skill/Athletics|Athletics]] +29, [[DATABASE/skill/Intimidation|Intimidation]] +22, [[DATABASE/skill/Survival|Survival]] +31
**Str** +8, **Dex** +6, **Con** +7, **Int** +5, **Wis** +6, **Cha** -3
**Smoke Vision** Smoke doesn't impair a tolokand's vision; it ignores the [[DATABASE/condition/Concealed|concealed]] condition from smoke.

---
**AC** 36; **Fort** +30, **Ref** +25, **Will** +25; +2 status to all saves vs. primal magic
**HP** 245; **Immunities** disease, [[DATABASE/condition/Immobilized|immobilized]], poison; **Resistances** acid 15, negative 15
<span class="in-box-ability">**Heartless Furnace** (aura, conjuration, occult) 50 feet, 2d6 poison damage (DC 34 basic Fortitude save). The poisonous smoke that bellows from a tolokand makes all creatures inside it [[DATABASE/condition/Concealed|concealed]], and all creatures outside the smoke are concealed to creatures within it.</span><span class="in-box-ability">**Inexorable** The tolokand recovers from the [[DATABASE/condition/Paralyzed|paralyzed]], [[DATABASE/condition/Slowed|slowed]], and [[DATABASE/condition/Stunned|stunned]] conditions at the end of its turn. It's also immune to penalties to its Speeds and ignores difficult terrain and greater difficult terrain.</span><span class="in-box-ability">**Toxic Blood** When a creature scores a critical hit against the tolokand with a piercing or slashing Strike, the tolokand's poisonous, oily blood sprays forth. Any creature within 5 feet of the tolokand takes 3d6 poison damage (DC 34 basic Reflex save). Any non-creature plants the blood spills on die.</span>

---
**Speed** 120 feet; [[DATABASE/spell/Air Walk|air walk]]
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> hand +31 [+26/+21] (reach 10 feet), **Damage** 2d12+16 slashing plus 2d6 persistent poison</span>**Occult Spontaneous Spells** DC 37; **8th** _[[DATABASE/spell/Cloudkill|cloudkill]]_, _[[DATABASE/spell/Earthquake|earthquake]]_, _[[DATABASE/spell/Horrid Wilting|horrid wilting]]_, _[[DATABASE/spell/Volcanic Eruption|volcanic eruption]]_ (3 slots)
**Occult Innate Spells** DC 37; **4th** _[[DATABASE/spell/Earthbind|earthbind]]_ (at will), _[[DATABASE/spell/Haste|haste]]_ (at will; self only); **2nd** _[[DATABASE/spell/Sudden Blight|sudden blight]]_ (at will); **Constant** **(5th)** _[[DATABASE/spell/Air Walk|air walk]]_, _[[DATABASE/spell/Endure Elements|endure elements]]_, _[[DATABASE/spell/Tongues|tongues]]_
