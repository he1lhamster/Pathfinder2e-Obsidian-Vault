...
**Items** [[Alchemist's Tools]], [[Acid Flask]], [[Alchemist's Fire]], infused reagents (2), [[Studded Leather Armor]], [[Warhammer]]
...
---
**Speed** 20 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> warhammer +4 [-1/-6] (shove), **Damage** 1d8+1 bludgeoning</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> bomb +8 [+3/-2] (range increment 30 feet, splash), **Effect** varies by bomb</span>**Occult Innate Spells** DC 17; **2nd** _[[Enlarge]]_ (self only), _[[Invisibility]]_ (self only)
<span class="in-box-ability">**Alchemical Formulas** **(1st)** [[Acid Flask]], [[Alchemist's Fire]], [[Tanglefoot Bag]]</span><span class="in-box-ability">**Far Lobber** The duergar bombardier has a range increment of 30 feet with their bombs instead of 20 feet.
