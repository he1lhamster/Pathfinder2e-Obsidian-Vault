...
**HP** 50 ([[Negative Healing]]); **Immunities** death effects, disease, paralyze, poison, unconscious
...
---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> claw +12 [+7/+2], **Damage** 1d6+4 slashing plus drain life</span><span class="in-box-ability">**Drain Life** (divine, necromancy) When the wight damages a living creature with its claw Strike, the wight gains 3 temporary Hit Points and the creature must succeed at a DC 17 Fortitude save or become [[Drained]]. Further damage dealt by the wraith increases the amount of drain by 1 on a failed save to a maximum of [[Drained]]</span><span class="in-box-ability">**Wight Spawn** (divine, necromancy) A living humanoid slain by a wight’s claw Strike rises as a wight after 1d4 rounds. This wight spawn is under the command of the wight that killed it. It doesn’t have Drain Life or Wight Spawn and becomes [[Clumsy]] for as long as it is a wight spawn. If the creator of the wight spawn dies, the wight spawn becomes a full-fledged, autonomous wight; it regains its free will, gains Drain Life and Wight Spawn, and is no longer [[Clumsy]].</span>
