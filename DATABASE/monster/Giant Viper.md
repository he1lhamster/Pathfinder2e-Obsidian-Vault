...
**HP** 26
<span class="in-box-ability">**Coiled Opportunity** <span class="action-icon">5</span> As Attack of Opportunity, but the snake can use this reaction only if it’s Coiled.</span>

---
**Speed** 20 feet, climb 20 feet, swim 20 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> fangs +11 [+6/+1] (finesse), **Damage** 1d8+3 piercing plus giant viper venom</span><span class="in-box-ability">**Coil** <span class="action-icon">1</span> The giant viper uses an action to coil itself, increasing its reach with its fangs from 5 to 10 feet. After the giant viper Strikes with its fangs, it becomes uncoiled.</span><span class="in-box-ability">**Giant Viper Venom** (poison) **Saving Throw** DC 17 Fortitude; **Maximum Duration** 6 rounds; **Stage 1** 1d6 poison (1 round); **Stage 2** 1d6 poison and drained 1.</span>