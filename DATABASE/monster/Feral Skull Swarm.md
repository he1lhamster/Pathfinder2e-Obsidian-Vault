...
**HP** 160 ([[Negative Healing]]); **Immunities** death effects, disease, mental, [[Paralyzed]], poison, precision, [[Unconscious]]; **Resistances** bludgeoning 5, cold 10, electricity 10, fire 10, piercing 10, slashing 10; **Weaknesses** area damage 10, splash damage 10
...
---
**Speed** 40 feet
<span class="in-box-ability">**Feral Gnaw** <span class="action-icon">1</span> Each enemy in the swarm's space takes 2d6 bludgeoning, 2d6 piercing, and 2d6 slashing damage (DC 32 basic Reflex save). A creature that fails its saving throw also takes 1d10 [[Persistent Damage]]</span><span class="in-box-ability">**Frightening Howl** <span class="action-icon">1</span> (auditory, emotion, enchantment, fear, mental) The feral skull swarm emits a terrifying howl. Each creature within 60 feet must succeed at a DC 32 Will save or become [[Frightened]] (frightened 3 and [[Fleeing]] for 1 round on a critical failure). Whether it succeeds or fails its save, a creature is temporarily immune to Frightening Howl for 24 hours.</span>