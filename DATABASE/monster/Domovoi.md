...
**Source** [[DATABASE/source/Bestiary 3|Bestiary 3]]
**Perception** +11; [[DATABASE/monsterability/Tremorsense|tremorsense]] (imprecise) within their entire bound home
**Languages** [[DATABASE/language/Common|Common]], [[DATABASE/language/Sylvan|Sylvan]]
**Skills** [[DATABASE/skill/Crafting|Crafting]] +9, [[DATABASE/skill/Lore|Household Lore]] +11, [[DATABASE/skill/Stealth|Stealth]] +7 (+9 within their bound home)
**Str** +1, **Dex** +3, **Con** +1, **Int** +3, **Wis** +5, **Cha** +1
**Master of the Home** A home with a friendly domovoi is blessed, as the domovoi cooks, cleans, fetches water, and does a hundred other small tasks. A home so blessed never suffers from random accidents such as fires, and any checks to [[DATABASE/action/Craft|Craft]], [[DATABASE/action/Earn Income|Earn Income]], [[DATABASE/action/Repair|Repair]], or [[DATABASE/action/Subsist|Subsist]] in the home receive a +2 circumstance bonus. If the domovoi is unfriendly, such checks take a –2 circumstance penalty instead, as the domovoi hides things, makes noise when people try to sleep, tangles weaving, and otherwise makes life a misery. A domovoi must spend a week in a place before these benefits occur.

---
**AC** 17; **Fort** +5, **Ref** +9, **Will** +11
**HP** 35; **Weaknesses** [[DATABASE/equipment/Cold Iron Weapon|cold iron]] 4
<span class="in-box-ability">**Shy** A domovoi is naturally [[DATABASE/condition/Invisible|invisible]] while within sight of their bound home. The domovoi can become visible, or even selectively visible—allowing some people to see them</span>

---
**Speed** 20 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> broom +7 [+2/-3], **Damage** 1d4+3 bludgeoning</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> enraged home +9 [+4/-1] (evocation, primal, range increment 30 feet), **Damage** 1d8+4 bludgeoning, piercing, or slashing (depending on object)</span>**Primal Innate Spells** DC 18; **1st** _[[DATABASE/spell/Mending|mending]]_ (at will); **Cantrips** **(1st)** _[[DATABASE/spell/Mage Hand|mage hand]]_, _[[DATABASE/spell/Prestidigitation|prestidigitation]]_, _[[DATABASE/spell/Telekinetic Projectile|telekinetic projectile]]_
<span class="in-box-ability">**Home Guardian** By commanding their home to attack, the domovoi can [[DATABASE/action/Grapple|Grapple]], [[DATABASE/action/Shove|Shove]], [[DATABASE/action/Trip|Trip]], and [[DATABASE/action/Disarm|Disarm]] with their enraged home Strike. The domovoi uses their [[DATABASE/skill/Lore|Household Lore]] instead of [[DATABASE/skill/Athletics|Athletics]] skill for these checks.</span>