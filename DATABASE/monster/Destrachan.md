...
**Languages** [[DATABASE/language/Destrachan|Destrachan]], [[DATABASE/language/Undercommon|Undercommon]]; can speak only Destrachan
**Skills** [[DATABASE/skill/Athletics|Athletics]] +18, [[DATABASE/skill/Stealth|Stealth]] +15, [[DATABASE/skill/Survival|Survival]] +18
...
**HP** 135; **Immunities** [[DATABASE/condition/Blinded|blinded]], visual; **Resistances** sonic 15
...
**Success **The creature is [[DATABASE/condition/Sickened|sickened 1]] for 1 round. 
**Failure **The creature is [[DATABASE/condition/Deafened|deafened]] for 3 rounds and [[DATABASE/condition/Stunned|stunned 2]]. 
...
The [[DATABASE/language/Destrachan|Destrachan]] language can be learned by other creatures, but without a destrachan's unique vocal organs, non-destrachans can convey only basic notions and concepts with it. In most cases, it's better to speak [[DATABASE/language/Undercommon|Undercommon]] to a destrachan than attempt to use its own language.