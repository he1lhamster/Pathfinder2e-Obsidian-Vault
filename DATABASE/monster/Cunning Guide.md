...
---
**Speed** 40 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> horn +6 [+1/-4] (finesse, magical), **Damage** 1d8+1 force</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +6 [+2/-2] (agile, finesse, magical), **Damage** 1d4+1 force</span>**Primal Innate Spells** DC 17; **3rd** _[[Wanderer's Guide]]_; **1st** _[[Detect Poison]]_, _[[Purify Food and Drink]]_; **Cantrips** **(1st)** _[[Guidance]]_, _[[Read Aura]]_, _[[Stabilize]]_; **Constant** **(5th)** _[[Tongues]]_
