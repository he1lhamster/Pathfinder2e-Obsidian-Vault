...
# Hooklimb Xulgath<span class="item-type">Creature 10</span>

<span class="trait-rare item-trait">Rare</span><span class="trait-alignment item-trait">NE</span><span class="trait-size item-trait">Medium</span><span class="item-trait">Humanoid</span><span class="item-trait">Xulgath</span>
...
**Skills** [[DATABASE/skill/Acrobatics|Acrobatics]] +25, [[DATABASE/skill/Athletics|Athletics]] +21, [[DATABASE/skill/Intimidation|Intimidation]] +16, [[DATABASE/skill/Stealth|Stealth]] +19, [[DATABASE/skill/Survival|Survival]] +16
**Str** +7, **Dex** +5, **Con** +3, **Int** +0, **Wis** +2, **Cha** +0

---
**AC** 29; **Fort** +21, **Ref** +21, **Will** +16
**HP** 190
...
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +22 [+17/+12], **Damage** 1d6+13 piercing</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> claw +22 [+18/+14] (agile), **Damage** 2d8+13 slashing</span><span class="in-box-ability">**Quick Catch** The hooklimb always critically succeeds at checks to [[DATABASE/monsterability/Grab|Grab a Ledge]].</span><span class="in-box-ability">**Raking Claws** <span class="action-icon">1</span> The hooklimb flexes hooklike barbs on its claws. Until the start of the hooklimb's next turn, its claws Strikes deal an additional 1d10 [[DATABASE/condition/Persistent Damage|persistent bleed damage]].</span><span class="in-box-ability">**[[DATABASE/monsterability/Rend|Rend]]** <span class="action-icon">1</span> claw</span>