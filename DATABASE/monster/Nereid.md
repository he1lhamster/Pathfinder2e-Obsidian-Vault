...
<span class="in-box-ability">**Watery Transparency** (primal, transmutation, water) When underwater, the nereid's body is [[Invisible]]. The nereid can dismiss or resume this transparency as an action that has the concentrate trait.</span>

---
**Speed** 25 feet, swim 50 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> poisonous touch +23 [+19/+15] (agile, finesse, magical), **Damage** 6d6 poison</span>**Primal Innate Spells** DC 29; **6th** _[[Summon Elemental]]_ ([[Elemental, Water]] only); **5th** _[[Control Water]]_, _[[Elemental Form]]_ (×3; water only); **4th** _[[Suggestion]]_
...
**Failure** The creature becomes [[Sickened]] as it chokes on the water. 
