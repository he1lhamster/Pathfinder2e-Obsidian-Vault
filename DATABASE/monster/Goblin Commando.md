...
**HP** 18
<span class="in-box-ability">**Goblin Scuttle** <span class="action-icon">5</span> **Trigger** A goblin ally ends a move action adjacent to the commando. **Effect** The goblin commando Steps.</span>

---
**Speed** 25 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> horsechopper +8 [+3/-2] (reach 10 feet, trip, versatile P), **Damage** 1d8+3 slashing</span><span class="in-box-ability">**Ranged** <span class="action-icon">1</span> shortbow +8 [+3/-2] (deadly 1d10, range increment 60 feet, reload 0), **Damage** 1d6 piercing</span>