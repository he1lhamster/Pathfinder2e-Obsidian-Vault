...
Spawned by acts and legacies of cold-blooded spite, hatred siktemporas kill indiscriminately out of pure loathing, methodically hunting down and slaughtering anyone who catches their vile attention. Fortunately for mortals, they typically limit their predations to the [[DATABASE/plane/Dimension of Time|Dimension of Time]], where they hunt down creatures foreign to that realm—and some native to it.
...
**Languages** [[DATABASE/language/Aklo|Aklo]]; (can't speak any language), [[DATABASE/monsterability/Telepathy|telepathy]] 500 feet
**Skills** [[DATABASE/skill/Athletics|Athletics]] +35, [[DATABASE/skill/Deception|Deception]] +32, [[DATABASE/skill/Lore|Dimension of Time Lore]] +32, [[DATABASE/skill/Intimidation|Intimidation]] +32, [[DATABASE/skill/Stealth|Stealth]] +32
...
**HP** 240, regeneration 50 (deactivated by good, mental, or [[DATABASE/equipment/Orichalcum Weapon|orichalcum]]); **Immunities** disease, emotion, poison
<span class="in-box-ability">**Impending Dread** (aura, emotion, fear, mental, occult) 150 feet. Creatures within the hatred siktempora's aura don't reduce the value of their [[DATABASE/condition/Frightened|frightened]] condition automatically at the end of their turns.</span><span class="in-box-ability">**Uncanny Pounce <span class="action-icon">4</span> ** **Trigger** The hatred siktempora rolls Dimension of Time Lore for initiative; **Effect** The hatred siktempora Strides once and makes a claw Strike, in either order.</span><span class="in-box-ability">**Punish Flight <span class="action-icon">5</span> ** **Trigger** A creature attempts to [[DATABASE/action/Escape|Escape]] from the hatred siktempora; **Effect** The siktempora makes a loathing garotte Strike against the triggering creature. This Strike doesn't have [[DATABASE/monsterability/Improved Grab|Improved Grab]].</span>

---
**Speed** 80 feet; [[DATABASE/spell/Air Walk|air walk]]
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> loathing garotte +35 [+30/+25] (cold, reach 10 feet), **Damage** 3d10+17 cold plus [[DATABASE/monsterability/Improved Grab|Improved Grab]]</span>**Occult Innate Spells** DC 40; **9th** _[[DATABASE/spell/Blink|blink]]_; **4th** _[[DATABASE/spell/Dimension Door|dimension door]]_ (at will); **Constant** **(9th)** _[[DATABASE/spell/Air Walk|air walk]]_
<span class="in-box-ability">**Contorted Clutch** The hatred siktempora can have up to two creatures [[DATABASE/condition/Grabbed|grabbed]] with their loathing garotte at once.</span><span class="in-box-ability">**Vindictive Crush** <span class="action-icon">1</span> **Frequency** once per round; **Requirements** The hatred siktempora has a creature [[DATABASE/condition/Grabbed|grabbed]]; **Effect** The hatred siktempora tightens their garrote, dealing 5d10 bludgeoning damage to each creature they're Grabbing. Each creature grabbed by the siktempora must attempt a DC 40 Fortitude save. 
...
**Critical Failure** As failure, but double damage and the creature becomes [[DATABASE/condition/Restrained|restrained]] and can't speak for 1 round after it's no longer grabbed.</span>