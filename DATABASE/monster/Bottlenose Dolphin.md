...
# Bottlenose Dolphin<span class="item-type">Creature 0</span>
...
**Deep Breath** A bottlenose dolphin can hold its breath for 2 hours.
...
---
**Speed** swim 60 feet
<span class="in-box-ability">**Melee** <span class="action-icon">1</span> snout +6 [+1/-4], **Damage** 1d6+2 bludgeoning</span><span class="in-box-ability">**Melee** <span class="action-icon">1</span> jaws +6 [+1/-4], **Damage** 1d6+2 piercing</span><span class="in-box-ability">**Ramming Speed** <span class="action-icon">2</span> The bottlenose dolphin [[DATABASE/action/Swim|Swims]] twice and then makes a snout Strike. As long as it moved at least 20 feet, it gains a +1 circumstance bonus to its attack roll. A Large or smaller creature hit by this attack must succeed at a DC 16 Fortitude save or be [[DATABASE/condition/Slowed|slowed 1]] for 1 round.</span>