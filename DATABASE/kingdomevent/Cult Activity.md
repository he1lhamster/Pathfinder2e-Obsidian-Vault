...
**Special** If this event occurs in a settlement with a Sewer System, you take a –2 item penalty to Intrigue checks to discover the cult's hideout. If this event occurs while the PCs are playing through Chapter 5, increase the event's level modifier to +3. The cult in this case is always associated with the worship of [[DATABASE/deity/Lamashtu|Lamashtu]].