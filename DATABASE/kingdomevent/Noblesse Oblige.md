...
---
# Noblesse Oblige<span class="item-type">Event +0</span>
...
**Kingdom Skill** [[DATABASE/skill/Arts|Arts]]; **Leader** Viceroy
**Critical Success** The nobles build a monument and a park in lots of the players' choice at no expense to the kingdom (the [[DATABASE/action/Build Structure|Build Structure]] activity is not required).
