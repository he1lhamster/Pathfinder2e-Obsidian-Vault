...
## [[Power Attack]] <span class="action-icon">2</span> <span class="item-type">Feat 4*</span>

<span class="item-trait">Fighter</span><span class="item-trait">Flourish</span>
**Source** [[Core Rulebook]] 
**Archetype** [[Mauler]]
* This version of the Power Attack feat is intended for use with an Archetype and has a different level for access than the [[Power Attack]].
...
## [[Clear the Way]] <span class="action-icon">2</span> <span class="item-type">Feat 6</span>
...
## [[Shoving Sweep]] <span class="action-icon">5</span> <span class="item-type">Feat 8</span>
...
## [[Improved Knockdown]] <span class="item-type">Feat 12*</span>

<span class="item-trait">Fighter</span>
**Source** [[Core Rulebook]] 
**Archetype** [[Mauler]]
**Prerequisites** [[Knockdown]]
* This version of the Improved Knockdown feat is intended for use with an Archetype and has a different level for access than the [[Improved Knockdown]].
...
## [[Brutal Finish]] <span class="action-icon">1</span> <span class="item-type">Feat 14*</span>
...
* This version of the Brutal Finish feat is intended for use with an Archetype and has a different level for access than the [[Brutal Finish]].
...
## [[Unbalancing Sweep]] <span class="action-icon">3</span> <span class="item-type">Feat 14*</span>

<span class="item-trait">Barbarian</span><span class="item-trait">Flourish</span><span class="item-trait">Open</span>
**Source** [[Advanced Player's Guide]] 
**Archetype** [[Mauler]]
* This version of the Unbalancing Sweep feat is intended for use with an Archetype and has a different level for access than the [[Unbalancing Sweep]].
