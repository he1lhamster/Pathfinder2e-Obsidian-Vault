...
## [[DATABASE/feat/Mauler Dedication|Mauler Dedication]] <span class="item-type">Feat 2</span>
...
## [[DATABASE/feat/Knockdown|Knockdown]] <span class="action-icon">2</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Power Attack|Power Attack]] <span class="action-icon">2</span> <span class="item-type">Feat 4*</span>

<span class="item-trait">Fighter</span><span class="item-trait">Flourish</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Archetype** [[DATABASE/archetype/Mauler|Mauler]]
* This version of the Power Attack feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Power Attack|original feat]].
...
## [[DATABASE/feat/Clear the Way|Clear the Way]] <span class="action-icon">2</span> <span class="item-type">Feat 6</span>
...
---
You put your body behind your massive weapon and swing, shoving enemies to clear a wide path. You attempt to [[DATABASE/action/Shove|Shove]] up to five creatures adjacent to you, rolling a separate [[DATABASE/skill/Athletics|Athletics]] check for each target. Then Stride up to half your Speed. This movement doesn't trigger reactions from any of the creatures you successfully Shoved.

## [[DATABASE/feat/Shoving Sweep|Shoving Sweep]] <span class="action-icon">5</span> <span class="item-type">Feat 8</span>

<span class="item-trait">Archetype</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Mauler|Mauler]]
**Prerequisites** [[DATABASE/feat/Mauler Dedication|Mauler Dedication]]; expert in [[DATABASE/skill/Athletics|Athletics]]
**Trigger** A creature within your reach leaves a square during a move action it's using.
**Requirements** You're wielding a melee weapon in two hands.

---
You swing your weapon at your foe, rebuffing them back. You attempt to [[DATABASE/action/Shove|Shove]] the triggering creature, ignoring the requirement that you have a hand free. The creature continues its movement after the Shove.

## [[DATABASE/feat/Improved Knockdown|Improved Knockdown]] <span class="item-type">Feat 12*</span>

<span class="item-trait">Fighter</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Archetype** [[DATABASE/archetype/Mauler|Mauler]]
**Prerequisites** [[DATABASE/feat/Knockdown|Knockdown]]
* This version of the Improved Knockdown feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Improved Knockdown|original feat]].
...
## [[DATABASE/feat/Brutal Finish|Brutal Finish]] <span class="action-icon">1</span> <span class="item-type">Feat 14*</span>
...
* This version of the Brutal Finish feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Brutal Finish|original feat]].
...
## [[DATABASE/feat/Hammer Quake|Hammer Quake]] <span class="action-icon">3</span> <span class="item-type">Feat 14</span>
...
## [[DATABASE/feat/Unbalancing Sweep|Unbalancing Sweep]] <span class="action-icon">3</span> <span class="item-type">Feat 14*</span>

<span class="item-trait">Barbarian</span><span class="item-trait">Flourish</span><span class="item-trait">Open</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Mauler|Mauler]]
* This version of the Unbalancing Sweep feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Unbalancing Sweep|original feat]].
...
## [[DATABASE/feat/Avalanche Strike|Avalanche Strike]] <span class="action-icon">3</span> <span class="item-type">Feat 16</span>
