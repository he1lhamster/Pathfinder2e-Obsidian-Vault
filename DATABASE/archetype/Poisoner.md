...
## [[DATABASE/feat/Poisoner Dedication|Poisoner Dedication]] <span class="item-type">Feat 2</span>
...
## [[DATABASE/feat/Poisoner's Twist|Poisoner's Twist]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Subtle Delivery|Subtle Delivery]] <span class="item-type">Feat 4*</span>

<span class="item-trait">Alchemist</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Poisoner|Poisoner]]
* This version of the Subtle Delivery feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Subtle Delivery|original feat]].

---
You can capably deliver toxins with a [[DATABASE/weapon/Blowgun|blowgun]]. Your blowgun Strikes can apply injury poisons even if they deal no damage due to a creature's resistance. If you critically succeed at an attack roll using a blowgun loaded with a dart you've poisoned and the target rolls a failure on the poison's initial save, the target critically fails instead.

## [[DATABASE/feat/Expert Poisoner|Expert Poisoner]] <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Poison Coat|Poison Coat]] <span class="action-icon">5</span> <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Tenacious Toxins|Tenacious Toxins]] <span class="item-type">Feat 6*</span>

<span class="item-trait">Alchemist</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Poisoner|Poisoner]]
* This version of the Tenacious Toxins feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Tenacious Toxins|original feat]].
...
## [[DATABASE/feat/Acquired Tolerance|Acquired Tolerance]] <span class="action-icon">5</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Sticky Poison|Sticky Poison]] <span class="item-type">Feat 8*</span>

<span class="item-trait">Alchemist</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Poisoner|Poisoner]]
* This version of the Sticky Poison feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Sticky Poison|original feat]].
...
## [[DATABASE/feat/Pinpoint Poisoner|Pinpoint Poisoner]] <span class="item-type">Feat 10*</span>

<span class="item-trait">Alchemist</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Poisoner|Poisoner]]
* This version of the Pinpoint Poisoner feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Pinpoint Poisoner|original feat]].

---
Unsuspecting targets are especially vulnerable to your poisons. When you successfully Strike a [[DATABASE/condition/Flat-Footed|flat-footed]] creature with a poisoned weapon or expose a flat-footed creature to an inhaled poison, the flat-footed condition also gives that creature a –2 circumstance penalty to its initial save against that poison.

## [[DATABASE/feat/Chemical Contagion|Chemical Contagion]] <span class="action-icon">5</span> <span class="item-type">Feat 18*</span>

<span class="item-trait">Alchemist</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Poisoner|Poisoner]]
**Trigger** A creature within 30 feet critically fails its initial saving throw against a poison you created.
* This version of the Chemical Contagion feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Chemical Contagion|original feat]].
