...
## [[DATABASE/feat/Dual-Weapon Warrior Dedication|Dual-Weapon Warrior Dedication]] <span class="item-type">Feat 2</span>
...
## [[DATABASE/feat/Dual Thrower|Dual Thrower]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Dual-Weapon Reload|Dual-Weapon Reload]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Twin Parry|Twin Parry]] <span class="action-icon">1</span> <span class="item-type">Feat 6*</span>
...
* This version of the Twin Parry feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Twin Parry|original feat]].
...
## [[DATABASE/feat/Flensing Slice|Flensing Slice]] <span class="action-icon">1</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Dual-Weapon Blitz|Dual-Weapon Blitz]] <span class="action-icon">2</span> <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/Twin Riposte|Twin Riposte]] <span class="action-icon">5</span> <span class="item-type">Feat 12*</span>
...
* This version of the Twin Riposte feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Twin Riposte|original feat]].
...
## [[DATABASE/feat/Dual Onslaught|Dual Onslaught]] <span class="item-type">Feat 14</span>
...
---
When you lash out with both weapons, you leave no room for the target to escape your attack. When you use [[DATABASE/feat/Double Slice|Double Slice]], if you miss with both Strikes, choose one of the two weapons and apply the effects of a hit with that weapon. You can't choose a weapon if your attack roll with that weapon was a critical failure, meaning you still miss entirely if both attack rolls were critical failures.

## [[DATABASE/feat/Improved Twin Riposte (Fighter)|Improved Twin Riposte (Fighter)]] <span class="item-type">Feat 16*</span>

<span class="item-trait">Fighter</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Archetype** [[DATABASE/archetype/Dual-Weapon Warrior|Dual-Weapon Warrior]]
**Prerequisites** [[DATABASE/feat/Twin Riposte|Twin Riposte]]
* This version of the Improved Twin Riposte (Fighter) feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Improved Twin Riposte (Fighter)|original feat]].
...
## [[DATABASE/feat/Two-Weapon Flurry|Two-Weapon Flurry]] <span class="action-icon">1</span> <span class="item-type">Feat 16*</span>
...
* This version of the Two-Weapon Flurry feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Two-Weapon Flurry|original feat]].

---
You lash out with both your weapons in a sudden frenzy. Strike twice, once with each weapon.

## [[DATABASE/feat/Twinned Defense (Fighter)|Twinned Defense (Fighter)]] <span class="action-icon">1</span> <span class="item-type">Feat 18*</span>
...
**Requirements** You are wielding two melee weapons, one in each hand.
* This version of the Twinned Defense (Fighter) feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Twinned Defense (Fighter)|original feat]].
