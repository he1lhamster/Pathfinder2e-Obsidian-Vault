...
## [[DATABASE/feat/Cathartic Mage Dedication|Cathartic Mage Dedication]] <span class="item-type">Feat 2</span>
 ...
 **Catharsis** <span class="action-icon">5</span> (concentrate, emotion, mental) **Trigger** determined by your catharsis emotion; **Effect** You gain the catharsis activation effects listed for your catharsis emotion. You gain that emotion's emotional fervor benefits for 3 rounds. When your emotional fervor ends, you suffer the listed emotional fallout. After using Catharsis, you can't use it again until you use the Settle Emotions activity.
...
## [[DATABASE/feat/Basic Cathartic Spellcasting|Basic Cathartic Spellcasting]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Cathartic Focus Spell|Cathartic Focus Spell]] <span class="item-type">Feat 4</span>
...
---
You learn the focus spell listed under your emotion's entry. You can cast it only while in emotional fervor. If you don't already have one, you gain a focus pool of 1 Focus Point, which you can [[DATABASE/action/Refocus|Refocus]] while you use [[DATABASE/feat/Cathartic Mage Dedication|Settle Emotions]].

## [[DATABASE/feat/Work Yourself Up|Work Yourself Up]] <span class="action-icon">2</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Expert Cathartic Spellcasting|Expert Cathartic Spellcasting]] <span class="item-type">Feat 12</span>

<span class="item-trait">Archetype</span>
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
**Archetype** [[DATABASE/archetype/Cathartic Mage|Cathartic Mage]]
**Prerequisites** [[DATABASE/feat/Basic Cathartic Spellcasting|Basic Cathartic Spellcasting]]

---
You gain the expert spellcasting benefits.

## [[DATABASE/feat/Infectious Emotions|Infectious Emotions]] <span class="item-type">Feat 12</span>
...
---
When you use [[DATABASE/feat/Cathartic Mage Dedication|Catharsis]], one ally within 30 feet gains the catharsis activation benefits in addition to you. If these benefits require an emotional focus, they use your emotional focus as they're experiencing an empathic imprint of your emotions. Depending on the activation benefit, it might be impossible to grant it to an ally; for instance, pride could only have an effect for an ally if both you and the ally critically failed the same saving throw against the same effect.

## [[DATABASE/feat/Master Cathartic Spellcasting|Master Cathartic Spellcasting]] <span class="item-type">Feat 18</span>

<span class="item-trait">Archetype</span>
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
**Archetype** [[DATABASE/archetype/Cathartic Mage|Cathartic Mage]]
**Prerequisites** [[DATABASE/feat/Expert Cathartic Spellcasting|Expert Cathartic Spellcasting]]
...
**Catharsis Trigger** An enemy deals damage to you. You can't use this reaction if you're [[DATABASE/condition/Fatigued|fatigued]].
**Catharsis Activation** If you're [[DATABASE/condition/Grabbed|grabbed]], [[DATABASE/condition/Immobilized|immobilized]], or [[DATABASE/condition/Restrained|restrained]], you can attempt to [[DATABASE/action/Escape|Escape]]. If you succeed, the creature or hazard imposing the condition on you (if applicable) takes force damage equal to your level.
**Emotional Fervor** When you Cast a Spell from your spell slots, if the spell deals damage and doesn't have a duration, you gain a status bonus to that spell's damage equal to the spell's level. Spell: [[DATABASE/spell/Draw Ire|draw ire]]
**Emotional Fallout** You become [[DATABASE/condition/Fatigued|fatigued]] until you Settle your Emotions.
**Focus Spell** _[[DATABASE/spell/Athletic Rush|athletic rush]]_
...
**Catharsis Activation** If you're [[DATABASE/condition/Fascinated|fascinated]] or [[DATABASE/condition/Stupefied|stupefied]], you can attempt an additional save to end the effect if it allowed a save.
**Emotional Fervor** When you cast a spell, choose one creature that was hit by your spell attack roll or that failed its saving throw, if any. That creature becomes fascinated with you until the end of its next turn. It's then temporarily immune to this fervor effect for 1 hour. Spell: [[DATABASE/spell/Glitterdust|glitterdust]]
**Emotional Fallout** You become [[DATABASE/condition/Flat-Footed|flat-footed]] until you Settle your Emotions.
**Focus Spell** _[[DATABASE/spell/Dazzling Flash|dazzling flash]]_ (doesn't require a [[DATABASE/equipment/Religious Symbol|religious symbol]])
...
**Emotional Fervor** Your spells that target your emotional focus gain the benefits of [[DATABASE/feat/Reach Spell|Reach Spell]]. When you cast a healing spell that affects your emotional focus, your emotional focus also gains temporary HP equal to the spell's level in addition to the spell's effects. These temporary HP last for 1 minute. Spell: [[DATABASE/spell/Spirit Link|spirit link]]
**Emotional Fallout** Until you Settle your Emotions, you can't Cast Spells unless you're adjacent to your emotional focus.
**Focus Spell** _[[DATABASE/spell/Protector's Sacrifice|protector's sacrifice]]_

## Fear

**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
You let your fear fuel you, rather than consume you, but it burns your endurance.
**Catharsis Trigger** An enemy makes you [[DATABASE/condition/Frightened|frightened]].
**Catharsis Activation** Increase your frightened value by 1, to a maximum of frightened 4.
**Emotional Fervor** You don't take the status penalty from the frightened condition to your spell DCs or spell attack bonus. Instead, you gain a status bonus to spell attack rolls equal to the penalty you would've taken, and your foes take the same status penalty to their saving throws against your spells. Any other statistic takes the status penalty as normal. Spell: [[DATABASE/spell/Fear|fear]]
**Emotional Fallout** You are [[DATABASE/condition/Fleeing|fleeing]] for 2 rounds, running from the source of the frightened condition that triggered your Catharsis. If that source is no longer present, you instead flee from the position where you were at the start of your emotional fallout.
**Focus Spell** _[[DATABASE/spell/Waking Nightmare|waking nightmare]]_
...
**Emotional Fervor** Your emotional focus is [[DATABASE/condition/Flat-Footed|flat-footed]] to you and takes a –2 status penalty to saves against your spells. You're flat-footed to your emotional focus and take a –2 status penalty to saves against it. Spell: [[DATABASE/spell/Blood Vendetta|blood vendetta]]
**Emotional Fallout** You become [[DATABASE/condition/Stunned|stunned 2]].
**Focus Spell** _[[DATABASE/spell/Cry of Destruction|cry of destruction]]_
...
**Catharsis Activation** Reduce the value of any [[DATABASE/condition/Frightened|frightened]] or [[DATABASE/condition/Stupefied|stupefied]] condition you have by 1 and end any [[DATABASE/condition/Persistent Damage|persistent mental damage]] you have.
**Emotional Fervor** You gain a +1 status bonus to [[DATABASE/skill/Performance|Performance]] checks and to the spell attack rolls of emotion spells, and enemies take a –1 status penalty to saves against your emotion spells. Spell: [[DATABASE/spell/Hideous Laughter|hideous laughter]]
**Emotional Fallout** You become [[DATABASE/condition/Fatigued|fatigued]] until you Settle your Emotions.
**Focus Spell** _[[DATABASE/spell/Unimpeded Stride|unimpeded stride]]_
...
**Focus Spell** _[[DATABASE/spell/Savor the Sting|savor the sting]]_
...
**Emotional Fervor** Each time you cast an illusion spell, until the start of your next turn, any critical failure you roll on an attack roll or saving throw is a failure instead. Spell: [[DATABASE/spell/Color Spray|color spray]]
**Emotional Fallout** You momentarily lose track of what's real, becoming [[DATABASE/condition/Confused|confused]] for 1 round. Spell: [[DATABASE/spell/Mirror Image|mirror image]]
**Focus Spell** _[[DATABASE/spell/Veil of Confidence|veil of confidence]]_
...
**Emotional Fervor** Any spell you cast that restores Hit Points to the triggering ally gets a status bonus to the Hit Points healed equal to the spell's level, or double the spell's level if the ally is at 0 Hit Points. Spell: [[DATABASE/spell/Warrior's Regret|warrior's regret]]
**Emotional Fallout** Your emotional weight crushes you, leaving you [[DATABASE/condition/Stupefied|stupefied 2]] until you Settle your Emotions.
**Focus Spell** _[[DATABASE/spell/Healer's Blessing|healer's blessing]]_