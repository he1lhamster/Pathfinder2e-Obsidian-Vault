...
## [[DATABASE/feat/Overwatch Dedication|Overwatch Dedication]] <span class="item-type">Feat 2</span>
...
## [[DATABASE/feat/Spyglass Modification|Spyglass Modification]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Swift Intervention|Swift Intervention]] <span class="action-icon">5</span> <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Topple Giants|Topple Giants]] <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Wide Overwatch|Wide Overwatch]] <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/Forewarn|Forewarn]] <span class="action-icon">5</span> <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Control Tower|Control Tower]] <span class="item-type">Feat 14</span>
...
---
Your keen senses and ability to process battlefield information have dramatically improved, allowing you to drastically reduce the advantage of unseen foes. You and allies in your overwatch field gain a +2 circumstance bonus when using the [[DATABASE/action/Seek|Seek]] action to find [[DATABASE/condition/Hidden|hidden]] or [[DATABASE/condition/Undetected|undetected]] creatures within the overwatch field. You and your allies don't have to succeed at a flat check to target a [[DATABASE/condition/Concealed|concealed]] creature within your overwatch field. When you or an ally targets a hidden creature in your overwatch field, reduce the DC of the flat check to 5.

## [[DATABASE/feat/Converge|Converge]] <span class="action-icon">5</span> <span class="item-type">Feat 16</span>
