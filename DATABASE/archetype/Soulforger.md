...
## [[DATABASE/feat/Soulforger Dedication|Soulforger Dedication]] <span class="item-type">Feat 2</span>
...
## [[DATABASE/feat/Soul Flare|Soul Flare]] <span class="action-icon">5</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Rapid Manifestation|Rapid Manifestation]] <span class="action-icon">4</span> <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Soul Arsenal|Soul Arsenal]] <span class="item-type">Feat 6</span>
...
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
Melee weapon only. The weapon gains the thrown 30 feet trait and has the [[DATABASE/equipment/Returning|returning]] rune (even if it already has its maximum number of property runes).
...
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
You gain a +2 status bonus to your [[DATABASE/skill/Intimidation|Intimidation]] checks and don't take any penalties for not sharing a language when [[DATABASE/action/Demoralize|Demoralizing]] foes who can perceive your armament's essence form. When you manifest the essence form, you can attempt to Demoralize an enemy who can perceive the manifestation.
...
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
Any status penalties you take from the following conditions are 1 less than their condition's value: [[DATABASE/condition/Clumsy|clumsy]], [[DATABASE/condition/Drained|drained]], [[DATABASE/condition/Enfeebled|enfeebled]], [[DATABASE/condition/Frightened|frightened]], [[DATABASE/condition/Sickened|sickened]], [[DATABASE/condition/Stupefied|stupefied]]. This doesn't change the actual condition value, or any other effects of the condition (such as stupefied's disruption and its DC).
...
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
Your Strikes deal an additional 1d4 negative damage. Once while the armament is manifested, you can cast [[DATABASE/spell/Harm|harm]] as an innate spell, with a level equal to half your level rounded up.
...
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
You gain [[DATABASE/monsterability/Fast Healing|fast healing]] equal to half your level. You can cast [[DATABASE/spell/Heal|heal]] once as an innate spell with a level equal to half your level rounded up.
...
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
Armor or shield only. You gain a +2 status bonus to saving throws and AC against spells. If you're 5th level or higher, you can cast [[DATABASE/spell/Dispel Magic|dispel magic]] once as an innate spell. The spell level is equal to 1 lower than half your level rounded up (2nd level if you're 5th or 6th level, and so on).
...
<span class="item-trait">Transmutation</span>
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
Weapon only. Any time you hit with the soulforged weapon, the target takes a –10-foot penalty to its Speeds for 1 round. On a critical hit, the creature is [[DATABASE/condition/Immobilized|immobilized]] for 1 round instead.
_**Corruption Flaw**_ You take a –10-foot penalty to all your Speeds.
...
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
Shield only. The shield gains a +2 status bonus to its Hardness and gains temporary Hit Points equal to your level + 2 that last until the essence effect ends. If you don't have the [[DATABASE/feat/Shield Block|Shield Block]] reaction, you gain it while your shield is manifested.
_**Corruption Flaw**_ When you take damage while [[DATABASE/action/Raise a Shield|Raising a Shield]] or use Shield Block, attempt a DC 5 flat check. If you fail, the shield is Dismissed if it's your soulforged armament or Dropped if it's a different shield.