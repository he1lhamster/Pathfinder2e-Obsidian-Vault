...
## [[Snarecrafter Dedication]] <span class="item-type">Feat 2</span>
...
---
You've learned to create a limited number of snares at no cost. Each day during your daily preparations, you can prepare four snares from your [[Formula Book (Blank)]] for quick deployment; if they normally take 1 minute to [[Craft]], you can Craft them with 3 Interact actions. The number of snares increases to six if you're a master in Crafting and eight if you're legendary. Snares prepared in this way don't cost you any resources to Craft.
...
## [[Remote Trigger]] <span class="item-type">Feat 6</span>
...
## [[Quick Snares]] <span class="item-type">Feat 8*</span>

<span class="item-trait">Ranger</span>
**Source** [[Core Rulebook]] 
**Archetype** [[Snarecrafter]]
**Prerequisites** expert in [[Crafting]]; [[Snare Specialist]]
* This version of the Quick Snares feat is intended for use with an Archetype and has a different level for access than the [[Quick Snares]].
...
## [[Powerful Snares]] <span class="item-type">Feat 10*</span>

<span class="item-trait">Ranger</span>
**Source** [[Core Rulebook]] 
**Archetype** [[Snarecrafter]]
**Prerequisites** master in [[Crafting]]; [[Snare Specialist]]
* This version of the Powerful Snares feat is intended for use with an Archetype and has a different level for access than the [[Powerful Snares]].
...
## [[Plentiful Snares]] <span class="item-type">Feat 12</span>
...
## [[Lightning Snares]] <span class="item-type">Feat 14*</span>

<span class="item-trait">Ranger</span>
**Source** [[Core Rulebook]] 
**Archetype** [[Snarecrafter]]
**Prerequisites** master in [[Crafting]]; [[Quick Snares]]; [[Snare Specialist]]
* This version of the Lightning Snares feat is intended for use with an Archetype and has a different level for access than the [[Lightning Snares]].
