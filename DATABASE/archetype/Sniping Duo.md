...
## [[Cover Fire]] <span class="action-icon">1</span> <span class="item-type">Feat 4*</span>
...
* This version of the Cover Fire feat is intended for use with an Archetype and has a different level for access than the [[Cover Fire]].
...
## [[Triangulate]] <span class="item-type">Feat 4</span>
...
## [[Exploit Opening]] <span class="action-icon">5</span> <span class="item-type">Feat 6</span>
...
## [[Duo's Aim]] <span class="action-icon">2</span> <span class="item-type">Feat 8</span>
...
## [[Vantage Shot]] <span class="item-type">Feat 8</span>
...
## [[Deflecting Shot]] <span class="action-icon">5</span> <span class="item-type">Feat 12*</span>
...
**Requirements** You're wielding a loaded firearm or crossbow.
* This version of the Deflecting Shot feat is intended for use with an Archetype and has a different level for access than the [[Deflecting Shot]].
...
## [[Eagle Eyes]] <span class="item-type">Feat 12</span>
...
## [[Redirecting Shot]] <span class="action-icon">5</span> <span class="item-type">Feat 12*</span>
...
**Requirements** You're wielding a loaded firearm or crossbow.
* This version of the Redirecting Shot feat is intended for use with an Archetype and has a different level for access than the [[Redirecting Shot]].
