...
The ability to infuse eldritch energy into bow shots is often seen as a kind of [[DATABASE/ancestry/Elf|elven]] magic. While it may be true that elves first developed eldritch archery as a martial art, and many eldritch archers are elves and half-elves, other peoples have learned and developed their own forms of eldritch archery.
 Some whisper that remote regions to the south have their own dedications that rely on elemental archery, while the strange and shadowy hunters of the Uskwood use a form that relies on tenebrous shadow magic. Disturbing rumors circulate claiming that devils have developed a diabolical form of magical archery that can trap the soul and bind it to [[DATABASE/plane/Hell|Hell]], albeit for a short time. Like any form of magic, the discipline of eldritch archery will continue to develop among its practitioners across the multiverse.
...
## [[DATABASE/feat/Eldritch Archer Dedication|Eldritch Archer Dedication]] <span class="item-type">Feat 6</span>
...
**Prerequisites** expert in at least one type of [[DATABASE/weapongroup/Bow|bow]]
...
**Activate** <span class="action-icon">3</span> Eldritch Shot **Requirements** You are wielding a [[DATABASE/weapongroup/Bow|bow]]; **Effect** You Cast a Spell that takes 1 or 2 actions to cast and requires a spell attack roll. The effects of the spell do not occur immediately but are imbued into the bow you're wielding. Make a Strike with that bow. Your spell flies with the ammunition, using your attack roll result to determine the effects of both the Strike and the spell. This counts as two attacks for your multiple attack penalty, but you don't apply the penalty until after you've completed both attacks.
...
## [[DATABASE/feat/Basic Eldritch Archer Spellcasting|Basic Eldritch Archer Spellcasting]] <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Enchanting Arrow|Enchanting Arrow]] <span class="action-icon">2</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Magic Arrow|Magic Arrow]] <span class="action-icon">4</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Precious Arrow|Precious Arrow]] <span class="action-icon">1</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Expert Eldritch Archer Spellcasting|Expert Eldritch Archer Spellcasting]] <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Seeker Arrow|Seeker Arrow]] <span class="action-icon">1</span> <span class="item-type">Feat 14</span>
...
## [[DATABASE/feat/Phase Arrow|Phase Arrow]] <span class="action-icon">1</span> <span class="item-type">Feat 16</span>
...
## [[DATABASE/feat/Arrow of Death|Arrow of Death]] <span class="action-icon">3</span> <span class="item-type">Feat 18</span>
...
## [[DATABASE/feat/Master Eldritch Archer Spellcasting|Master Eldritch Archer Spellcasting]] <span class="item-type">Feat 18</span>
...
## [[DATABASE/feat/Impossible Volley|Impossible Volley]] <span class="action-icon">3</span> <span class="item-type">Feat 20*</span>
...
* This version of the Impossible Volley feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Impossible Volley|original feat]].
