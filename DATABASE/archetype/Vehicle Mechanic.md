...
**Prerequisites** Intelligence 14; trained in [[DATABASE/skill/Crafting|Crafting]]
...
## [[DATABASE/feat/Engine Bay|Engine Bay]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Patch Job|Patch Job]] <span class="item-type">Feat 4</span>
...
---
You can patch up damage to an object with a quick fix. You gain the [[DATABASE/feat/Improvised Repair|Improvised Repair]] general feat. When you use Improvised Repair, you can attempt a [[DATABASE/skill/Crafting|Crafting]] check with the same DC as [[DATABASE/action/Repair|Repair]]. If you succeed, you can use the object as a normal object of its type until it takes damage rather than as a shoddy object of its type.

## [[DATABASE/feat/Superior Propulsion|Superior Propulsion]] <span class="item-type">Feat 6</span>
 ...
 **Clockwork** More resilient gears allow the vehicle to remain functional, even when damaged. If your signature vehicle is [[DATABASE/condition/Broken|broken]], it does not need to make the flat check to avoid losing operating time.
 ...
 **Steam** The outlet of steam forms a cloud around the vehicle as it moves. For the duration of its movement, your signature vehicle is [[DATABASE/condition/Concealed|concealed]].
...
## [[DATABASE/feat/Efficient Controls|Efficient Controls]] <span class="item-type">Feat 7</span>
...
## [[DATABASE/feat/Impervious Vehicle|Impervious Vehicle]] <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Miraculous Flight|Miraculous Flight]] <span class="item-type">Feat 18</span>
