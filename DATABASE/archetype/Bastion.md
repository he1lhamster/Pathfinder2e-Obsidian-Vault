...
## [[Bastion Dedication]] <span class="item-type">Feat 2</span>
...
## [[Agile Shield Grip]] <span class="action-icon">1</span> <span class="item-type">Feat 4*</span>
...
* This version of the Agile Shield Grip feat is intended for use with an Archetype and has a different level for access than the [[Agile Shield Grip]].
...
## [[Everstand Stance]] <span class="action-icon">1</span> <span class="item-type">Feat 4*</span>
...
* This version of the Everstand Stance feat is intended for use with an Archetype and has a different level for access than the [[Everstand Stance]].

---
You brace your shield with both hands, enhancing its potential for both offense and defense. When in this stance, you wield the shield with both hands. When wielding a shield this way, increase the weapon damage die of the shield’s boss or spikes by one step, and increase the shield’s Hardness by 2 when using the [[Shield Block]] reaction.<span>Knights of Lastwall Class Feats</span>**Source** [[Character Guide]] 
...
## [[Everstand Strike]] <span class="action-icon">1</span> <span class="item-type">Feat 6*</span>
...
* This version of the Everstand Strike feat is intended for use with an Archetype and has a different level for access than the [[Everstand Strike]].

---
Your follow-up blow leaves you an opening to set your shield. Make a Strike with the wielded shield. If the Strike hits and deals damage, you also [[Raise a Shield]].<span>Knights of Lastwall Class Feats</span>**Source** [[Character Guide]] 
The following class feats are available to Knights of Lastwall. Those with the champion trait are champion class feats. Those with both the champion and fighter traits are both champion class feats and fighter class feats; when you take one of these feats, it loses the trait that doesn’t apply to your class.
...
## [[Shielded Stride]] <span class="item-type">Feat 6*</span>

<span class="item-trait">Fighter</span>
**Source** [[Core Rulebook]] 
**Archetypes** [[Bastion]], [[Viking]]
* This version of the Shielded Stride feat is intended for use with an Archetype and has a different level for access than the [[Shielded Stride]].
...
## [[Reflexive Shield]] <span class="item-type">Feat 8*</span>

<span class="item-trait">Fighter</span>
**Source** [[Core Rulebook]] 
**Archetype** [[Bastion]]
* This version of the Reflexive Shield feat is intended for use with an Archetype and has a different level for access than the [[Reflexive Shield]].
...
## [[Shield Warden]] <span class="item-type">Feat 8*</span>

<span class="item-trait">Champion</span><span class="item-trait">Fighter</span>
**Source** [[Core Rulebook]] 
**Archetypes** [[Bastion]], [[Knight Vigilant]]
**Prerequisites** [Champion] [[Champion]]; [Champion] [[Good]]; [Fighter] [[Shield Block]]
* This version of the Shield Warden feat is intended for use with an Archetype and has a different level for access than the [[Shield Warden]].
...
## [[Destructive Block]] <span class="item-type">Feat 10</span>
...
## [[Quick Shield Block]] <span class="item-type">Feat 10*</span>

<span class="item-trait">Champion</span><span class="item-trait">Fighter</span>
**Source** [[Core Rulebook]] 
**Archetypes** [[Bastion]], [[Viking]]
**Prerequisites** [[Shield Block]]
* This version of the Quick Shield Block feat is intended for use with an Archetype and has a different level for access than the [[Quick Shield Block]].
...
## [[Mirror Shield]] <span class="action-icon">5</span> <span class="item-type">Feat 12*</span>
...
* This version of the Mirror Shield feat is intended for use with an Archetype and has a different level for access than the [[Mirror Shield]].
...
## [[Shield Salvation]] <span class="item-type">Feat 12</span>
