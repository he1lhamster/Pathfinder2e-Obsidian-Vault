...
**Source** [[DATABASE/source/Book of the Dead|Book of the Dead]]
You are a [[DATABASE/monsterfamily/Zombie|zombie]], a rotting corpse animated by necromantic magic. Although most zombies are mindless brutes, you're a [[DATABASE/monster/Husk Zombie|husk zombie]], preserved through necromantic rites and alchemical reagents. The process worked especially well on you, and you retained your intelligence and identity to a far greater degree than other husk zombies.
...
## [[DATABASE/feat/Zombie Dedication|Zombie Dedication]] <span class="item-type">Feat 2</span>
...
**Prerequisites** You died and were animated as a [[DATABASE/monster/Husk Zombie|husk zombie]].
...
Despite your death and subsequent reanimation as a rotting corpse, you retain most of your mind and identity. Yet, it's always there: the hunger for the flesh and organs of the living. You gain the undead and zombie traits, and the basic undead benefits. Unlike a typical zombie, you're not mindless. Reduce all your Speeds by 5 feet. Your fist loses the nonlethal trait.
 ...
 While your body is deteriorated, you're [[DATABASE/condition/Slowed|slowed 1]]. You can spend 10 minutes checking and repairing your joints and other weak parts of your body to recover from deterioration. You can perform these repairs as part of your daily preparations. Because it's a natural result of your body's functions, you can't remove the slowed condition from deterioration through any other means.
 You crave the flesh of the living. You gain a jaws unarmed attack that deals 1d8 piercing damage. Your jaws are in the [[DATABASE/weapongroup/Brawling|brawling]] group and have the unarmed trait. You can use your jaws Strike only against a creature that's [[DATABASE/condition/Grabbed|grabbed]] or [[DATABASE/condition/Restrained|restrained]] by you.
**Special** You can't select another dedication feat until you have gained two other feats from the zombie archetype.

## [[DATABASE/feat/Ankle Biter|Ankle Biter]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Bashing Charge|Bashing Charge]] <span class="action-icon">2</span> <span class="item-type">Feat 4*</span>
...
* This version of the Bashing Charge feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Bashing Charge|original feat]].
...
## [[DATABASE/feat/Feast|Feast]] <span class="action-icon">2</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Ravenous Charge|Ravenous Charge]] <span class="action-icon">2</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Brains!|Brains!]] <span class="action-icon">4</span> <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Numb|Numb]] <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Out of Hand|Out of Hand]] <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Unkillable|Unkillable]] <span class="action-icon">5</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Festering Wound|Festering Wound]] <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Corpse Stench|Corpse Stench]] <span class="item-type">Feat 14*</span>
...
* This version of the Corpse Stench feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Corpse Stench|original feat]].
...
## [[DATABASE/feat/Seize|Seize]] <span class="action-icon">1</span> <span class="item-type">Feat 14</span>
