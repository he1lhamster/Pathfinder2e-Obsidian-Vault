...
## [[DATABASE/feat/Turn Back the Clock|Turn Back the Clock]] <span class="action-icon">5</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Guide the Timeline|Guide the Timeline]] <span class="action-icon">1</span> <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Reversing Charge|Reversing Charge]] <span class="action-icon">2</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Superimpose Time Duplicates|Superimpose Time Duplicates]] <span class="action-icon">1</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Borrow Time|Borrow Time]] <span class="action-icon">4</span> <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/Steal Time|Steal Time]] <span class="action-icon">2</span> <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/Combat Premonition|Combat Premonition]] <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Escape Timeline|Escape Timeline]] <span class="action-icon">4</span> <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Space-Time Shift|Space-Time Shift]] <span class="action-icon">4</span> <span class="item-type">Feat 12</span>
...
---
You travel just a few moments into the future to immediately arrive at your destination. Your Strides are augmented until the end of your turn, allowing you to instantly teleport to any point you could reach with your Stride instead of traversing normally to the location. Your augmented Strides have the [[DATABASE/spell/Teleport|teleport]] trait and don't trigger reactions that can be triggered by move actions or upon leaving or entering a square. You also augment your [[DATABASE/action/Burrow|Burrow]], [[DATABASE/action/Climb|Climb]], [[DATABASE/action/Fly|Fly]], or [[DATABASE/action/Swim|Swim]] actions in this way if you have the corresponding movement type.

## [[DATABASE/feat/Reset the Past|Reset the Past]] <span class="action-icon">4</span> <span class="item-type">Feat 14</span>
