...
## [[DATABASE/feat/Marshal Dedication|Marshal Dedication]] <span class="item-type">Feat 2</span>
...
## [[DATABASE/feat/Devrin's Cunning Stance|Devrin's Cunning Stance]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Archetype</span><span class="item-trait">Open</span><span class="item-trait">Stance</span>
**Source** [[DATABASE/source/Firebrands|Firebrands]]
**Archetype** [[DATABASE/archetype/Marshal|Marshal]]**Prerequisites** [[DATABASE/feat/Marshal Dedication|Marshal Dedication]]; trained in [[DATABASE/skill/Deception|Deception]]
...
**Critical Success** Your marshal's aura increases to a 20-foot emanation, and it grants you and your allies a +1 status bonus to skill checks. When you or an ally in the aura Strike a [[DATABASE/condition/Flat-Footed|flat-footed]] enemy, that enemy can't use reactions until the beginning of its next turn.
...
## [[DATABASE/feat/Dread Marshal Stance|Dread Marshal Stance]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>

<span class="item-trait">Archetype</span><span class="item-trait">Open</span><span class="item-trait">Stance</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Marshal|Marshal]]
**Prerequisites** [[DATABASE/feat/Marshal Dedication|Marshal Dedication]]; trained in [[DATABASE/skill/Intimidation|Intimidation]]

---
Putting on a grim face for the battle ahead, you encourage your allies to strike fear into their foes with vicious attacks. When you use this action, attempt an [[DATABASE/skill/Intimidation|Intimidation]] check. The DC is usually a standard-difficulty DC of your level, but the GM can assign a different DC based on the circumstances. The effect depends on the result of your check.
**Critical Success** Your marshal's aura increases to a 20-foot emanation, and it grants you and allies a status bonus to damage rolls equal to the number of weapon damage dice of the unarmed attack or weapon you are wielding that has the most weapon damage dice. When you or an ally in the aura critically hits an enemy with a Strike, that enemy is [[DATABASE/condition/Frightened|frightened 1]].
**Success** As critical success, but your aura's size doesn't increase.
**Failure** You fail to enter the stance.
**Critical Failure** You fail to enter the stance and can't take this action again for 1 minute.

## [[DATABASE/feat/Inspiring Marshal Stance|Inspiring Marshal Stance]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Push Back the Dead!|Push Back the Dead!]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Snap Out of It! (Marshal)|Snap Out of It! (Marshal)]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Steel Yourself!|Steel Yourself!]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Cadence Call|Cadence Call]] <span class="action-icon">1</span> <span class="item-type">Feat 6</span>

<span class="item-trait">Archetype</span><span class="item-trait">Auditory</span><span class="item-trait">Flourish</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Marshal|Marshal]]
...
---
You call out a quick cadence, guiding your allies into a more efficient rhythm. Each willing ally within your marshal's aura is [[DATABASE/condition/Quickened|quickened]] until the end of their next turn, and they can use the extra action only to Stride. At the end of each ally's turn, if they used the extra action, they then become [[DATABASE/condition/Slowed|slowed 1]] until the end of their following turn.

## [[DATABASE/feat/Rallying Charge|Rallying Charge]] <span class="action-icon">2</span> <span class="item-type">Feat 6</span>

<span class="item-trait">Archetype</span><span class="item-trait">Open</span><span class="item-trait">Visual</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Marshal|Marshal]]
**Prerequisites** [[DATABASE/feat/Marshal Dedication|Marshal Dedication]]
...
## [[DATABASE/feat/Attack of Opportunity|Attack of Opportunity]] <span class="action-icon">5</span> <span class="item-type">Feat 8*</span>
...
* This version of the Attack of Opportunity feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Attack of Opportunity|original feat]].

---
You lash out at a foe that leaves an opening. Make a melee Strike against the triggering creature. If your attack is a critical hit and the trigger was a manipulate action, you disrupt that action. This Strike doesn’t count toward your multiple attack penalty, and your multiple attack penalty doesn’t apply to this Strike.

## [[DATABASE/feat/Back to Back|Back to Back]] <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/To Battle!|To Battle!]] <span class="action-icon">1</span> or <span class="action-icon">2</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Topple Foe|Topple Foe]] <span class="action-icon">5</span> <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/Coordinated Charge|Coordinated Charge]] <span class="action-icon">2</span> <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Tactical Cadence|Tactical Cadence]] <span class="item-type">Feat 14</span>

<span class="item-trait">Archetype</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Marshal|Marshal]]
**Prerequisites** [[DATABASE/feat/Cadence Call|Cadence Call]]

---
Your remarkable breath control and concise instructions allow you to coordinate your allies more effectively. When you grant allies the [[DATABASE/condition/Quickened|quickened]] condition using [[DATABASE/feat/Cadence Call|Cadence Call]], they can use the extra action to either Stride or Strike, and they aren't [[DATABASE/condition/Slowed|slowed 1]] on their following turn if they use the extra action.

## [[DATABASE/feat/Target of Opportunity|Target of Opportunity]] <span class="action-icon">5</span> <span class="item-type">Feat 14</span>
