...
## [[DATABASE/feat/Spellmaster Dedication|Spellmaster Dedication]] <span class="item-type">Feat 6</span>
...
---
As a Spellmaster, you are adept at identifying magic. You gain a +2 circumstance bonus when you [[DATABASE/action/Identify Magic|Identify Magic]] with a skill in which you are trained or better. If you have the [[DATABASE/feat/Wayfinder Resonance Tinkerer|Wayfinder Resonance Tinkerer]] feat, you can change the cantrip you chose for that feat each day during your daily preparations.
**Special** You cannot select another dedication feat until you have gained two other feats from the Spellmaster archetype.

## [[DATABASE/feat/Familiar Form|Familiar Form]] <span class="item-type">Feat 8</span>
...
---
You can use your magic to transform into a small creature of a type that commonly serves as a spellcaster's familiar, potentially allowing you to safely scout for your party while retaining a degree of spellcasting ability. You gain the [[DATABASE/spell/Familiar Form|familiar form]] focus spell. Increase the number of Focus Points in your focus pool by 1.

## [[DATABASE/feat/Glyph Expert|Glyph Expert]] <span class="item-type">Feat 8</span>
...
---
You've learned to recognize the telltale writings and other signs that indicate the presence of magical traps. You gain a +2 circumstance bonus to Perception checks to find magical traps, to AC against attacks made by magical traps, to saves against magical traps, and to checks to [[DATABASE/action/Disable a Device|Disable]] magical traps. Even if you aren't [[DATABASE/action/Search|Searching]], you get a check to find magical traps that normally require you to be Searching. You still need to meet any other requirements to find the trap. 
...
## [[DATABASE/feat/Surreptitious Spellcaster|Surreptitious Spellcaster]] <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Recover Spell|Recover Spell]] <span class="action-icon">1</span> <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/Spellmaster's Ward|Spellmaster's Ward]] <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/Ward Casting|Ward Casting]] <span class="action-icon">5</span> <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/Communal Sustain|Communal Sustain]] <span class="action-icon">1</span> <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Spellmaster's Resilience|Spellmaster's Resilience]] <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Absorb Spell|Absorb Spell]] <span class="action-icon">5</span> <span class="item-type">Feat 14</span>
...
## [[DATABASE/feat/Spellmaster's Tenacity|Spellmaster's Tenacity]] <span class="action-icon">5</span> <span class="item-type">Feat 14</span>
...
## [[DATABASE/feat/Master's Counterspell|Master's Counterspell]] <span class="action-icon">5</span> <span class="item-type">Feat 16</span>
...
## [[DATABASE/feat/Mobile Magical Combat|Mobile Magical Combat]] <span class="action-icon">1</span> <span class="item-type">Feat 16</span>
