...
## [[DATABASE/feat/Duelist Dedication|Duelist Dedication]] <span class="item-type">Feat 2</span>
...
---
You are always ready to draw your weapon and begin a duel, no matter the circumstances. You gain the [[DATABASE/feat/Quick Draw|Quick Draw]] ranger feat, enabling you to both draw and attack with a weapon as 1 action. This serves as Quick Draw for the purpose of meeting prerequisites.
**Special** You cannot select another dedication feat until you have gained two other feats from the duelist archetype.

## [[DATABASE/feat/Dueling Parry (Fighter)|Dueling Parry (Fighter)]] <span class="action-icon">1</span> <span class="item-type">Feat 4*</span>

<span class="item-trait">Fighter</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Archetype** [[DATABASE/archetype/Duelist|Duelist]]
**Requirements** You are wielding only a single one-handed melee weapon and have your other hand or hands free.
* This version of the Dueling Parry (Fighter) feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Dueling Parry (Fighter)|original feat]].
...
## [[DATABASE/feat/Duelist's Challenge|Duelist's Challenge]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Disarming Stance|Disarming Stance]] <span class="action-icon">1</span> <span class="item-type">Feat 8*</span>
...
**Requirements** You are wielding only a single one-handed melee weapon and have your other hand or hands free.
* This version of the Disarming Stance feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Disarming Stance|original feat]].
...
## [[DATABASE/feat/Selfless Parry|Selfless Parry]] <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Dueling Riposte|Dueling Riposte]] <span class="action-icon">5</span> <span class="item-type">Feat 10*</span>
...
* This version of the Dueling Riposte feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Dueling Riposte|original feat]].
...
## [[DATABASE/feat/Disarming Twist|Disarming Twist]] <span class="action-icon">1</span> <span class="item-type">Feat 12*</span>
...
**Prerequisites** trained in [[DATABASE/skill/Athletics|Athletics]]
**Requirements** You are wielding only a single one-handed melee weapon and have your other hand or hands free.
* This version of the Disarming Twist feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Disarming Twist|original feat]].

---
After your initial attack redirects your foe's defenses, your follow-up wrests their weapon from their grasp. Make a melee Strike with the required weapon. In addition to its other effects, this Strike gains the success and critical success effects of the [[DATABASE/action/Disarm|Disarm]] action. The Strike also has the following failure effect.
**Failure** The target is flat-footed until the end of your current turn.

## [[DATABASE/feat/Student of the Dueling Arts|Student of the Dueling Arts]] <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Dueling Dance (Fighter)|Dueling Dance (Fighter)]] <span class="action-icon">1</span> <span class="item-type">Feat 14*</span>
...
**Prerequisites** [[DATABASE/feat/Dueling Parry (Fighter)|Dueling Parry (Fighter)]]
**Requirements** You are wielding only a single one-handed melee weapon and have your other hand or hands free.
* This version of the Dueling Dance (Fighter) feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Dueling Dance (Fighter)|original feat]].
...
## [[DATABASE/feat/Improved Dueling Riposte|Improved Dueling Riposte]] <span class="item-type">Feat 14*</span>

<span class="item-trait">Fighter</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Archetype** [[DATABASE/archetype/Duelist|Duelist]]
**Prerequisites** [[DATABASE/feat/Dueling Riposte|Dueling Riposte]]
* This version of the Improved Dueling Riposte feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Improved Dueling Riposte|original feat]].
...
## [[DATABASE/feat/Guiding Riposte|Guiding Riposte]] <span class="item-type">Feat 16*</span>

<span class="item-trait">Fighter</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Archetype** [[DATABASE/archetype/Duelist|Duelist]]
**Prerequisites** [[DATABASE/feat/Dueling Riposte|Dueling Riposte]]
* This version of the Guiding Riposte feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Guiding Riposte|original feat]].
