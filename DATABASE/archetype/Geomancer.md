...
prerequisite: Trained in [[DATABASE/skill/Nature|Nature]] ; ability to cast spells
  from spell slots;at least one spell with the [[DATABASE/trait/Air|air]] , [[DATABASE/trait/Cold|cold]]
...
You know how to draw power from the land around you, no matter the terrain, by attuning your magic to match its mystical properties.
 You might be a [[DATABASE/class_/Druid|druid]] with an elemental focus (such as the [[DATABASE/druidicorder/Flame|flame]], [[DATABASE/druidicorder/Stone|stone]], or [[DATABASE/druidicorder/Wave|wave]] orders) or a naturalist with a touch of magic at your disposal. You could concentrate on a single type of terrain to wring every last drop of power from it or choose to wander the land to experience every type of terrain possible.
Click here for more rules on using this archetype.

## [[DATABASE/feat/Geomancer Dedication|Geomancer Dedication]] <span class="item-type">Feat 2</span>
...
**Prerequisites** trained in [[DATABASE/skill/Nature|Nature]]; ability to cast spells from spell slots; at least one spell with the air, cold, earth, fire, plant, or water trait
...
* **Desert** (fire) The scorching heat of the desert dehydrates your foes. Enemies must attempt a Fortitude save. On a failure, they're [[DATABASE/condition/Fatigued|fatigued]] until they drink water or another potable liquid.
* **Forest** (plant) Branches and vines reach out to get in your foes' way. Enemies must attempt a Reflex save. On a failure, they become [[DATABASE/condition/Clumsy|clumsy 1]] for 1 round (clumsy 2 on a critical failure).
* **Mountain** (earth) The rugged endurance of the mountain protects you from harm. You gain resistance to physical damage (except [[DATABASE/equipment/Adamantine Weapon|adamantine]]) equal to the spell level for 1 round.
...
* **Sky** (air) A gust of wind carries you aloft. You can [[DATABASE/action/Fly|Fly]] up to 10 feet. If you're in the air at the end of the turn and don't have a fly Speed, you fall.
* **Swamp** (plant) Your magic draws in noxious swamp gas to fumigate your foes. Affected foes take [[DATABASE/condition/Persistent Damage|persistent poison damage]] equal to half the spell's level (minimum 1 damage) with a basic Fortitude save.
* **Underground** (earth) The endless darkness of the cavern depths opens up its secrets to your senses. For 1 round, you gain darkvision as well as imprecise [[DATABASE/monsterability/Tremorsense|tremorsense]] out to 15 feet.

**Special** You can't select another dedication feat until you've gained two other feats from the geomancer archetype.

## [[DATABASE/feat/Attunement Shift|Attunement Shift]] <span class="action-icon">4</span> <span class="item-type">Feat 4</span>

<span class="item-trait">Archetype</span>
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
**Archetype** [[DATABASE/archetype/Geomancer|Geomancer]]
**Frequency** once per 10 minutes
**Prerequisites** [[DATABASE/feat/Geomancer Dedication|Geomancer Dedication]]
**Requirements** Your previous action was to cast a spell with the air, cold, earth, fire, plant, or water trait.

---
The magic of your spell floods into you, overriding your connection to the land around you. You alter your terrain attunement to a terrain that matches a trait of the spell you just cast. You thereby gain your terrain attunement benefit when you cast further spells with the same descriptor, instead of using the terrain you're actually in. For instance, if you cast [[DATABASE/spell/Tanglefoot|tanglefoot]], your terrain attunement switches to your choice of forest or swamp, and your terrain attunement applies when you cast another plant spell.
 Your terrain attunement reverts to that of the terrain you're in 1 minute after you use Attunement Shift.

## [[DATABASE/feat/Shared Attunement|Shared Attunement]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Rough Terrain Stance|Rough Terrain Stance]] <span class="action-icon">1</span> <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Attuned Stride|Attuned Stride]] <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Draw from the Land|Draw from the Land]] <span class="action-icon">1</span> <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/Read the Land|Read the Land]] <span class="item-type">Feat 12</span>
...
---
You've learned how to commune with the land to learn information. You learn the [[DATABASE/ritual/Commune with Nature|commune with nature]] ritual if you didn't know it already. You can perform this ritual with a casting time of 1 hour instead of 1 day and without a secondary caster.

## [[DATABASE/feat/Shifting Terrain|Shifting Terrain]] <span class="action-icon">1</span> <span class="item-type">Feat 14</span>

<span class="item-trait">Archetype</span>
**Source** [[DATABASE/source/Secrets of Magic|Secrets of Magic]] 
**Archetype** [[DATABASE/archetype/Geomancer|Geomancer]]
**Prerequisites** [[DATABASE/feat/Rough Terrain Stance|Rough Terrain Stance]]; master in [[DATABASE/skill/Nature|Nature]]
...
**Critical Failure** The creature is clumsy 2 for 1 round and falls [[DATABASE/condition/Prone|prone]].

## [[DATABASE/feat/Terrain Shield|Terrain Shield]] <span class="item-type">Feat 14</span>
...
## [[DATABASE/feat/Quickened Attunement|Quickened Attunement]] <span class="action-icon">4</span> <span class="item-type">Feat 16</span>
