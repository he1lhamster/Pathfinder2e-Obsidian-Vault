...
## [[DATABASE/feat/Wrestler Dedication|Wrestler Dedication]] <span class="item-type">Feat 2</span>

<span class="item-trait">Archetype</span><span class="item-trait">Dedication</span>
**Source** [[DATABASE/source/Grand Bazaar|Grand Bazaar]]
**Archetype** [[DATABASE/archetype/Wrestler|Wrestler]]
**Prerequisites** trained in [[DATABASE/skill/Athletics|Athletics]]; trained in unarmed attacks, and unarmored defense

---
Your training in the wrestling arts has made you particularly adept at moving, striking, and grappling while unencumbered. You become an expert in Athletics and gain the [[DATABASE/feat/Titan Wrestler|Titan Wrestler]] skill feat. You don't take the –2 circumstance penalty for making a lethal attack with your nonlethal unarmed attacks. In addition, you gain a +2 circumstance bonus to your Fortitude DC when resisting an opponent's attempts to [[DATABASE/action/Grapple|Grapple]] you or [[DATABASE/monsterability/Swallow Whole|Swallow you Whole]].
**Special** You can't select another dedication feat until you have gained two other feats from the wrestler archetype.

## [[DATABASE/feat/Combat Grab|Combat Grab]] <span class="action-icon">1</span> <span class="item-type">Feat 4*</span>
...
* This version of the Combat Grab feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Combat Grab|original feat]].

---
You swipe at your opponent and grab at them. Make a melee Strike while keeping one hand free. If the Strike hits, you grab the target using your free hand. The creature remains [[DATABASE/condition/Grabbed|grabbed]] until the end of your next turn or until it [[DATABASE/action/Escape|Escapes]], whichever comes first.

## [[DATABASE/feat/Crushing Grab|Crushing Grab]] <span class="item-type">Feat 4*</span>

<span class="item-trait">Monk</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Archetypes** [[DATABASE/archetype/Wrestler|Wrestler]], [[DATABASE/archetype/Zombie|Zombie]]
* This version of the Crushing Grab feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Crushing Grab|original feat]].
...
## [[DATABASE/feat/Disengaging Twist|Disengaging Twist]] <span class="action-icon">5</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Elbow Breaker|Elbow Breaker]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>

<span class="item-trait">Archetype</span>
**Source** [[DATABASE/source/Grand Bazaar|Grand Bazaar]]
**Archetype** [[DATABASE/archetype/Wrestler|Wrestler]]
**Prerequisites** [[DATABASE/feat/Wrestler Dedication|Wrestler Dedication]]
**Requirements** You have a creature [[DATABASE/condition/Grabbed|grabbed]] or [[DATABASE/condition/Restrained|restrained]].
...
**Success** You weaken your opponent's grasp on one held item. Until the start of that creature's turn, attempts to [[DATABASE/action/Disarm|Disarm]] the opponent of that item gain a +2 circumstance bonus, and the target takes a –2 circumstance penalty to attacks with the item or other checks requiring a firm grasp on the item.

## [[DATABASE/feat/Snagging Strike|Snagging Strike]] <span class="action-icon">1</span> <span class="item-type">Feat 4*</span>

<span class="item-trait">Fighter</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Archetype** [[DATABASE/archetype/Wrestler|Wrestler]]
**Requirements** You have one hand free, and your target is within reach of that hand.
* This version of the Snagging Strike feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Snagging Strike|original feat]].
...
## [[DATABASE/feat/Suplex|Suplex]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Running Tackle|Running Tackle]] <span class="action-icon">2</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Strangle|Strangle]] <span class="action-icon">1</span> <span class="item-type">Feat 8</span>
...
---
Your iron grip slowly saps your opponent's strength. Attempt an [[DATABASE/skill/Athletics|Athletics]] check to [[DATABASE/action/Grapple|Grapple]] the creature you have grabbed or restrained, with the following effects instead of the usual effects.
**Critical Success** The target is [[DATABASE/condition/Enfeebled|enfeebled 2]] until the end of its next turn and enfeebled 1 for 1 minute.
**Success** The target is enfeebled 1 until the end of its next turn.

## [[DATABASE/feat/Whirling Throw|Whirling Throw]] <span class="action-icon">1</span> <span class="item-type">Feat 8*</span>

<span class="item-trait">Monk</span>
**Source** [[DATABASE/source/Core Rulebook|Core Rulebook]] 
**Archetype** [[DATABASE/archetype/Wrestler|Wrestler]]
**Requirements** You have a creature grabbed or restrained.
* This version of the Whirling Throw feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Whirling Throw|original feat]].
...
## [[DATABASE/feat/Aerial Piledriver|Aerial Piledriver]] <span class="action-icon">2</span> <span class="item-type">Feat 10</span>
...
**Success** The target lands [[DATABASE/condition/Prone|prone]].
...
## [[DATABASE/feat/Spinebreaker|Spinebreaker]] <span class="action-icon">1</span> <span class="item-type">Feat 10</span>
...
---
You squeeze your opponent in a vicious bear hug, putting intense pressure on their nerves, joints, or other pain points. Attempt an [[DATABASE/skill/Athletics|Athletics]] check to [[DATABASE/action/Grapple|Grapple]] the creature you have grabbed or restrained, with the following effects instead of the usual effects.
**Critical Success** The target is [[DATABASE/condition/Clumsy|clumsy 2]] until the end of its next turn and clumsy 1 for 1 minute.
**Success** The target is clumsy 1 until the end of its next turn.

## [[DATABASE/feat/Inescapable Grasp|Inescapable Grasp]] <span class="item-type">Feat 12</span>
