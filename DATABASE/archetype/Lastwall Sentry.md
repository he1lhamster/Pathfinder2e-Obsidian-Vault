...
## [[DATABASE/feat/Lastwall Sentry Dedication|Lastwall Sentry Dedication]] <span class="item-type">Feat 2</span>
...
**Prerequisites** member of the Knights of Lastwall; [[DATABASE/feat/Shield Block|Shield Block]]
**Access** You are from the Eye of Dread region.

---
You’ve sworn yourself as a sentry for the Knights of Lastwall, the first line of defense against incursions by the Whispering Tyrant throughout Golarion. You become trained in [[DATABASE/skill/Athletics|Athletics]] and in Undead [[DATABASE/skill/Lore|Lore]]; if you were already trained, you become an expert instead. Finally, you gain the [[DATABASE/feat/Reactive Shield|Reactive Shield]] fighter feat.
...
## [[DATABASE/feat/Always Ready|Always Ready]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Bless Shield|Bless Shield]] <span class="action-icon">1</span> <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Eye of Ozem|Eye of Ozem]] <span class="item-type">Feat 4</span>

<span class="item-trait">Archetype</span>
**Source** [[DATABASE/source/World Guide|World Guide]] 
**Archetype** [[DATABASE/archetype/Lastwall Sentry|Lastwall Sentry]]
**Prerequisites** [[DATABASE/feat/Lastwall Sentry Dedication|Lastwall Sentry Dedication]]; expert in Perception
...
## [[DATABASE/feat/Familiar Foe|Familiar Foe]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Final Rest|Final Rest]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Necromantic Resistance|Necromantic Resistance]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Nonlethal Takedown|Nonlethal Takedown]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Rescuer's Press|Rescuer's Press]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Grave Sense|Grave Sense]] <span class="item-type">Feat 6</span>
...
---
You've battled more undead than you care to remember, often with little time to prepare between foes, forcing you to rely on experience and muscle memory to guide your blade. Attempt a check to [[DATABASE/action/Recall Knowledge|Recall Knowledge]] about an undead you can see and then Strike that undead. If your attempt to Recall Knowledge is successful, your Strike treats the target's resistances as 5 lower. The target is then immune to your Practiced Opposition for 24 hours.

## [[DATABASE/feat/Repulse the Wicken|Repulse the Wicken]] <span class="action-icon">5</span> <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Sacred Armaments|Sacred Armaments]] <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Flashing Shield|Flashing Shield]] <span class="action-icon">4</span> <span class="item-type">Feat 8</span>
...
---
Your shield flares with holy light as you block the attack, searing the undead with the power of your faith. The triggering undead takes positive damage equal to half your level and becomes [[DATABASE/condition/Flat-Footed|flat-footed]] for 1 round.

## [[DATABASE/feat/Necromantic Bulwark|Necromantic Bulwark]] <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Necromantic Tenacity|Necromantic Tenacity]] <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Grave Sight|Grave Sight]] <span class="item-type">Feat 10</span>

<span class="item-trait">Archetype</span>
**Source** [[DATABASE/source/Knights of Lastwall|Knights of Lastwall]]
**Archetype** [[DATABASE/archetype/Lastwall Sentry|Lastwall Sentry]]
**Prerequisites** [[DATABASE/feat/Lastwall Sentry Dedication|Lastwall Sentry Dedication]]; [[DATABASE/feat/Grave Sense|Grave Sense]]

---
Your ability to sense undead has improved. You sense undead as an imprecise sense with a range of 60 feet: an uncomfortable sensation brushes against your spirit and stinks of rot. When in proximity to an undead, you can sense its presence, but it has the [[DATABASE/condition/Hidden|hidden]] condition instead of the [[DATABASE/condition/Observed|observed]] condition. An undead using a disguise or otherwise trying to hide its presence must attempt a [[DATABASE/skill/Deception|Deception]] or [[DATABASE/skill/Stealth|Stealth]] check against your Perception DC to hide its presence from you. If the creature succeeds, it's [[DATABASE/condition/Undetected|undetected]], and you have to use the [[DATABASE/action/Seek|Seek]] basic action to detect the creature. As with hearing and other imprecise senses, you still need to Seek to locate an undetected creature.

## [[DATABASE/feat/Lastwall Warden|Lastwall Warden]] <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/No Stranger to Death|No Stranger to Death]] <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Resolute Defender|Resolute Defender]] <span class="item-type">Feat 14</span>
...
## [[DATABASE/feat/Thwart Evil|Thwart Evil]] <span class="action-icon">5</span> <span class="item-type">Feat 14</span>
...
## [[DATABASE/feat/Withstand Death|Withstand Death]] <span class="item-type">Feat 16</span>
