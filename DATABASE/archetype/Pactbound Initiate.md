...
## [[DATABASE/feat/Pactbound Dedication|Pactbound Dedication]] <span class="item-type">Feat 2</span>
...
**Prerequisites** [[DATABASE/language/Erutaki|Erutaki]] or [[DATABASE/language/Jotun|Giant]] language, must have earned the trust of a saumen kar who initiates you into the archetype; trained in [[DATABASE/skill/Nature|Nature]]

---
You befriended one of the last saumen kar and were infused with a fraction of their power, granting you the potential to become a guardian of their ancient pact. You gain cold resistance equal to half your level. You can [[DATABASE/action/Hide|Hide]] and [[DATABASE/action/Sneak|Sneak]] while it's snowing even lightly, even if it wouldn't be thick enough to normally grant [[DATABASE/condition/Concealed|concealment]]. Finally, all saumen kar can sense the mark of their pact upon you, and their attitude toward you is typically one step better than it would be otherwise ([[DATABASE/condition/Hostile|hostile]] to [[DATABASE/condition/Unfriendly|unfriendly]], unfriendly to [[DATABASE/condition/Indifferent|indifferent]], etc.) Most saumen kar are unfriendly to outsiders; this would make them indifferent to you.
...
## [[DATABASE/feat/Ice Crafter|Ice Crafter]] <span class="item-type">Feat 4</span>
...
---
The ancient ice-crafting techniques of the saumen kar awaken within you. You become trained in [[DATABASE/skill/Crafting|Crafting]], or become an expert if you were already trained. You gain the [[DATABASE/feat/Magical Crafting|Magical Crafting]] skill feat. You can craft permanent items out of ice instead of metal or wood; these items are a translucent crystal-blue in color, resemble icicles and glacier ice, and have the same statistics and properties as [[DATABASE/equipment/Cold Iron|cold iron]], including the price and the ability to deal additional damage to certain kinds of creatures.
...
## [[DATABASE/feat/Crown of the Saumen Kar|Crown of the Saumen Kar]] <span class="item-type">Feat 6</span>
...
---
Your body begins to evolve and adapt, taking the first steps towards blending your very self with the ancient curse of the saumen kar. You become larger and bulkier, pushing the very edge of height and weight for your size. You gain scent as an imprecise sense with a range of 30 feet and gain a +1 circumstance bonus to [[DATABASE/skill/Stealth|Stealth]] checks made to [[DATABASE/action/Sneak|Sneak]] or [[DATABASE/action/Hide|Hide]] in areas of forest and snow. You sprout a pair of horns from your forehead, gaining a horns unarmed attack that deals 1d8 bludgeoning damage. Your horns are in the [[DATABASE/weapongroup/Brawling|brawling]] group and have the shove and trip traits.

## [[DATABASE/feat/Frostbite Runes|Frostbite Runes]] <span class="item-type">Feat 12</span>
...
## [[DATABASE/feat/Curse of the Saumen Kar|Curse of the Saumen Kar]] <span class="action-icon">2</span> <span class="item-type">Feat 14</span>
...
## [[DATABASE/feat/Bound in Ice|Bound in Ice]] <span class="item-type">Feat 16</span>
