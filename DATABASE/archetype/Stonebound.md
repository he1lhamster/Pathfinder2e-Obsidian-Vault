...
---
Your body becomes infused with elemental earth. You gain the [[DATABASE/feat/Adopted Ancestry|Adopted Ancestry]] feat and gain a 1st level oread ancestry feat as a bonus feat, ignoring the limitations of the lineage trait. When you gain new ancestry feats, you can select oread feats in addition to feats allowed by your ancestry and heritage.

## [[DATABASE/feat/Stone Guardian|Stone Guardian]] <span class="item-type">Feat 4</span>
...
---
Your blood becomes thick and sluggish, but no less effective at oxygenating your cells. You can selectively stop your bleeding with ease. Reduce the DC of flat checks to stop [[DATABASE/condition/Persistent Damage|persistent bleed damage]] from 15 to 10, and you can use a single action that has the concentrate trait to gain an early flat check without physically binding the wounds. You recover from the [[DATABASE/condition/Drained|drained]] condition twice as quickly as normal.

## [[DATABASE/feat/Stonebound Magic|Stonebound Magic]] <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Statue|Statue]] <span class="action-icon">1</span> <span class="item-type">Feat 8</span>
...
---
Your body and equipment appear to be made of stone as you hold perfectly still. Until the next time you act, you appear to be a statue and do not need to eat, drink, or breathe, but you are [[DATABASE/condition/Flat-Footed|flat-footed]]. Your [[DATABASE/skill/Deception|Deception]] DC to pass as a statue is equal to 10 + your proficiency bonus (do not apply any other bonuses, penalties, or modifiers).

## [[DATABASE/feat/Rocky Flesh|Rocky Flesh]] <span class="item-type">Feat 10</span>
...
---
Your flesh takes on the hardness of stone. You gain resistance to physical damage (except [[DATABASE/equipment/Adamantine Weapon|adamantine]]) equal to your number of class feats from the Stonebound archetype.

## [[DATABASE/feat/Living Stone|Living Stone]] <span class="item-type">Feat 12</span>
