...
## [[DATABASE/feat/Linguist Dedication|Linguist Dedication]] <span class="item-type">Feat 2</span>
...
---
You have studied languages and their development. You become trained in [[DATABASE/skill/Society|Society]]; if you were already trained in Society, you instead become an expert in Society. You gain the [[DATABASE/feat/Multilingual|Multilingual]] skill feat twice.
**Special** You can't select another dedication feat until you have gained two other feats from the linguist archetype.

## [[DATABASE/feat/Multilingual Cipher|Multilingual Cipher]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Phonetic Training|Phonetic Training]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Spot Translate|Spot Translate]] <span class="action-icon">5</span> <span class="item-type">Feat 4</span>

<span class="item-trait">Archetype</span><span class="item-trait">Auditory</span><span class="item-trait">Linguistic</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Linguist|Linguist]]
**Prerequisites** [[DATABASE/feat/Linguist Dedication|Linguist Dedication]]
...
## [[DATABASE/feat/Analyze Idiolect|Analyze Idiolect]] <span class="item-type">Feat 6</span>

<span class="item-trait">Archetype</span><span class="item-trait">Skill</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Linguist|Linguist]]
**Prerequisites** [[DATABASE/feat/Linguist Dedication|Linguist Dedication]]; expert in [[DATABASE/skill/Deception|Deception]] and [[DATABASE/skill/Society|Society]]

---
You break down a specific individual's idiolect, memorizing their speech mannerisms and habits. If you interact with someone for at least 10 minutes, when you later attempt to [[DATABASE/action/Impersonate|Impersonate]] that individual, you gain a +4 circumstance bonus to your Deception checks and DCs. Due to the intense character study required, you can't remember more than one idiolect at a time.

## [[DATABASE/feat/Read Shibboleths|Read Shibboleths]] <span class="item-type">Feat 7</span>
...
## [[DATABASE/feat/Crude Communication|Crude Communication]] <span class="item-type">Feat 8</span>
