...
## [[DATABASE/feat/Sentinel Dedication|Sentinel Dedication]] <span class="item-type">Feat 2</span>
...
## [[DATABASE/feat/Steel Skin|Steel Skin]] <span class="item-type">Feat 4</span>
...
## [[DATABASE/feat/Armor Specialist|Armor Specialist]] <span class="item-type">Feat 6</span>
...
## [[DATABASE/feat/Armored Rebuff|Armored Rebuff]] <span class="action-icon">5</span> <span class="item-type">Feat 8</span>
...
## [[DATABASE/feat/Mighty Bulwark|Mighty Bulwark]] <span class="item-type">Feat 10</span>
...
## [[DATABASE/feat/Sacrifice Armor|Sacrifice Armor]] <span class="action-icon">5</span> <span class="item-type">Feat 10*</span>

<span class="item-trait">Champion</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Sentinel|Sentinel]]
**Trigger** You are hit by a Strike that deals physical damage.
* This version of the Sacrifice Armor feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Sacrifice Armor|original feat]].
...
## [[DATABASE/feat/Greater Interpose|Greater Interpose]] <span class="item-type">Feat 16*</span>

<span class="item-trait">Champion</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
**Archetype** [[DATABASE/archetype/Sentinel|Sentinel]]
**Prerequisites** [[DATABASE/feat/Sacrifice Armor|Sacrifice Armor]]
* This version of the Greater Interpose feat is intended for use with an Archetype and has a different level for access than the [[DATABASE/feat/Greater Interpose|original feat]].
