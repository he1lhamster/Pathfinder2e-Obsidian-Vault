...
[[DATABASE/monster/Vetalarana Emergent|Vetalarana Emergent]] (Creature 8), [[DATABASE/monster/Vetalarana Manipulator|Vetalarana Manipulator]] (Creature 11)
...
* It gains the undead and [[DATABASE/monsterfamily/Vampire|vampire]] traits, and usually becomes evil.
...
* The vetalarana gains fast healing, resistance to mental damage, and resistance to physical damage (except [[DATABASE/equipment/Cold Iron Weapon|cold iron]]) as indicated on the table. These abilities are the reason the vetalarana has less HP.
 ...
 **Resistances** The vetalarana manipulator resists mental damage and all physical damage (except magical [[DATABASE/equipment/Cold Iron Weapon|cold iron]]).
 ...
 **Drain Thoughts** <span class="action-icon">1</span> (divination, mental, occult) As a basic vetalarana, but the vetalarana manipulator can choose to alter, enhance, or erase the memory they view as a 4th-level [[DATABASE/spell/Modify Memory|modify memory]] spell. If the vetalarana gets a critical success on their Athletics check to Drain Thoughts, the target is stupefied 2 instead of stupefied 1.
 **Occult Innate Spells** A vetalarana manipulator has [[DATABASE/spell/Tongues|tongues]] as a constant occult innate spell.
 **Paralyzing Claws** (incapacitation, occult, necromancy) Any living creature hit by a vetalarana manipulator's claw Strike must succeed at a Fortitude save or become [[DATABASE/condition/Paralyzed|paralyzed]]. The target can attempt a new save at the end of each of its turns to end the effect, and the DC cumulatively decreases by 1 on each such save. Use the moderate DC for the creature's level on the Spell DC and Spell Attack Bonus table.
...
Canny mortals looking to thwart a vetalarana make heavy use of [[DATABASE/equipment/Cold Iron|cold iron]]. They line their sanctuaries with the material or surround comatose victims in cold iron sheets, armor, or shields. Others weave shrouds of cold iron thread or mix cold iron dust into paints and oils—though the efficacy of the latter is debatable.

## Vampire

**Related Groups** [[DATABASE/monsterfamily/Vampire|Vampire]], [[DATABASE/monsterfamily/Vampire, Jiang-Shi|Vampire, Jiang-Shi]], [[DATABASE/monsterfamily/Vampire, Nosferatu|Vampire, Nosferatu]], [[DATABASE/monsterfamily/Vampire, Strigoi|Vampire, Strigoi]], [[DATABASE/monsterfamily/Vampire, Vrykolakas|Vampire, Vrykolakas]]
