...
[[DATABASE/monster/Augur|Augur]] (Creature 1), [[DATABASE/monster/Ephialtes|Ephialtes]] (Creature 16), [[DATABASE/monster/Eremite|Eremite]] (Creature 20), [[DATABASE/monster/Evangelist|Evangelist]] (Creature 6), [[DATABASE/monster/Interlocutor|Interlocutor]] (Creature 12), [[DATABASE/monster/Ostiarius|Ostiarius]] (Creature 5), [[DATABASE/monster/Precentor|Precentor]] (Creature 16), [[DATABASE/monster/Sacristan|Sacristan]] (Creature 10), [[DATABASE/monster/Vincuvicar|Vincuvicar]] (Creature 18)
...
Velstracs originated with the first debased thoughts of mortals, which divine beings found so deplorable that they locked all velstracs away in [[DATABASE/plane/Hell|Hell]]. It wasn't long, however, before the newly formed beings escaped their infernal prison to the [[DATABASE/plane/Shadow Plane|Shadow Plane]].
...
Velstracs are most often encountered in the shadowy realm of Nidal, where the state worship of [[DATABASE/deity/Zon-Kuthon|Zon-Kuthon]] is rigidly enforced. Indeed, many velstracs are created from the souls of Joyful Things, devotees of Zon-Kuthon who have had their limbs amputated to focus their minds on the veneration of pain, sacrifice, and torment.