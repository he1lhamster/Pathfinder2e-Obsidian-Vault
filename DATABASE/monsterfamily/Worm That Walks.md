...
[[DATABASE/monster/Worm That Walks|Worm That Walks Cultist]] (Creature 14)
...
| 0 | 1 | 2 |
|:---------------|:------------|:---------------------------------------|
| Starting Level | HP Decrease | Fast Healing, Resistance, and Weakness |
| 4 or less | -20 | 5 |
| 5-7 | -30 | 7 |
| 8-14 | -40 | 10 |
| 15 or higher | -60 | 15 |
...
**Immunities** All worms that walk have immunity to disease, paralyzed, poison, precision, and unconscious. They also have the [[DATABASE/monsterability/Swarm Mind|swarm mind]] ability, which makes them immune to mental effects that target a specific number of creatures, though they are still subject to mental effects that affect all creatures in an area. 
...
* **Cockroaches**: A worm that walks made of cockroaches gains a +1 bonus to AC and [[DATABASE/monsterability/Light Blindness|light blindness]].
