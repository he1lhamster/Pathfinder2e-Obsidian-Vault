...
[[DATABASE/npc/Beggar|Beggar]] (Creature -1), [[DATABASE/npc/Commoner|Commoner]] (Creature -1), [[DATABASE/npc/Prisoner|Prisoner]] (Creature 1), [[DATABASE/npc/Urchin|Urchin]] (Creature -1)

###  Braving The Mob

A mob is a violent crowd that works as greater difficult terrain and hazardous terrain, dealing 1d4 damage for each square entered. A creature can spend a single action to attempt a DC 16 [[DATABASE/skill/Intimidation|Intimidation]] check, clearing the mob from all squares adjacent to them on a success (or all squares within 10 feet on a critical success). This action has the concentrate, emotion, manipulate, and mental traits.

###  Word On The Street

Privy to all sorts of conversations from passersby, the downtrodden can provide eyes and ears on the street. Finding a reliable contact can give a character a circumstance bonus to checks to [[DATABASE/action/Gather Information|Gather Information]] if they return to that source. This bonus is usually +1, but could be +2 or +3 if the contact lingers in a market where influential politicians shop, sweeps a noble estate, or the like.
