...
**Failure** The creature takes full damage and becomes temporarily cursed by the patron deity. The creature becomes [[Enfeebled]] and [[Stupefied]] for 1 day; this is a curse effect that uses the Will save DC as the counteract DC. 
...
**Faithful Weapon** A divine warden always wields its patron deity's favored weapon. If the weapon is a ranged weapon, the divine warden automatically generates new ammunition with each attack. For a divine warden of 4th level or higher, the deity's favored weapon gains the effects of a [[Striking]] rune while the divine warden wields it; at 12th level, these effects are of a _greater striking_ rune, and at 19th level, they're instead of a _major striking_ rune. 
