...
**Source** [[DATABASE/source/Kingmaker Adventure Path|Kingmaker Adventure Path]]
A fetch is a twisted, deviant simulacrum of a humanoid creature that exists or existed at one point on the [[DATABASE/plane/Material Plane|Material Plane]]. Rumors of fetches that are reflections of entities from other planes persist, but none of these tales speak of fetches that duplicate anything other than a sapient source. A fetch can manifest spontaneously when a powerful creature undergoes a significant emotional event or dies, either while on the [[DATABASE/plane/First World|First World]] or while in an area significantly influenced by the First World, but one can also be created by significant forces like the Eldest in order to torment and vex those who have annoyed them. While a fetch manifests from a soul's “reflection,” and as such bears a striking resemblance to that creature's appearance in life, a fetch has no true memories of its own. It keeps fragments of false remembrances from its source as if it experienced them in a half-remembered dream—which ensure the fetch is enraged by and jealous of its source.
...
[[DATABASE/monster/Fetch Behemoth|Fetch Behemoth]] (Creature 20), [[DATABASE/monster/Fetch Stalker|Fetch Stalker]] (Creature 18), [[DATABASE/monster/Risen Fetch|Risen Fetch]] (Creature 22)
