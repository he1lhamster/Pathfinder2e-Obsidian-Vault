...
Xiomorns have mastered the creation of numerous magic items made of crystal beyond generation stones and vault seeds. These include pillars of black stone called _whisperstones_ that allow xiomorns to communicate telepathically across vaults, _orvgates_ that use weblike funnels of green crystal to allow teleportation between Darklands vaults, and a vortex in Orv called the _Crystal Womb_ that connects to a crucial stronghold on the [[Plane of Earth]].
