...
[[DATABASE/monster/Aapoph Serpentfolk|Aapoph Serpentfolk]] (Creature 3), [[DATABASE/monster/Bone Prophet|Bone Prophet]] (Creature 8), [[DATABASE/monster/Coil Spy|Coil Spy]] (Creature 4), [[DATABASE/monster/Serpentfolk Granitescale|Serpentfolk Granitescale]] (Creature 6), [[DATABASE/monster/Venom Caller|Serpentfolk Venom Caller]] (Creature 7), [[DATABASE/monster/Zyss Serpentfolk|Zyss Serpentfolk]] (Creature 2)
...
Some serpentfolk might have entirely different innate spells. These alternative spells are typically illusions, enchantments, or divinations like [[DATABASE/spell/Dream Message|dream message]], [[DATABASE/spell/Enthrall|enthrall]], [[DATABASE/spell/Glibness|glibness]], [[DATABASE/spell/Invisibility|invisibility]], [[DATABASE/spell/Mindlink|mindlink]], [[DATABASE/spell/Mind Probe|mind probe]], [[DATABASE/spell/Mind Reading|mind reading]], [[DATABASE/spell/Mislead|mislead]], [[DATABASE/spell/Phantom Pain|phantom pain]], or [[DATABASE/spell/Zealous Conviction|zealous conviction]]. [[DATABASE/monster/Aapoph Serpentfolk|Aapoph serpentfolk]] lack innate spells.

###  the Headless King

[[DATABASE/deity/Ydersius|Ydersius]] was defeated by an Azlanti heroine named Savith in the era before Earthfall, and now the so-called Headless King's body prowls aimlessly in the Darklands. That the decapitated god's clerics still gain power from worship points to Ydersius's tenacity and continued existence, after a fashion. Those who seek to recover his skull and return it to his body hope that doing so will restore both him and the sekmin civilization to their full power.
