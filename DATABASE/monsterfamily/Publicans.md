...
Bar fights work better without a grid. Use the stat blocks here or in the [[Downtrodden]] section for notable participants, everyone else attacking nonlethally with fists or improvised weapons. Roll one or two attacks at the end of each round against each PC in the fight (+4 attack modifier, 1d4+2 bludgeoning damage). Alcohol rules can be found [[Alcohol]]
