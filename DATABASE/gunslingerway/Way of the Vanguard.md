...
**Slinger's Reload** [[DATABASE/action/Clear a Path|Clear a Path]]
**Deeds** _Initial_ [[DATABASE/action/Living Fortification|Living Fortification]]; _Advanced_ [[DATABASE/action/Spinning Crush|Spinning Crush]]; _Greater_ [[DATABASE/action/Siegebreaker|Siegebreaker]]
**Way Skill** [[DATABASE/skill/Athletics|Athletics]]

## Slinger's Reload

### [[DATABASE/action/Clear a Path|Clear a Path]] <span class="action-icon">1</span>
...
### [[DATABASE/action/Spinning Crush|Spinning Crush]] <span class="action-icon">3</span>
