...
You're trained in the [[DATABASE/skill/Nature|Nature]] skill, and a [[DATABASE/skill/Lore|Lore]] skill associated with a particular type of wilderness (choose from forest, hills, mountains, plains, rivers, or swamp). You gain the [[DATABASE/feat/Train Animal|Train Animal]] skill feat.