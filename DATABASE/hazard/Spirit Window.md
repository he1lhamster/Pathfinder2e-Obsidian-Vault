...
**Siphon Soul** <span class="action-icon">5</span> (evil, necromancy, negative, occult) **Trigger** A creature touches the window; **Effect** The triggering creature takes 8d10+44 negative damage (DC 42 basic Will save) as the window attempts to steal their soul. If this damage would kill the target, its soul is trapped inside the window with the effects of [[Bind Soul]].
