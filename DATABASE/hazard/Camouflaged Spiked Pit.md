...
**Spiked Pitall** <span class="action-icon">5</span> **Trigger** A creature walks onto one of the pits; **Effect** The triggering creature falls and rolls through several spikes as it slides to the bottom. This inflicts 5 bludgeoning damage from the fall itself down the steep slope (the falling PC can't attempt to [[DATABASE/action/Grab an Edge|Grab an Edge]] due to the lack of defined edges to the pit's walls), but the falling PC must also attempt a DC 26 Reflex save.
...
**Critical Failure** The character takes 4d10+22 piercing damage from the spikes plus 2d6 [[DATABASE/condition/Persistent Damage|bleed]]damage. While the character is taking this bleed damage, they are also sickened 2 from the pain.
