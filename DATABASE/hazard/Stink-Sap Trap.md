...
---
**Disable** DC 15 [[DATABASE/skill/Thievery|Thievery]] (trained) to clog the nozzle or DC 14 [[DATABASE/skill/Athletics|Athletics]] (trained) to redirect the stream away from the path; the Athletics check can be made at a distance with a thrown object, but a critical failure triggers the trap's Sudden Spray.
**AC** 13, **Fort** +8, **Ref** +5
