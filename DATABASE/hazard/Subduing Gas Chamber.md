...
---
**Disable** DC 26 [[DATABASE/skill/Thievery|Thievery]] (Trained) to disconnect the wire to the counterweight, preventing it from falling, or DC 20 [[DATABASE/skill/Crafting|Crafting]] ([[DATABASE/feat/Alchemical Crafting|Alchemical Crafting]]) to create a counteragent to the sleeping gas
**AC** 10, **Fort** +15, **Ref** +9
 ...
 **Sleeping Gas** (inhaled, poison) **Saving Throw** DC 22 Fortitude; **Maximum Duration** 4 hours; **Stage 1** slowed 1 (1 round); **Stage 2** [[DATABASE/condition/Unconscious|unconscious]] with no Perception check to wake up (1 round); **Stage 3** unconscious with no Perception check to wake up (1 hour)
