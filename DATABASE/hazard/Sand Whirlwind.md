...
---
**Disable** DC 38 Religion (expert) to state an [[DATABASE/deity/Irori|Iroran]] koan about being complete only upon recognizing one's incompleteness, or DC 41 [[DATABASE/skill/Occultism|Occultism]] (master) to create a ward against future hauntings
...
**Failure** The creature is pulled back 15 feet into the room and is [[DATABASE/condition/Blinded|blinded]] for 1 round.
**Critical Failure** The creature is pulled back 15 feet into the room and is blinded for 1 minute.

---
**Routine** (1 action) The haunt's violent winds savagely buffet everyone in the room, dealing 6d10+30 bludgeoning damage to living creatures (DC 34 basic Reflex save). On a critically failed save, a creature is also [[DATABASE/condition/Blinded|blinded]] for 1 minute.

---
**Reset** The haunt deactivates after 1 minute and re-forms after 1 hour. The haunt is disabled and doesn't re-form if at least two creatures spend 1 minute to create an image with the sand. Creating the image requires a successful DC 30 [[DATABASE/skill/Crafting|Crafting]] or [[DATABASE/skill/Thievery|Thievery]] check.