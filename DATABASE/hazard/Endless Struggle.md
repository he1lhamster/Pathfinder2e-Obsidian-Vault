...
**HP** 66, negative healing; **Immunities** critical hits, precision damage, **Weaknesses** positive 10, **Resistances** all 10 (except force, [[DATABASE/equipment/Ghost Touch|ghost touch]], or positive; double resistance vs. non-magical)
**Spectral Uprising** <span class="action-icon">5</span> **Trigger** More than three Small or larger living creatures are in area **B7** at the end of a turn. **Effect** Spectral figures of the bandits and owlbears manifest in a sudden and overwhelming battle of endless violence. All living creatures in area **B7** must make a successful DC 28 Will save or become [[DATABASE/condition/Frightened|frightened]] 1 (frightened 3 on a critical failure).
