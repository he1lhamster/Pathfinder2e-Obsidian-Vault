...
---
**Routine** (8 actions) This trap loses 2 actions each turn for each disabled shadow lash. Each shadow lash has 2 actions it can use to perform the following actions.
 **Melee** <span class="action-icon">1</span> lash +41 (reach 20 feet), **Damage** 4d10+22 slashing
 **Long-Range Lash** <span class="action-icon">2</span> The lash lengthens, increasing its reach to 60 feet, and makes a lash Strike. The lash's length then reverts to normal.