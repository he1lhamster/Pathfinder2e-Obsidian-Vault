...
**Slam Doors** <span class="action-icon">5</span> (arcane, [[Cat]]) **Trigger** A second creature crosses a magical sensor at the midpoint of the hall. 
The doors at either end of the hall slam shut and lock in place while the trap is active (the doors open automatically if the trap is disabled or destroyed). The doors (Hardness 14, HP 56 [28 BT]) can be [[Force Open]] with a DC 40 Athletics check, or via a DC 35 Thievery check to [[Pick a Lock]]. The trap rolls initiative.
