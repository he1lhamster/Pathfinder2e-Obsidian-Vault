...
---
**Disable** three DC 39 [[Athletics]] (trained), [[Crafting]] (trained), or [[Lore]] (trained) checks to brace a small structure or surface to cancel the effects of the quake in that area; DC 41 [[Performance]] (legendary) to calm Mogaru momentarily
**Quake** <span class="action-icon">5</span> **Trigger** Mogaru moves at least 60 feet; **Effect** The ground shakes in a 120-foot emanation from Mogaru's space. This creates a variety of effects, depending on where the player characters are at the time of the quake.
 In most parts of the city, the ground becomes difficult terrain, and creatures on it are [[Clumsy]] for 1 round.
