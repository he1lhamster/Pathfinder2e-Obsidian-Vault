...
---
**Disable** DC 43 [[DATABASE/skill/Thievery|Thievery]] (master) to steal the cloth before the spirit manifests, or DC 47 [[DATABASE/skill/Athletics|Athletics]] to pull the cloth off the spirit after it manifests
**AC** 40, **Fort** +26, **Ref** +32, **Will** +35
**Spirit HP** 230; **Resistances** all damage 20 (except force, [[DATABASE/equipment/Ghost Touch|ghost touch]], or positive; double resistance to non-magical)
**Don Shroud** <span class="action-icon">5</span> (occult) **Trigger** A creature enters the area; **Effect** The spirit steps out of the mirror, wearing the cloth as a shroud and revealing the mirror. The triggering creature is [[DATABASE/condition/Frightened|frightened 3]] unless they succeed at a DC 38 Will save. The haunt then rolls initiative.
