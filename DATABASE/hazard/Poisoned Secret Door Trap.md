...
---
**Disable** DC 34 [[Thievery]] (expert) to break the mechanism, or DC 39 Perception (master) to identify the three stones that, when pressed, prevent the trap from triggering
 ...
 **Purple Worm Venom** (poison) **Saving Throw** DC 34 Fortitude; **Maximum Duration** 6 rounds; **Stage 1** 5d6 poison damage and [[Enfeebled]] (1 round); **Stage 2** 6d6 poison damage and enfeebled 2 (1 round); **Stage 3** 8d6 poison and enfeebled 2 (1 round)
