...
**Explode** <span class="action-icon">5</span> **Trigger** A creature steps on the bottle or the bottle becomes [[Broken]]; **Effect** The bottle explodes, dealing 2d8 fire damage plus 2 [[Persistent Damage]] and 2 fire splash damage to each creature sharing its square (DC 18 basic Reflex save).