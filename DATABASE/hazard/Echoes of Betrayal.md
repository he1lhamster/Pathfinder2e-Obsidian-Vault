...
---
# Echoes of Betrayal<span class="item-type">Hazard 16</span>
...
---
**Disable** [[DATABASE/skill/Religion|Religion]] DC 35 (master) three times to exorcise the spirits or [[DATABASE/skill/Diplomacy|Diplomacy]] DC 39 (expert) three times to talk them down.
**Confuse** <span class="action-icon">5</span> (emotion, fear, illusion, mental, occult) **Trigger** At least three creatures enter area H10. **Effect** The haunt takes control of all creatures in the prison, affecting them with [[DATABASE/spell/Confusion|confusion]] (8th level, DC 37).
 ...
 **Melee** spectral fist +35 (magical, reach 10 feet), **Damage** 5d10 bludgeoning, and the creature must attempt a new DC 37 Will save against _confusion_ if it's not already [[DATABASE/condition/Confused|confused]].
