...
---
**Disable** DC 22 [[DATABASE/skill/Diplomacy|Diplomacy]] (trained) to soothe the restless spirits, or DC 24 [[DATABASE/skill/Religion|Religion]] (trained) to recite a prayer honoring the deceased; two successful checks are required to disable the haunt
...
**Critical Failure** The creature takes full damage and can't shake off the vision; they take 1d8 [[DATABASE/condition/Persistent Damage|persistent bleed damage]] and are [[DATABASE/condition/Frightened|frightened]] 1—believing they're being eaten alive—as long as the bleed damage persists.
