 ...
 **Ash Web Spores** (inhaled, poison) The [[Enfeebled]] condition from ash web remains even after the poison's duration ends. The condition's value reduces by 1 per hour. [[Gug]] are immune to this poison; instead, they have vivid and strange dreams when they sleep after ingesting ash web. **Saving Throw** Fortitude DC 29; **Maximum Duration** 6 rounds; **Stage 1** 2d6 poison damage and enfeebled 1 (1 round); **Stage 2** 4d6 poison damage and enfeebled 2 (1 round); **Stage 3** 6d6 poison and enfeebled 3 (1 round).
