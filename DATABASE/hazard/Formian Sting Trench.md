...
---
**Disable** DC 22 [[DATABASE/skill/Thievery|Thievery]] (trained)
**AC** 18, **Fort** +8, **Ref** +8
**Canvas HP** 30 (BT 15); **Immunities** critical hits, object immunities, precision damage
**Entrench** <span class="action-icon">5</span> (attack) **Trigger** A creature walks onto the canvas; **Effect** The creature falls into the concealed trench and takes falling damage (typically 10 bludgeoning damage). The creature is also gouged by three poisoned stingers as they fall. The creature can use the [[DATABASE/action/Grab an Edge|Grab an Edge]] reaction to avoid falling.
**Melee** <span class="action-icon">1</span> stinger +17, **Damage** 1d8+3 plus formian trench poison
