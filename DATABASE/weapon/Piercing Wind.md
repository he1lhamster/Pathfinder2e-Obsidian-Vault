...
- '[[DATABASE/trait/Fatal Aim|Fatal Aim d10]]'
...
---
Favored by caravan guards who traverse the Mana Wastes, a piercing wind is similar to a [[DATABASE/weapon/Jezail|jezail]], in that you can carry it in one hand as long as the other hand's free, by holding it under one arm. Additionally, it's fitted with an underslung curved blade.

## Melee

<span class="item-trait">Critical Fusion</span><span class="item-trait">Finesse</span><span class="item-trait">Forceful</span><span class="item-trait">Sweep</span>
**Damage** 1d4 S 
**Group** [[DATABASE/weapongroup/Sword|Sword]]

## Ranged

<span class="item-trait">Concussive</span><span class="item-trait">Fatal Aim d10</span>
**Damage** 1d6 P
