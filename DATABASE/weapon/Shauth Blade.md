...
<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Agile</span><span class="item-trait">Deadly d8</span><span class="item-trait">Finesse</span><span class="item-trait">Versatile P</span>
...
---
These strange curved blades are jagged and deadly weapons made from the alchemically strengthened teeth of dead urdefhans. Each weapon is typically named for the [[DATABASE/monsterfamily/Urdefhan|urdefhan]] whose teeth were forged into the weapon, which are often carried (and revered) by that urdefhan's descendants. Magical shauth blades allow an urdefhan wielder to channel their Wicked Bite ability through shauth blade Strikes.
