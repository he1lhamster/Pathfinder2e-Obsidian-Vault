...
---
This elegant weapon is shaped similarly to a [[DATABASE/weapon/Rapier|rapier]] with a pistol down the length of the blade.

## Melee

<span class="item-trait">Critical Fusion</span><span class="item-trait">Deadly d8</span><span class="item-trait">Disarm</span><span class="item-trait">Finesse</span>
**Damage** 1d4 P 
