...
- '[[DATABASE/trait/Fatal Aim|FatalAim d12]]'
...
---
# Jezail<span class="item-type">Item 1</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Concussive</span><span class="item-trait">Fatal Aim d12</span>
**Source** [[DATABASE/source/Guns & Gears|Guns & Gears]]
**Access** The following regions have access to firearms: Alkenstar, Dongun Hold, Tian Xia, Vudra, Arcadia, Ustalav, the Shackles
**Price** 11 gp; **Damage** 1d8 P; **Bulk** 1
**Hands** 1; **Range** 90 ft.; **Reload** 1
...
---
Jezails are simple, efficient long guns developed in Casmaron that typically feature a custom stock and a flintlock firing mechanism. Though lacking the range and stopping power of an [[DATABASE/weapon/Arquebus|arquebus]] or the raw force of a [[DATABASE/weapon/Harmona Gun|harmona gun]], the jezail is an elegant, well-balanced weapon suitable for a variety of combat situations. It's even possible to tuck it under one arm to fire a less accurate attack that uses only one hand.
...
[[DATABASE/equipment/Boastful Hunter|Boastful Hunter]], [[DATABASE/equipment/Iris of the Sky|Iris of the Sky]]