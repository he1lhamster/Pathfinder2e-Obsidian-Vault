...
favored_weapon: '[[DATABASE/deity/Jin Li|Jin Li]]'
hands: '2'
id: '302'
...
<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Backswing</span><span class="item-trait">Disarm</span><span class="item-trait">Monk</span><span class="item-trait">Parry</span>
**Source** [[DATABASE/source/Treasure Vault|Treasure Vault]] 
**Favored Weapon** [[DATABASE/deity/Jin Li|Jin Li]]
**Price** 2 gp; **Damage** 1d8 B; **Bulk** 2
**Hands** 2
**Type** Melee; **Category** Martial; **Group** [[DATABASE/weapongroup/Flail|Flail]]

---
The sansetsukon, also known as a sanjiegun or three-section staff, is made up of three wooden staff segments, each about 14 inches in length. The staff sections are connected by short lengths of cord or chain, similar to [[DATABASE/weapon/Nunchaku|nunchaku]].
