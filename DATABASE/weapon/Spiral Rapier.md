...
<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Disarm</span><span class="item-trait">Finesse</span><span class="item-trait">Parry</span>
**Source** [[DATABASE/source/Grand Bazaar|Grand Bazaar]]
**Access** Characters from Taldor have access to the spiral rapier.
**Price** 5 gp; **Damage** 1d6 P; **Bulk** 1
**Hands** 1
**Type** Melee; **Category** Advanced; **Group** [[DATABASE/weapongroup/Sword|Sword]]

---
An old Taldan dueling weapon from the empire's height, this rapier has a thicker blade than normal, which is shaped into a corkscrew-like spiral well suited to catching enemy weapons.
