...
<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Deadly d10</span><span class="item-trait">Finesse</span><span class="item-trait">Trip</span>
**Source** [[DATABASE/source/Pathfinder 165. Eyes of Empty Death|Pathfinder #165: Eyes of Empty Death]]
**Price** 8 gp; **Damage** 1d6 S; **Bulk** 1
**Hands** 2
**Type** Melee; **Category** Advanced; **Group** [[DATABASE/weapongroup/Flail|Flail]]

---
This metal chain bears hook-like barbs made of alchemically strengthened [[DATABASE/monsterfamily/Urdefhan|urdefhan]] teeth. Magical shauth lashes have the same ability to channel an urdefhan wielder's Wicked Bite as magical [[DATABASE/weapon/Shauth Blade|shauth blades]], and urdefhans hold these weapons with the same reverence as they do shauth blades.
