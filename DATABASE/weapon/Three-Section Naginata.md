...
<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Deadly d8</span><span class="item-trait">Forceful</span><span class="item-trait">Sweep</span><span class="item-trait">Versatile B</span>
**Source** [[DATABASE/source/Treasure Vault|Treasure Vault]] 
**Price** 12 gp; **Damage** 1d8 S; **Bulk** 2
**Hands** 2
**Type** Melee; **Category** Advanced; **Group** [[DATABASE/weapongroup/Flail|Flail]]

---
A fusion of a [[DATABASE/weapon/Naginata|naginata]] and [[DATABASE/weapon/Sansetsukon|sansetsukon]], this three-section weapon has a sweeping, curved blade along each of the outer sections. Though difficult for anyone but an expert weapon master to use effectively, the three-section naginata can be wielded at devastating speed to slice or smash apart a foe.
