...
<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Concussive</span><span class="item-trait">Fatal d10</span>
**Source** [[DATABASE/source/Guns & Gears|Guns & Gears]]
...
---
The most commonly available of firearms in Alkenstar, the flintlock musket includes an external firing mechanism and an efficient and relatively compact frame. Though lacking the range and firing power of the [[DATABASE/weapon/Arquebus|arquebus]] preferred by Alkenstar and Dongun Hold's military members, the flintlock musket is popular among civilians for its ease of use.
...
[[DATABASE/equipment/Duchy Defender|Duchy Defender]], [[DATABASE/equipment/Solar Shellflower|Solar Shellflower]]