...
---
# Boarding Pike<span class="item-type">Item 1</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Reach</span><span class="item-trait">Shove</span>
**Source** [[DATABASE/source/PFS Guide|PFS Guide]]
**Access** Member of the Pathfinder Society on a mission for the Arcadian Mariner’s Lodge.
**Price** 8 sp; **Damage** 1d10 P; **Bulk** 2
**Hands** 2
**Type** Melee; **Category** Martial; **Group** [[DATABASE/weapongroup/Polearm|Polearm]]

---
Taking the form of a [[DATABASE/weapon/Longspear|longspear]] fitted with crossbars or hooks, a boarding pike provides its wielder a sharp implement that's as adept at shoving enemies off a ship's railings as facilitating the boarding of other vessels. This is a martial melee weapon.
