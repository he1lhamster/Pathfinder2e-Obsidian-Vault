...
---
# Stiletto Pen<span class="item-type">Item 1</span>

<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Agile</span><span class="item-trait">Concealable</span><span class="item-trait">Finesse</span><span class="item-trait">Thrown 10 ft.</span>
**Source** [[DATABASE/source/PFS Guide|PFS Guide]]
**Access** Member of the Pathfinder Society.
**Price** 8 gp; **Damage** 1d4 P; **Bulk** L
**Hands** 1
**Type** Melee; **Category** Simple; **Group** [[DATABASE/weapongroup/Dart|Dart]]
