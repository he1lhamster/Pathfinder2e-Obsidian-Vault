...
<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Agile</span><span class="item-trait">Catfolk</span><span class="item-trait">Deadly d8</span><span class="item-trait">Disarm</span><span class="item-trait">Finesse</span><span class="item-trait">Versatile P</span>
**Source** [[DATABASE/source/Advanced Player's Guide|Advanced Player's Guide]] 
...
---
The three parallel blades of this handheld weapon extend between the fingers to resemble the natural claws of the [[DATABASE/ancestry/Catfolk|amurruns]] who created them, providing a way for those catfolk without suitable natural claws to share the fighting customs of their kin.
