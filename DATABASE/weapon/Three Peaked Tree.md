...
---
# Three Peaked Tree<span class="item-type">Item 1</span>
...
---
A recently developed weapon created for an [[DATABASE/ancestry/Elf|elven]] champion from Jinin, the three-peaked tree can be used as both a [[DATABASE/weapon/Trident|trident]] and a [[DATABASE/weapon/Mithral Tree|mithral tree]]. A three-peaked tree has a length of silken rope attached to the butt of its haft, allowing it to be quickly retrieved after thrown.

## Melee

<span class="item-trait">Critical Fusion</span><span class="item-trait">Elf</span><span class="item-trait">Tethered</span><span class="item-trait">Thrown 20 ft.</span>
**Damage** 1d8 P 
**Group** [[DATABASE/weapongroup/Spear|Spear]]

## Ranged

<span class="item-trait">Concussive</span><span class="item-trait">Elf</span><span class="item-trait">Fatal d8</span><span class="item-trait">Parry</span>
**Damage** 1d4 P
