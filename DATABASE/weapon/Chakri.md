...
**Price** 2 sp; **Damage** 1d6 S; **Bulk** L
**Hands** 1; **Range** 40 ft.
**Type** Ranged; **Category** Martial; **Group** [[DATABASE/weapongroup/Dart|Dart]]

---
Similar to a [[DATABASE/weapon/Chakram|chakram]], chakri are too light to be wielded in melee but allow the user significantly more control over their throws. A chakri is small and light enough that up to two can be worn on each wrist; a chakri worn on the wrist is reload 0 instead of reload —.
