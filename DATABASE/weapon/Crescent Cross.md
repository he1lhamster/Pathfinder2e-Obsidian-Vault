...
---
A crescent cross combines a small [[DATABASE/weapon/Scizore|scizore]] with an arm-mounted crossbow apparatus that can hold up to three bolts at a time.

## Melee

<span class="item-trait">Critical Fusion</span><span class="item-trait">Parry</span>
**Damage** 1d4 S 
**Group** [[DATABASE/weapongroup/Knife|Knife]]

## Ranged

<span class="item-trait">Capacity 3</span><span class="item-trait">Parry</span>
**Damage** 1d6 P
