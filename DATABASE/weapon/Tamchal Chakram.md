...
**Hands** 1
**Type** Melee; **Category** Advanced; **Group** [[Dart]]

---
These circular weapons are among the many strange weapons used by [[Urdefhan]]. The sharp metal circle contains numerous protruding blades, while an angled central handle provides a decent grip that spins the weapon as it's thrown.
