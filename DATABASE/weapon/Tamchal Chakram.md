...
- '[[DATABASE/trait/Thrown|Thrown 20 feet]]'
...
<span class="trait-uncommon item-trait">Uncommon</span><span class="item-trait">Agile</span><span class="item-trait">Deadly d6</span><span class="item-trait">Finesse</span><span class="item-trait">Thrown 20 feet</span>
**Source** [[DATABASE/source/Pathfinder 164. Hands of the Devil|Pathfinder #164: Hands of the Devil]]
**Price** 5 gp; **Damage** 1d6 S; **Bulk** L
**Hands** 1
**Type** Melee; **Category** Advanced; **Group** [[DATABASE/weapongroup/Dart|Dart]]

---
These circular weapons are among the many strange weapons used by [[DATABASE/monsterfamily/Urdefhan|urdefhans]]. The sharp metal circle contains numerous protruding blades, while an angled central handle provides a decent grip that spins the weapon as it's thrown.
