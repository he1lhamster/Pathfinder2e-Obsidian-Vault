...
---
At first glance this weapon looks like nothing more than an iron-bound [[DATABASE/weapon/Club|club]]. But the top of the weapon features a latch that opens to reveal three rotating pistol muzzles concealed in the mace's head that can be fired and rotated using triggers built into the weapon's haft.

## Melee

<span class="item-trait">Critical Fusion</span><span class="item-trait">Shove</span>
**Damage** 1d6 B 
**Group** [[DATABASE/weapongroup/Club|Club]]

## Ranged

<span class="item-trait">Capacity 3</span><span class="item-trait">Concussive</span><span class="item-trait">Fatal d8</span>
**Damage** 1d4 P
