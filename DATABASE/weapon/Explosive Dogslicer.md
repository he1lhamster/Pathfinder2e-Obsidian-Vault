...
- '[[DATABASE/trait/Scatter|Scatter 5 ft.]]'
...
---
# Explosive Dogslicer<span class="item-type">Item 1</span>
...
---
An explosive dogslicer is a sneaky, explosive weapon that often brings perverse joy to the [[DATABASE/ancestry/Goblin|goblins]] who use them. At first glance, it appears to be a triple-bladed [[DATABASE/weapon/Dogslicer|dogslicer]] with an oversized guard.

## Melee

<span class="item-trait">Backstabber</span><span class="item-trait">Critical Fusion</span><span class="item-trait">Finesse</span><span class="item-trait">Goblin</span>
**Damage** 1d6 S 
**Group** [[DATABASE/weapongroup/Sword|Sword]]

## Ranged

<span class="item-trait">Backstabber</span><span class="item-trait">Goblin</span><span class="item-trait">Scatter 5 ft.</span>
**Damage** 1d6 S
