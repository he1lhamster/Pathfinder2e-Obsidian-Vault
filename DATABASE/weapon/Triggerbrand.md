...
**Source** [[DATABASE/source/Impossible Lands|Impossible Lands]]
**Access** Characters from Alkenstar have access to this option.
**Price** 10 gp; **Bulk** 1
**Hands** 1
**Category** Martial

---
This unusual combination weapon integrates features of a [[DATABASE/weapon/Flintlock Pistol|flintlock pistol]] and a [[DATABASE/weapon/Shortsword|shortsword]]. Like other combination weapons, a wielder can transform it between ranged and melee modes as an Interact action.

## Melee

<span class="item-trait">Critical Fusion</span><span class="item-trait">Finesse</span><span class="item-trait">Versatile S</span>
**Damage** 1d6 P 
**Group** [[DATABASE/weapongroup/Sword|Sword]]

## Ranged

<span class="item-trait">Concussive</span><span class="item-trait">Fatal d8</span>
**Damage** 1d4 P
