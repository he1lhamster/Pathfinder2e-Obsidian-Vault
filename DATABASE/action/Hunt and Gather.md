...
<span class="item-trait">Camping</span><span class="item-trait">Move</span>
**Source** [[DATABASE/source/Kingmaker Companion Guide|Kingmaker Companion Guide]]
**Requirements** trained in [[DATABASE/skill/Survival|Survival]]

---
You spend 2 hours gathering ingredients. This supplements the food from [[DATABASE/action/Subsist|Subsisting]] with additional ingredients you can use to cook basic or special meals, gaining greater effects than simply eating the rations alone. Attempt a [[DATABASE/skill/Lore|Hunting Lore]] or Survival check against the Zone DC.
