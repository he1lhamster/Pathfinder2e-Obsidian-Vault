...
---
The army moves through your kingdom or beyond. Since this travel occurs over the course of the entire month that preceded the Kingdom turn, the ground an army covers when it deploys can be quite extensive. You can Deploy an Army with an [[DATABASE/skill/Exploration|Exploration]], [[DATABASE/skill/Boating|Boating]], or [[DATABASE/skill/Magic|Magic]] check.
...
**Critical Success** The army arrives much more quickly than you anticipated; it arrives at its destination and then becomes [[DATABASE/condition/Efficient|efficient]].
**Success** The army arrives at its destination.
**Failure** The army arrives at its destination, but ran into some sort of trouble along the way. Increase the army's [[DATABASE/condition/Weary|weary]] condition by 1 and attempt a DC 6 flat check; on a failure, reduce the army's HP by 1.
**Critical Failure** Rather than arriving at its destination, the army becomes [[DATABASE/condition/Lost|lost]] until it recovers from this condition. Increase Unrest by 1d4, and attempt a DC 11 flat check; on a failure, reduce the army's HP by 1.