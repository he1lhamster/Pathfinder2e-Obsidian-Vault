...
---
You can grow an item from a living thing, most commonly a plant. You need the [[DATABASE/feat/Alchemical Crafting|Alchemical Crafting]] skill feat to Grow an alchemical item, the [[DATABASE/feat/Magical Crafting|Magical Crafting]] skill feat to Grow a magic item, and the [[DATABASE/feat/Snare Crafting|Snare Crafting]] feat to Grow a snare. To Grow an item, you must meet the following requirements.
