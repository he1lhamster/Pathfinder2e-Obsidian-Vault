...
* The bettors' life. As soon as the outcome has been decided, the losers die instantly with no saving throw; this is a death effect. The next time the winner would die, they instead remain alive and [[Unconscious]] at 0 Hit Points with a [[Dying]] condition 1 lower than would kill them. Until this protection has been exhausted, the loser of the bet can't be returned to life through any means, even powerful magic such as [[Wish]]. A creature already in possession of an additional life as a result of winning an _Asmodean wager_ can't enter into a new wager with a life as collateral.
