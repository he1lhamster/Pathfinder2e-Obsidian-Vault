...
target: 1 creature of a level no greater than double theterminate bloodlineritual's
  level
trait:
...
---
# Terminate Bloodline<span class="item-type">Ritual 6</span>
...
**Primary Check** [[DATABASE/skill/Occultism|Occultism]] (master)
; **Secondary Checks** [[DATABASE/skill/Society|Society]]
**Range** 10 miles; **Target(s)** 1 creature of a level no greater than double the _terminate bloodline_ ritual's level
