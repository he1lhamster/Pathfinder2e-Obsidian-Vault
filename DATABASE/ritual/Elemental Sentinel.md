...
---
# Elemental Sentinel<span class="item-type">Ritual 1</span>
...
**Primary Check** [[DATABASE/skill/Arcana|Arcana]] (expert) or [[DATABASE/skill/Occultism|Occultism]] (expert)
**Target(s)** 1 object
**Duration** unlimited
...
**Heightened (6th)** As 4th level, except the wisp can [[DATABASE/spell/See Invisibility|see invisibility]], and its Perception modifier increases to +15, or +17 on a critical success.