...
**Primary Check** [[DATABASE/skill/Nature|Nature]] or [[DATABASE/skill/Religion|Religion]] (expert); **Secondary Checks** [[DATABASE/skill/Diplomacy|Diplomacy]], [[DATABASE/skill/Society|Society]]
**Range** 20 feet
...
**Critical Success** Once per day, each bonded creature can use a 2-action activity, which has the concentrate trait, to learn the present state of the other bonded creature. The creature knows the other creature's direction and distance and any conditions affecting them. Both of the participants can cast [[DATABASE/spell/Message|message]] as a divine innate spell at will, but can only target the other participant.
**Success** As a critical success, except the bonded creatures can't cast _message_ as a divine innate spell.
**Failure** The ritual has no effect.
**Critical Failure** Magical backlash creates discordant energy among the participants. For 1 week, each ritual participant is [[DATABASE/condition/Clumsy|clumsy 2]] and [[DATABASE/condition/Stupefied|stupefied 2]] whenever they are within 30 feet of another ritual participant.

---
**Heightened (6th)** Increase the cost to a total value of 600 gp. On a success, secondary casters in the ritual permanently gain the effects of a 6th-level [[DATABASE/spell/Telepathy|telepathy]] spell, but only with each other.