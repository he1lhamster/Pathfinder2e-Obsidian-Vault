...
---
You transform the target into an undead creature with a level up to that allowed in Table 7–1. There are many versions of this ritual, each specific to a particular type of undead (one ritual for all [[Zombie]], one for [[Skeleton]], one for [[Ghoul]], and so on), and the rituals that create rare undead are also rare. Some forms of undead, such as [[Lich]], form using their own unique methods and can’t be created with a version of _create undead_.
