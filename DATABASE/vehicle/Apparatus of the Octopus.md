...
**Piloting Check** [[Lore]] (DC 28) or [[Crafting]] (DC 30)
...
**Manipulate Hands** <span class="action-icon">2</span> (Interact) A crew member operates a lever set up like a joystick, allowing that crew member to extend and manipulate the apparatus's hands. While the hands can't attack and can't perform fine actions such as [[Disable a Device]], [[Steal]] something, or opening the stopper on a potion bottle, but they can grasp and hold up to 50 Bulk.
